...
`],encapsulation:2})}return n})();var Bn=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275cmp=I({type:n,selectors:[["structural-styles"]],decls:0,vars:0,template:function(t,r){},styles:[`.mat-focus-indicator {
  position: relative;
}
...
`],encapsulation:2,changeDetection:1})}return n})(),Mg=class{index;tab};var V0=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=X({type:n});static \u0275inj=K({imports:[Se]})}return n})();var bR=["*",[["mat-toolbar-row"]]],vR=["*","mat-toolbar-row"],yR=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275dir=k({type:n,selectors:[["mat-toolbar-row"]],hostAttrs:[1,"mat-toolbar-row"],exportAs:["matToolbarRow"]})}return n})(),j0=(()=>{class n{_elementRef=s(z);_platform=s(Ee);_document=s(re);color;_toolbarRows;ngAfterViewInit(){this._platform.isBrowser&&(this._checkToolbarMixedModes(),this._toolbarRows.changes.subscribe(()=>this._checkToolbarMixedModes()))}_checkToolbarMixedModes(){this._toolbarRows.length}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=I({type:n,selectors:[["mat-toolbar"]],contentQueries:function(t,r,a){if(t&1&&It(a,yR,5),t&2){let o;G(o=U())&&(r._toolbarRows=o)}},hostAttrs:[1,"mat-toolbar"],hostVars:6,hostBindings:function(t,r){t&2&&(ut(r.color?"mat-"+r.color:""),j("mat-toolbar-multiple-rows",r._toolbarRows.length>0)("mat-toolbar-single-row",r._toolbarRows.length===0))},inputs:{color:"color"},exportAs:["matToolbar"],ngContentSelectors:vR,decls:2,vars:0,template:function(t,r){t&1&&(Fe(bR),ne(0),ne(1,1))},styles:[`.mat-toolbar {
...
`],encapsulation:2})}return n})();var gt=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=X({type:n});static \u0275inj=K({imports:[du,wt,Se]})}return n})();var i1=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275cmp=I({type:n,selectors:[["ng-component"]],hostAttrs:["cdk-text-field-style-loader",""],decls:0,vars:0,template:function(t,r){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
...
`],encapsulation:2})}return n})();var li=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=X({type:n});static \u0275inj=K({imports:[Kt,Ao,Se,gi,gt,Ao]})}return n})();var HC=(()=>{class n{get vertical(){return this._vertical}set vertical(e){this._vertical=Pi(e)}_vertical=!1;get inset(){return this._inset}set inset(e){this._inset=Pi(e)}_inset=!1;static \u0275fac=function(t){return new(t||n)};static \u0275cmp=I({type:n,selectors:[["mat-divider"]],hostAttrs:["role","separator",1,"mat-divider"],hostVars:7,hostBindings:function(t,r){t&2&&(te("aria-orientation",r.vertical?"vertical":"horizontal"),j("mat-divider-vertical",r.vertical)("mat-divider-horizontal",!r.vertical)("mat-divider-inset",r.inset))},inputs:{vertical:"vertical",inset:"inset"},decls:0,vars:0,template:function(t,r){},styles:[`.mat-divider {
  display: block;
  margin: 0;
  border-top-style: solid;
...
`],encapsulation:2})}return n})(),Mm=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=X({type:n});static \u0275inj=K({imports:[Se]})}return n})();var Ji={MALE:"M\xE4nnlich",FEMALE:"Weiblich",BOTH:"Beide"};var er=y("[Participant] Load Participants"),xm=y("[Participant] Load Participants Success",C()),Em=y("[Participant] Load Participants Failure",C()),Am=y("[Participant] Load Participant",C()),Rm=y("[Participant] Load Participant Success",C()),km=y("[Participant] Load Participant Failure",C()),ts=y("[Participant] Create Participant",C()),Tm=y("[Participant] Create Participant Success",C()),Nm=y("[Participant] Create Participant Failure",C()),ns=y("[Participant] Update Participant",C()),Im=y("[Participant] Update Participant Success",C()),Om=y("[Participant] Update Participant Failure",C()),is=y("[Participant] Delete Participant",C()),Fm=y("[Participant] Delete Participant Success",C()),Pm=y("[Participant] Delete Participant Failure",C()),rs=y("[Participant] Delete Participants By Race Id",C()),Lm=y("[Participant] Delete Participants By Race Id Success",C()),Bm=y("[Participant] Delete Participants By Race Id Failure",C()),WC=y("[Participant] Select Participant",C()),as=y("[Participant] Export All PDF",C()),Ac=y("[Participant] Export All PDF Success",C()),Vm=y("[Participant] Export All PDF Failure",C()),os=y("[Participant] Export By Gender PDF",C()),Rc=y("[Participant] Export By Gender PDF Success",C()),jm=y("[Participant] Export By Gender PDF Failure",C()),ss=y("[Participant] Export All Age Groups PDF",C()),kc=y("[Participant] Export All Age Groups PDF Success",C()),zm=y("[Participant] Export All Age Groups PDF Failure",C());var Nc=Vn("participant"),ls=be(Nc,n=>n.participants),qC=be(Nc,n=>n.loading),YC=be(Nc,n=>n.pdfExportLoading),XW=be(Nc,n=>n.error),oN=be(Nc,n=>n.selectedParticipantId),ZW=be(ls,oN,(n,i)=>i?n.find(e=>e.id===i):null);var Gm=be(ls,Si,(n,i)=>i?n.filter(e=>e.race?.id===i):n);var S_=Vn("team"),$m=be(S_,n=>n.teams),KC=be(S_,n=>n.loading),JW=be(S_,n=>n.error);var Or=y("[Team] Load Teams"),Hm=y("[Team] Load Teams Success",C()),Wm=y("[Team] Load Teams Failure",C()),cs=y("[Team] Create Team",C()),qm=y("[Team] Create Team Success",C()),Ym=y("[Team] Create Team Failure",C()),ds=y("[Team] Update Team",C()),Km=y("[Team] Update Team Success",C()),Xm=y("[Team] Update Team Failure",C()),us=y("[Team] Delete Team",C()),Zm=y("[Team] Delete Team Success",C()),Qm=y("[Team] Delete Team Failure",C());var cN=(n,i)=>i.value,XC=(n,i)=>i.id;function dN(n,i){n&1&&(u(0,"mat-error"),m(1,"Vorname ist erforderlich"),d())}function uN(n,i){n&1&&(u(0,"mat-error"),m(1,"Nachname ist erforderlich"),d())}function mN(n,i){n&1&&(u(0,"mat-error"),m(1,"Geburtsdatum ist erforderlich"),d())}function hN(n,i){if(n&1&&(u(0,"mat-option",9),m(1),d()),n&2){let e=i.$implicit;w("value",e.value),h(),ue(e.label)}}function pN(n,i){n&1&&(u(0,"mat-error"),m(1,"Geschlecht ist erforderlich"),d())}function fN(n,i){if(n&1&&(u(0,"mat-option",9),m(1),d()),n&2){let e=i.$implicit,t=O();w("value",e.id),h(),vr("",e.name," (",t.formatRaceDate(e.date),")")}}function gN(n,i){n&1&&(u(0,"mat-error"),m(1,"Rennen ist erforderlich"),d())}function _N(n,i){n&1&&(u(0,"mat-error"),m(1,"Startnummer ist erforderlich"),d())}function bN(n,i){if(n&1&&(u(0,"mat-option",9),m(1),d()),n&2){let e=i.$implicit;w("value",e.id),h(),ue(e.name)}}var Ic=class n{fb=s(ri);dialogRef=s(ln);data=s(bi);store=s(qe);destroy$=new E;form;genderOptions=[{value:"MALE",label:Ji.MALE},{value:"FEMALE",label:Ji.FEMALE}];races$=this.store.select(yi);selectedRaceId$=this.store.select(Si);teams$=this.store.select($m);constructor(){let i=this.data?.birthDate||"";if(i&&typeof i=="string"){let e=i.split("-");e.length===3&&(i=new Date(parseInt(e[0]),parseInt(e[1])-1,parseInt(e[2])))}this.form=this.fb.group({firstName:[this.data?.firstName||"",xe.required],lastName:[this.data?.lastName||"",xe.required],birthDate:[i,xe.required],gender:[this.data?.gender||"",xe.required],race:[this.data?.race?.id||"",xe.required],raceNumber:[this.data?.raceNumber||"",xe.required],teamId:[this.data?.team?.id||null]})}ngOnInit(){this.store.dispatch(Or()),this.data||this.selectedRaceId$.pipe(Be(1)).subscribe(i=>{i&&this.form.patchValue({race:i})})}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete()}onCancel(){this.dialogRef.close()}onSave(){if(this.form.valid){let i=this.form.value,e={raceId:Number(i.race),firstName:i.firstName,lastName:i.lastName,birthDate:this.formatDate(i.birthDate),gender:i.gender,raceNumber:Number(i.raceNumber),teamId:i.teamId?Number(i.teamId):void 0};this.dialogRef.close(e)}}formatDate(i){if(typeof i=="string")return i;let e=new Date(i),t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${r}-${a}`}formatRaceDate(i){let e=i.split("-");if(e.length===3){let t=e[0],r=e[1];return`${e[2]}.${r}.${t}`}return i}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=I({type:n,selectors:[["app-participant-dialog"]],decls:58,vars:16,consts:[["picker",""],["mat-dialog-title",""],[1,"participant-form",3,"formGroup"],["appearance","outline"],["matInput","","formControlName","firstName","required",""],["matInput","","formControlName","lastName","required",""],["matInput","","formControlName","birthDate","placeholder","TT.MM.JJJJ","required","",3,"matDatepicker"],["matSuffix","",3,"for"],["formControlName","gender","required",""],[3,"value"],["formControlName","race","required",""],["matInput","","type","number","formControlName","raceNumber","required",""],["formControlName","teamId"],["align","end"],["mat-button","",3,"click"],["mat-raised-button","","color","primary",3,"click","disabled"]],template:function(e,t){if(e&1&&(u(0,"h2",1),m(1),d(),u(2,"mat-dialog-content")(3,"form",2)(4,"mat-form-field",3)(5,"mat-label"),m(6,"Vorname"),d(),R(7,"input",4),Ie(),T(8,dN,2,0,"mat-error"),d(),u(9,"mat-form-field",3)(10,"mat-label"),m(11,"Nachname"),d(),R(12,"input",5),Ie(),T(13,uN,2,0,"mat-error"),d(),u(14,"mat-form-field",3)(15,"mat-label"),m(16,"Geburtsdatum"),d(),R(17,"input",6),Ie(),R(18,"mat-datepicker-toggle",7)(19,"mat-datepicker",null,0),u(21,"mat-hint"),m(22,"Format: TT.MM.JJJJ (z.B. 24.3.2022)"),d(),T(23,mN,2,0,"mat-error"),d(),u(24,"mat-form-field",3)(25,"mat-label"),m(26,"Geschlecht"),d(),u(27,"mat-select",8),_t(28,hN,2,2,"mat-option",9,cN),d(),Ie(),T(30,pN,2,0,"mat-error"),d(),u(31,"mat-form-field",3)(32,"mat-label"),m(33,"Rennen"),d(),u(34,"mat-select",10),_t(35,fN,2,3,"mat-option",9,XC),oe(37,"async"),d(),Ie(),T(38,gN,2,0,"mat-error"),d(),u(39,"mat-form-field",3)(40,"mat-label"),m(41,"Startnummer"),d(),R(42,"input",11),Ie(),T(43,_N,2,0,"mat-error"),d(),u(44,"mat-form-field",3)(45,"mat-label"),m(46,"Team"),d(),u(47,"mat-select",12)(48,"mat-option",9),m(49,"Kein Team"),d(),_t(50,bN,2,2,"mat-option",9,XC),oe(52,"async"),d(),Ie(),d()()(),u(53,"mat-dialog-actions",13)(54,"button",14),M("click",function(){return t.onCancel()}),m(55,"Abbrechen"),d(),u(56,"button",15),M("click",function(){return t.onSave()}),m(57," Speichern "),d()()),e&2){let r=vt(20);h(),_e(" ",t.data?"Teilnehmer bearbeiten":"Neuer Teilnehmer"," "),h(2),w("formGroup",t.form),h(4),Oe(),h(),N(t.form.get("firstName")?.hasError("required")&&t.form.get("firstName")?.touched?8:-1),h(4),Oe(),h(),N(t.form.get("lastName")?.hasError("required")&&t.form.get("lastName")?.touched?13:-1),h(4),w("matDatepicker",r),Oe(),h(),w("for",r),h(5),N(t.form.get("birthDate")?.hasError("required")&&t.form.get("birthDate")?.touched?23:-1),h(4),Oe(),h(),bt(t.genderOptions),h(2),N(t.form.get("gender")?.hasError("required")&&t.form.get("gender")?.touched?30:-1),h(4),Oe(),h(),bt(me(37,12,t.races$)),h(3),N(t.form.get("race")?.hasError("required")&&t.form.get("race")?.touched?38:-1),h(4),Oe(),h(),N(t.form.get("raceNumber")?.hasError("required")&&t.form.get("raceNumber")?.touched?43:-1),h(4),Oe(),h(),w("value",null),h(2),bt(me(52,14,t.teams$)),h(6),w("disabled",!t.form.valid)}},dependencies:[et,ai,ii,pn,Nr,gn,ni,fn,Tt,Rn,yt,Bi,ji,Vi,gt,wt,Ct,Di,kn,Cc,si,oi,Ye,Qe,Dm,Cm,es,xc,wu,li,Gi,kt,ft],styles:[".participant-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:16px;min-width:400px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}"]})};var vN=(n,i)=>i.id;function yN(n,i){if(n&1&&(u(0,"mat-option",4),m(1),d()),n&2){let e=i.$implicit,t=O();w("value",e.id),h(),vr("",e.name," (",t.formatRaceDate(e.date),")")}}function SN(n,i){if(n&1){let e=$e();u(0,"button",32),M("click",function(){pe(e);let r=O();return fe(r.deleteParticipantsByRace())}),u(1,"mat-icon"),m(2,"delete_sweep"),d(),m(3," Alle Teilnehmer l\xF6schen "),d()}}function CN(n,i){n&1&&R(0,"mat-spinner",10)}function DN(n,i){n&1&&(u(0,"mat-icon"),m(1,"picture_as_pdf"),d())}function wN(n,i){n&1&&(u(0,"div",12),R(1,"mat-spinner"),d())}function MN(n,i){n&1&&(u(0,"th",33),m(1,"ID"),d())}function xN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),ue(e.id)}}function EN(n,i){n&1&&(u(0,"th",33),m(1,"Vorname"),d())}function AN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),_e(" ",e.firstName," ")}}function RN(n,i){n&1&&(u(0,"th",33),m(1,"Nachname"),d())}function kN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),_e(" ",e.lastName," ")}}function TN(n,i){n&1&&(u(0,"th",33),m(1," Geburtsdatum "),d())}function NN(n,i){if(n&1&&(u(0,"td",34),m(1),oe(2,"date"),d()),n&2){let e=i.$implicit;h(),_e(" ",ga(2,1,e.birthDate,"dd.MM.yyyy")," ")}}function IN(n,i){n&1&&(u(0,"th",33),m(1," Geschlecht "),d())}function ON(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit,t=O();h(),_e(" ",t.getGenderLabel(e.gender)," ")}}function FN(n,i){n&1&&(u(0,"th",33),m(1," Startnummer "),d())}function PN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),_e(" ",e.raceNumber," ")}}function LN(n,i){n&1&&(u(0,"th",33),m(1,"Team"),d())}function BN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),_e(" ",e.team?.name||"-"," ")}}function VN(n,i){n&1&&(u(0,"th",33),m(1,"Altersgruppe"),d())}function jN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),_e(" ",e.ageGroup?.name||"-"," ")}}function zN(n,i){n&1&&(u(0,"th",33),m(1,"Rennen"),d())}function GN(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit;h(),_e(" ",e.race?.name||"-"," ")}}function UN(n,i){n&1&&(u(0,"th",33),m(1,"Zeit"),d())}function $N(n,i){if(n&1&&(u(0,"td",34),m(1),d()),n&2){let e=i.$implicit,t=O();h(),_e(" ",e.durationMs!==void 0&&e.durationMs!==null?t.formatDuration(e.durationMs):"-"," ")}}function HN(n,i){n&1&&(u(0,"th",33),m(1,"Gemessen am"),d())}function WN(n,i){if(n&1&&(u(0,"td",34),m(1),oe(2,"date"),d()),n&2){let e=i.$implicit;h(),_e(" ",e.measuredAt?ga(2,1,e.measuredAt,"dd.MM.yyyy HH:mm:ss"):"-"," ")}}function qN(n,i){n&1&&(u(0,"th",35),m(1,"Aktionen"),d())}function YN(n,i){if(n&1){let e=$e();u(0,"td",34)(1,"button",36),M("click",function(){let r=pe(e).$implicit,a=O();return fe(a.openEditDialog(r))}),u(2,"mat-icon"),m(3,"edit"),d()(),u(4,"button",37),M("click",function(){let r=pe(e).$implicit,a=O();return fe(a.deleteParticipant(r))}),u(5,"mat-icon"),m(6,"delete"),d()()()}}function KN(n,i){n&1&&R(0,"tr",38)}function XN(n,i){n&1&&R(0,"tr",39)}var eh=class n{store=s(qe);dialog=s(ei);snackBar=s(An);destroy$=new E;participants$;races$;selectedRaceId$;loading$;pdfExportLoading$;displayedColumns=["id","firstName","lastName","birthDate","gender","raceNumber","team","ageGroup","race","durationMs","measuredAt","actions"];dataSource=new fr([]);sortInitialized=!1;sort=Sn.required(xt);constructor(){this.participants$=this.store.select(Gm),this.races$=this.store.select(yi),this.selectedRaceId$=this.store.select(Si),this.loading$=this.store.select(qC),this.pdfExportLoading$=this.store.select(YC),Dt(()=>{let i=this.sort();i&&!this.sortInitialized&&setTimeout(()=>{this.dataSource.sort=i,this.sortInitialized=!0,i.sortChange.pipe(F(this.destroy$)).subscribe(()=>{console.log("Sort changed:",i.active,i.direction)})},100)})}ngAfterViewInit(){this.store.dispatch(er()),this.store.dispatch(vi()),this.participants$.pipe(F(this.destroy$)).subscribe(i=>{this.dataSource.data=i})}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete()}getGenderLabel(i){return Ji[i]||i}formatRaceDate(i){let e=i.split("-");if(e.length===3){let t=e[0],r=e[1];return`${e[2]}.${r}.${t}`}return i}formatDuration(i){let e=Math.floor(i/1e3),t=Math.floor(e/3600),r=Math.floor(e%3600/60),a=e%60,o=i%1e3;return t>0?`${t}:${String(r).padStart(2,"0")}:${String(a).padStart(2,"0")}.${String(o).padStart(3,"0")}`:r>0?`${r}:${String(a).padStart(2,"0")}.${String(o).padStart(3,"0")}`:`${a}.${String(o).padStart(3,"0")}s`}onRaceFilterChange(i){this.store.dispatch(ea({id:i}))}openCreateDialog(){this.dialog.open(Ic,{width:"500px"}).afterClosed().pipe(F(this.destroy$)).subscribe(e=>{e&&(this.store.dispatch(ts({participant:e})),this.snackBar.open("Teilnehmer erfolgreich erstellt","OK",{duration:3e3}))})}openEditDialog(i){this.dialog.open(Ic,{width:"500px",data:i}).afterClosed().pipe(F(this.destroy$)).subscribe(t=>{t&&(this.store.dispatch(ns({id:i.id,participant:t})),this.snackBar.open("Teilnehmer erfolgreich aktualisiert","OK",{duration:3e3}))})}deleteParticipant(i){confirm(`M\xF6chten Sie den Teilnehmer "${i.firstName} ${i.lastName}" wirklich l\xF6schen?`)&&(this.store.dispatch(is({id:i.id})),this.snackBar.open("Teilnehmer erfolgreich gel\xF6scht","OK",{duration:3e3}))}deleteParticipantsByRace(){this.selectedRaceId$.pipe(Be(1)).subscribe(i=>{if(i===null)return;let e=this.dataSource.data[0]?.race?.name||"diesem Rennen";confirm(`M\xF6chten Sie wirklich ALLE Teilnehmer von "${e}" l\xF6schen? Diese Aktion kann nicht r\xFCckg\xE4ngig gemacht werden!`)&&(this.store.dispatch(rs({raceId:i})),this.snackBar.open("Alle Teilnehmer des Rennens erfolgreich gel\xF6scht","OK",{duration:3e3}))})}refreshData(){this.store.dispatch(er()),this.snackBar.open("Daten werden aktualisiert...","OK",{duration:2e3})}async exportAllPdf(){let i=await Qc(this.selectedRaceId$);if(!i){this.snackBar.open("Bitte w\xE4hlen Sie zuerst ein Rennen aus!","Schlie\xDFen",{duration:5e3,panelClass:["error-snackbar"]});return}this.store.dispatch(as({raceId:i})),this.snackBar.open("PDF Export gestartet: Gesamtwertung","OK",{duration:2e3})}async exportByGenderPdf(i){let e=await Qc(this.selectedRaceId$);if(!e){this.snackBar.open("Bitte w\xE4hlen Sie zuerst ein Rennen aus!","Schlie\xDFen",{duration:5e3,panelClass:["error-snackbar"]});return}this.store.dispatch(os({gender:i,raceId:e}));let t=i==="MALE"?"Herren":"Damen";this.snackBar.open(`PDF Export gestartet: Alle ${t}`,"OK",{duration:2e3})}async exportAllAgeGroupsPdf(){let i=await Qc(this.selectedRaceId$);if(!i){this.snackBar.open("Bitte w\xE4hlen Sie zuerst ein Rennen aus!","Schlie\xDFen",{duration:5e3,panelClass:["error-snackbar"]});return}this.store.dispatch(ss({raceId:i})),this.snackBar.open("PDF Export gestartet: Nach Altersklassen","OK",{duration:2e3})}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=I({type:n,selectors:[["app-participant-list"]],viewQuery:function(e,t){e&1&&Ei(t.sort,xt,5),e&2&&ui()},decls:104,vars:31,consts:[["exportMenu","matMenu"],[1,"filter-section"],["appearance","outline"],[3,"selectionChange","value"],[3,"value"],["mat-raised-button","","color","warn","matTooltip","Alle Teilnehmer des gefilterten Rennens l\xF6schen"],[1,"header-actions"],["mat-raised-button","","color","primary",3,"click"],["mat-raised-button","","matTooltip","Daten aktualisieren",3,"click"],["mat-raised-button","","color","accent","matTooltip","PDF Export Optionen",3,"matMenuTriggerFor","disabled"],["diameter","20",2,"display","inline-block","margin-right","8px"],["mat-menu-item","",3,"click"],[1,"loading-container"],["mat-table","","matSort","",1,"participant-table",3,"dataSource"],["matColumnDef","id"],["mat-header-cell","","mat-sort-header","",4,"matHeaderCellDef"],["mat-cell","",4,"matCellDef"],["matColumnDef","firstName"],["matColumnDef","lastName"],["matColumnDef","birthDate"],["matColumnDef","gender"],["matColumnDef","raceNumber"],["matColumnDef","team"],["matColumnDef","ageGroup"],["matColumnDef","race"],["matColumnDef","durationMs"],["matColumnDef","measuredAt"],["matColumnDef","actions"],["mat-header-cell","",4,"matHeaderCellDef"],["mat-header-row","",4,"matHeaderRowDef"],["mat-row","",4,"matRowDef","matRowDefColumns"],[1,"count-info"],["mat-raised-button","","color","warn","matTooltip","Alle Teilnehmer des gefilterten Rennens l\xF6schen",3,"click"],["mat-header-cell","","mat-sort-header",""],["mat-cell",""],["mat-header-cell",""],["mat-icon-button","","matTooltip","Bearbeiten",3,"click"],["mat-icon-button","","color","warn","matTooltip","L\xF6schen",3,"click"],["mat-header-row",""],["mat-row",""]],template:function(e,t){if(e&1&&(u(0,"mat-card")(1,"mat-card-header")(2,"mat-card-title"),m(3,"Teilnehmer"),d()(),u(4,"mat-card-content")(5,"div",1)(6,"mat-form-field",2)(7,"mat-label"),m(8,"Nach Rennen filtern"),d(),u(9,"mat-select",3),oe(10,"async"),M("selectionChange",function(a){return t.onRaceFilterChange(a.value)}),u(11,"mat-option",4),m(12,"Alle Rennen"),d(),_t(13,yN,2,3,"mat-option",4,vN),oe(15,"async"),d()(),T(16,SN,4,0,"button",5),oe(17,"async"),d(),u(18,"div",6)(19,"button",7),M("click",function(){return t.openCreateDialog()}),u(20,"mat-icon"),m(21,"add"),d(),m(22," Neuer Teilnehmer "),d(),u(23,"button",8),M("click",function(){return t.refreshData()}),u(24,"mat-icon"),m(25,"refresh"),d(),m(26," Aktualisieren "),d(),u(27,"button",9),oe(28,"async"),T(29,CN,1,0,"mat-spinner",10),oe(30,"async"),On(31,DN,2,0,"mat-icon"),m(32," PDF Export "),u(33,"mat-icon"),m(34,"arrow_drop_down"),d()(),u(35,"mat-menu",null,0)(37,"button",11),M("click",function(){return t.exportAllPdf()}),u(38,"mat-icon"),m(39,"groups"),d(),u(40,"span"),m(41,"Gesamtwertung (Alle)"),d()(),R(42,"mat-divider"),u(43,"button",11),M("click",function(){return t.exportByGenderPdf("MALE")}),u(44,"mat-icon"),m(45,"male"),d(),u(46,"span"),m(47,"Alle Herren"),d()(),u(48,"button",11),M("click",function(){return t.exportByGenderPdf("FEMALE")}),u(49,"mat-icon"),m(50,"female"),d(),u(51,"span"),m(52,"Alle Damen"),d()(),R(53,"mat-divider"),u(54,"button",11),M("click",function(){return t.exportAllAgeGroupsPdf()}),u(55,"mat-icon"),m(56,"view_list"),d(),u(57,"span"),m(58,"Nach Altersklassen aufgeteilt"),d()()()(),T(59,wN,2,0,"div",12),oe(60,"async"),u(61,"table",13),oe(62,"async"),ve(63,14),Y(64,MN,2,0,"th",15)(65,xN,2,1,"td",16),ye(),ve(66,17),Y(67,EN,2,0,"th",15)(68,AN,2,1,"td",16),ye(),ve(69,18),Y(70,RN,2,0,"th",15)(71,kN,2,1,"td",16),ye(),ve(72,19),Y(73,TN,2,0,"th",15)(74,NN,3,4,"td",16),ye(),ve(75,20),Y(76,IN,2,0,"th",15)(77,ON,2,1,"td",16),ye(),ve(78,21),Y(79,FN,2,0,"th",15)(80,PN,2,1,"td",16),ye(),ve(81,22),Y(82,LN,2,0,"th",15)(83,BN,2,1,"td",16),ye(),ve(84,23),Y(85,VN,2,0,"th",15)(86,jN,2,1,"td",16),ye(),ve(87,24),Y(88,zN,2,0,"th",15)(89,GN,2,1,"td",16),ye(),ve(90,25),Y(91,UN,2,0,"th",15)(92,$N,2,1,"td",16),ye(),ve(93,26),Y(94,HN,2,0,"th",15)(95,WN,3,4,"td",16),ye(),ve(96,27),Y(97,qN,2,0,"th",28)(98,YN,7,0,"td",16),ye(),Y(99,KN,1,0,"tr",29)(100,XN,1,0,"tr",30),d(),u(101,"div",31),oe(102,"async"),m(103),d()()()),e&2){let r=vt(36);h(9),w("value",me(10,15,t.selectedRaceId$)),h(2),w("value",null),h(2),bt(me(15,17,t.races$)),h(3),N(me(17,19,t.selectedRaceId$)!==null?16:-1),h(11),w("matMenuTriggerFor",r)("disabled",me(28,21,t.pdfExportLoading$)),h(2),N(me(30,23,t.pdfExportLoading$)?29:31),h(30),N(me(60,25,t.loading$)?59:-1),h(2),j("hidden",me(62,27,t.loading$)),w("dataSource",t.dataSource),h(38),w("matHeaderRowDef",t.displayedColumns),h(),w("matRowDefColumns",t.displayedColumns),h(),j("hidden",me(102,29,t.loading$)),h(2),_e(" Anzahl der Teilnehmer: ",t.dataSource.data.length," ")}},dependencies:[et,Jn,Un,Hn,Kn,Wn,$n,Xn,qn,Yn,Zn,Qn,Ye,Qe,$t,Wt,Ht,sn,on,yt,ti,hn,cn,un,mn,dn,an,Xt,Jr,xt,Qr,li,wt,Ct,Gi,kt,gt,Lo,pr,Tr,Po,Mm,HC,ft,_a],styles:[".filter-section[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px;align-items:center}.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px}.loading-container[_ngcontent-%COMP%]{display:flex;justify-content:center;padding:40px}.participant-table[_ngcontent-%COMP%]{width:100%}.hidden[_ngcontent-%COMP%]{display:none}mat-card[_ngcontent-%COMP%]{margin:20px}th.mat-sort-header-sorted[_ngcontent-%COMP%]{color:#000}mat-form-field[_ngcontent-%COMP%]{min-width:250px}.count-info[_ngcontent-%COMP%]{margin-top:16px;padding:12px 16px;background-color:#f5f5f5;border-radius:4px;font-size:14px;font-weight:500;color:#000000de}"]})};var ZC=(()=>{class n{static \u0275fac=function(t){return new(t||n)};static \u0275mod=X({type:n});static \u0275inj=K({imports:[Er,Se]})}return n})();var ZN=["switch"],QN=["*"];function JN(n,i){n&1&&(u(0,"span",11),Qt(),u(1,"svg",13),R(2,"path",14),d(),u(3,"svg",15),R(4,"path",16),d()())}var eI=new v("mat-slide-toggle-default-options",{providedIn:"root",factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})}),th=class{source;checked;constructor(i,e){this.source=i,this.checked=e}},C_=(()=>{class n{_elementRef=s(z);_focusMonitor=s(nn);_changeDetectorRef=s(Me);defaults=s(eI);_onChange=e=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(e){return new th(this,e)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=je();_focused=!1;name=null;id;labelPosition="after";ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(e){this._checked=e,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new L;toggleChange=new L;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){s(st).load(Bn);let e=s(new Ai("tabindex"),{optional:!0}),t=this.defaults;this.tabIndex=e==null?0:parseInt(e)||0,this.color=t.color||"accent",this.id=this._uniqueId=s(We).getId("mat-mdc-slide-toggle-"),this.hideIcon=t.hideIcon??!1,this.disabledInteractive=t.disabledInteractive??!1,this._labelId=this._uniqueId+"-label"}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(e=>{e==="keyboard"||e==="program"?(this._focused=!0,this._changeDetectorRef.markForCheck()):e||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(e){e.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(e){this.checked=!!e}registerOnChange(e){this._onChange=e}registerOnTouched(e){this._onTouched=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorOnChange=e}setDisabledState(e){this.disabled=e,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new th(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=I({type:n,selectors:[["mat-slide-toggle"]],viewQuery:function(t,r){if(t&1&&He(ZN,5),t&2){let a;G(a=U())&&(r._switchElement=a.first)}},hostAttrs:[1,"mat-mdc-slide-toggle"],hostVars:15,hostBindings:function(t,r){t&2&&(St("id",r.id),te("tabindex",null)("aria-label",null)("name",null)("aria-labelledby",null),ut(r.color?"mat-"+r.color:""),j("mat-mdc-slide-toggle-focused",r._focused)("mat-mdc-slide-toggle-checked",r.checked)("mat-slide-toggle-full-width",r.fullWidth)("_mat-animation-noopable",r._noopAnimations))},inputs:{name:"name",id:"id",labelPosition:"labelPosition",ariaLabel:[0,"aria-label","ariaLabel"],ariaLabelledby:[0,"aria-labelledby","ariaLabelledby"],ariaDescribedby:[0,"aria-describedby","ariaDescribedby"],required:[2,"required","required",B],color:"color",disabled:[2,"disabled","disabled",B],fullWidth:[2,"fullWidth","fullWidth",B],disableRipple:[2,"disableRipple","disableRipple",B],tabIndex:[2,"tabIndex","tabIndex",e=>e==null?0:Jt(e)],checked:[2,"checked","checked",B],hideIcon:[2,"hideIcon","hideIcon",B],disabledInteractive:[2,"disabledInteractive","disabledInteractive",B]},outputs:{change:"change",toggleChange:"toggleChange"},exportAs:["matSlideToggle"],features:[De([{provide:_r,useExisting:Lt(()=>n),multi:!0},{provide:Qi,useExisting:n,multi:!0}]),Pe],ngContentSelectors:QN,decls:14,vars:27,consts:[["switch",""],["mat-internal-form-field","",3,"labelPosition"],["role","switch","type","button",1,"mdc-switch",3,"click","tabIndex","disabled"],[1,"mat-mdc-slide-toggle-touch-target"],[1,"mdc-switch__track"],[1,"mdc-switch__handle-track"],[1,"mdc-switch__handle"],[1,"mdc-switch__shadow"],[1,"mdc-elevation-overlay"],[1,"mdc-switch__ripple"],["mat-ripple","",1,"mat-mdc-slide-toggle-ripple","mat-focus-indicator",3,"matRippleTrigger","matRippleDisabled","matRippleCentered"],[1,"mdc-switch__icons"],[1,"mdc-label",3,"click","for"],["viewBox","0 0 24 24","aria-hidden","true",1,"mdc-switch__icon","mdc-switch__icon--on"],["d","M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z"],["viewBox","0 0 24 24","aria-hidden","true",1,"mdc-switch__icon","mdc-switch__icon--off"],["d","M20 13H4v-2h16v2z"]],template:function(t,r){if(t&1&&(Fe(),u(0,"div",1)(1,"button",2,0),M("click",function(){return r._handleClick()}),R(3,"div",3)(4,"span",4),u(5,"span",5)(6,"span",6)(7,"span",7),R(8,"span",8),d(),u(9,"span",9),R(10,"span",10),d(),T(11,JN,5,0,"span",11),d()()(),u(12,"label",12),M("click",function(o){return o.stopPropagation()}),ne(13),d()()),t&2){let a=vt(2);w("labelPosition",r.labelPosition),h(),j("mdc-switch--selected",r.checked)("mdc-switch--unselected",!r.checked)("mdc-switch--checked",r.checked)("mdc-switch--disabled",r.disabled)("mat-mdc-slide-toggle-disabled-interactive",r.disabledInteractive),w("tabIndex",r.disabled&&!r.disabledInteractive?-1:r.tabIndex)("disabled",r.disabled&&!r.disabledInteractive),te("id",r.buttonId)("name",r.name)("aria-label",r.ariaLabel)("aria-labelledby",r._getAriaLabelledBy())("aria-describedby",r.ariaDescribedby)("aria-required",r.required||null)("aria-checked",r.checked)("aria-disabled",r.disabled&&r.disabledInteractive?"true":null),h(9),w("matRippleTrigger",a)("matRippleDisabled",r.disableRipple||r.disabled)("matRippleCentered",!0),h(),N(r.hideIcon?-1:11),h(),w("for",r.buttonId),te("id",r._labelId)}},dependencies:[Ar,a0],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
