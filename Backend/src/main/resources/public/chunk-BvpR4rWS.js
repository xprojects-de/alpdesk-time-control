...
`],encapsulation:2})}return i})();var De=(()=>{class i{static ɵfac=function(e){return new(e||i)};static ɵmod=WE({type:i});static ɵinj=uu({providers:[Fr,{provide:ze,useValue:{separatorKeyCodes:[13]}}],imports:[Tr,re]})}return i})();var _t=rx(`person`);var Ge=Op(_t,i=>i.persons);var Pe=Op(_t,i=>i.loading);Op(_t,i=>i.error);var Ae=Op(Ge,a,(i,n)=>{let t=new Map;for(let e of n){if(!e.person||!e.race)continue;let a=t.get(e.person.id)??[];a.push(e.race),t.set(e.person.id,a)}return i.map(e=>z(G({},e),{activeRaces:t.get(e.id)??[]}))});var Qe=(i,n)=>n.value;function We(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Vorname ist erforderlich`),Jc())}function Ue(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Vorname darf nicht nur aus Leerzeichen bestehen`),Jc())}function Je(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Nachname ist erforderlich`),Jc())}function Ze(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Nachname darf nicht nur aus Leerzeichen bestehen`),Jc())}function Xe(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Geburtsdatum ist erforderlich`),Jc())}function Ye(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Geburtsdatum muss zwischen 1900 und heute liegen`),Jc())}function tn(i,n){if(i&1&&(Mi(0,`mat-option`,9),cw(1),Jc()),i&2){let t=n.$implicit;Xp(`value`,t.value),dI(),bh(t.label)}}function en(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Geschlecht ist erforderlich`),Jc())}var V=class i{fb=T(OD$1);minBirthDate=new Date(1900,0,1);maxBirthDate=new Date;dialogRef=T(he);data=T(Ti);form;genderOptions=[{value:`MALE`,label:e$1.MALE},{value:`FEMALE`,label:e$1.FEMALE}];constructor(){let n$1=this.data?.birthDate||``;if(n$1&&typeof n$1==`string`){let t=n$1.split(`-`);t.length===3&&(n$1=new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])))}this.form=this.fb.group({firstName:[this.data?.firstName||``,[Ot.required,n()]],lastName:[this.data?.lastName||``,[Ot.required,n()]],birthDate:[n$1,Ot.required],gender:[this.data?.gender||``,Ot.required],externalId:[this.data?.externalId||``]})}onCancel(){this.dialogRef.close()}onSave(){if(this.form.valid){let n=this.form.value,t={firstName:n.firstName,lastName:n.lastName,birthDate:this.formatDate(n.birthDate),gender:n.gender,externalId:n.externalId||void 0};this.dialogRef.close(t)}}formatDate(n){if(typeof n==`string`)return n;let t=new Date(n);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}static ɵfac=function(t){return new(t||i)};static ɵcmp=UE({type:i,selectors:[[`app-person-dialog`]],decls:45,vars:14,consts:[[`picker`,``],[`mat-dialog-title`,``],[1,`person-form`,3,`formGroup`],[`appearance`,`outline`],[`matInput`,``,`formControlName`,`firstName`,`required`,``],[`matInput`,``,`formControlName`,`lastName`,`required`,``],[`matInput`,``,`formControlName`,`birthDate`,`placeholder`,`TT.MM.JJJJ`,`required`,``,3,`matDatepicker`,`min`,`max`],[`matSuffix`,``,3,`for`],[`formControlName`,`gender`,`required`,``],[3,`value`],[`matInput`,``,`formControlName`,`externalId`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`]],template:function(t,e){if(t&1&&(Mi(0,`h2`,1),cw(1),Jc(),Mi(2,`mat-dialog-content`)(3,`form`,2)(4,`mat-form-field`,3)(5,`mat-label`),cw(6,`Vorname`),Jc(),eh(7,`input`,4),XI(),hD(8,We,2,0,`mat-error`),hD(9,Ue,2,0,`mat-error`),Jc(),Mi(10,`mat-form-field`,3)(11,`mat-label`),cw(12,`Nachname`),Jc(),eh(13,`input`,5),XI(),hD(14,Je,2,0,`mat-error`),hD(15,Ze,2,0,`mat-error`),Jc(),Mi(16,`mat-form-field`,3)(17,`mat-label`),cw(18,`Geburtsdatum`),Jc(),eh(19,`input`,6),XI(),eh(20,`mat-datepicker-toggle`,7)(21,`mat-datepicker`,null,0),Mi(23,`mat-hint`),cw(24,`Format: TT.MM.JJJJ (z.B. 24.3.2022)`),Jc(),hD(25,Xe,2,0,`mat-error`),hD(26,Ye,2,0,`mat-error`),Jc(),Mi(27,`mat-form-field`,3)(28,`mat-label`),cw(29,`Geschlecht`),Jc(),Mi(30,`mat-select`,8),vD(31,tn,2,2,`mat-option`,9,Qe),Jc(),XI(),hD(33,en,2,0,`mat-error`),Jc(),Mi(34,`mat-form-field`,3)(35,`mat-label`),cw(36,`Externe ID (optional)`),Jc(),eh(37,`input`,10),XI(),Mi(38,`mat-hint`),cw(39,`Vereins-/Verbandsnummer, falls vorhanden`),Jc()()()(),Mi(40,`mat-dialog-actions`,11)(41,`button`,12),sh(`click`,function(){return e.onCancel()}),cw(42,`Abbrechen`),Jc(),Mi(43,`button`,13),sh(`click`,function(){return e.onSave()}),cw(44,` Speichern `),Jc()()),t&2){let a=HD(22);dI(),rl(` `,e.data?`Person bearbeiten`:`Neue Person`,` `),dI(2),Xp(`formGroup`,e.form),dI(4),tE(),dI(),gD(e.form.get(`firstName`)?.hasError(`required`)&&e.form.get(`firstName`)?.touched?8:-1),dI(),gD(e.form.get(`firstName`)?.hasError(`blank`)?9:-1),dI(4),tE(),dI(),gD(e.form.get(`lastName`)?.hasError(`required`)&&e.form.get(`lastName`)?.touched?14:-1),dI(),gD(e.form.get(`lastName`)?.hasError(`blank`)?15:-1),dI(4),Xp(`matDatepicker`,a)(`min`,e.minBirthDate)(`max`,e.maxBirthDate),tE(),dI(),Xp(`for`,a),dI(5),gD(e.form.get(`birthDate`)?.hasError(`required`)&&e.form.get(`birthDate`)?.touched?25:-1),dI(),gD(e.form.get(`birthDate`)?.hasError(`matDatepickerMin`)||e.form.get(`birthDate`)?.hasError(`matDatepickerMax`)?26:-1),dI(4),tE(),dI(),ID(e.genderOptions),dI(2),gD(e.form.get(`gender`)?.hasError(`required`)&&e.form.get(`gender`)?.touched?33:-1),dI(4),tE(),dI(6),Xp(`disabled`,!e.form.valid)}},dependencies:[qa,kD$1,TD,Ic,AD,RD,Zc,Zn,Nm,go,fo,po,mo,Qn,Cc,Wo,Yo,kh,Lh,iN,nN,BE,VE,bn$2,fn$1,Xt$1,Va,Y,gE,pE,or],styles:[`.person-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:16px;min-width:400px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}`]})};var nn=()=>[10,25,50,100];var an=(i,n)=>n.id;function on(i,n){i&1&&(Mi(0,`div`,4),eh(1,`mat-spinner`),Jc())}function cn(i,n){i&1&&(Mi(0,`th`,21),cw(1,`ID`),Jc())}function rn(i,n){if(i&1&&(Mi(0,`td`,22),cw(1),Jc()),i&2){let t=n.$implicit;dI(),bh(t.id)}}function sn(i,n){i&1&&(Mi(0,`th`,21),cw(1,`Nachname`),Jc())}function dn(i,n){if(i&1&&(Mi(0,`td`,22),cw(1),Jc()),i&2){let t=n.$implicit;dI(),bh(t.lastName)}}function ln(i,n){i&1&&(Mi(0,`th`,21),cw(1,`Vorname`),Jc())}function pn(i,n){if(i&1&&(Mi(0,`td`,22),cw(1),Jc()),i&2){let t=n.$implicit;dI(),bh(t.firstName)}}function hn(i,n){i&1&&(Mi(0,`th`,21),cw(1,`Geburtsdatum`),Jc())}function mn(i,n){if(i&1&&(Mi(0,`td`,22),cw(1),Jc()),i&2){let t=n.$implicit,e=OD();dI(),bh(e.formatRaceDate(t.birthDate))}}function un(i,n){i&1&&(Mi(0,`th`,21),cw(1,`Geschlecht`),Jc())}function _n(i,n){if(i&1&&(Mi(0,`td`,22),cw(1),Jc()),i&2){let t=n.$implicit,e=OD();dI(),bh(e.getGenderLabel(t.gender))}}function vn(i,n){i&1&&(Mi(0,`th`,21),cw(1,`Externe ID`),Jc())}function fn(i,n){if(i&1&&(Mi(0,`td`,22),cw(1),Jc()),i&2){let t=n.$implicit;dI(),bh(t.externalId||`-`)}}function gn(i,n){i&1&&(Mi(0,`th`,23),cw(1,`Aktiv bei Rennen`),Jc())}function yn(i,n){if(i&1&&(Mi(0,`mat-chip`),cw(1),Jc()),i&2){let t=n.$implicit;dI(),bh(t.name)}}function bn(i,n){if(i&1&&(Mi(0,`mat-chip-set`),vD(1,yn,2,1,`mat-chip`,null,an),Jc()),i&2){let t=OD().$implicit;dI(),ID(t.activeRaces)}}function Cn(i,n){i&1&&(Mi(0,`span`,24),cw(1,`-`),Jc())}function Sn(i,n){if(i&1&&(Mi(0,`td`,22),hD(1,bn,3,0,`mat-chip-set`)(2,Cn,2,0,`span`,24),Jc()),i&2){let t=n.$implicit;dI(),gD(t.activeRaces.length?1:2)}}function wn(i,n){i&1&&(Mi(0,`th`,23),cw(1,`Aktionen`),Jc())}function xn(i,n){if(i&1){let t=CD();Mi(0,`td`,22)(1,`button`,25),sh(`click`,function(){let a=Pu(t).$implicit;return Fu(OD().openEditDialog(a))}),Mi(2,`mat-icon`),cw(3,`edit`),Jc()(),Mi(4,`button`,26),sh(`click`,function(){let a=Pu(t).$implicit;return Fu(OD().deletePerson(a))}),Mi(5,`mat-icon`),cw(6,`delete`),Jc()()()}if(i&2){let t=n.$implicit;dI(4),Xp(`disabled`,t.activeRaces.length>0)(`matTooltip`,t.activeRaces.length>0?`Kann nicht gelöscht werden, solange die Person einem Rennen zugeordnet ist`:`Löschen`)}}function Nn(i,n){i&1&&eh(0,`tr`,27)}function kn(i,n){i&1&&eh(0,`tr`,28)}var Re=class i$1{store=T(Pt);dialog=T(nt$1);snackBar=T(Mt);actions$=T(MN);destroy$=new Q;persons$;loading$;unusedPersonCount$;displayedColumns=[`id`,`lastName`,`firstName`,`birthDate`,`gender`,`externalId`,`activeRaces`,`actions`];dataSource=new Wt$1([]);trackById=(n,t)=>t.id;sortInitialized=!1;paginatorInitialized=!1;sort=jj.required(W);paginator=jj.required(st);constructor(){this.persons$=this.store.select(Ae),this.loading$=this.store.select(Pe),this.unusedPersonCount$=this.persons$.pipe(oe(n=>n.filter(t=>t.activeRaces.length===0).length)),this.actions$.pipe(AN(c),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Person erfolgreich erstellt`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(u),bg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim Erstellen der Person: ${n}`,`OK`,{duration:5e3})}),this.actions$.pipe(AN(a$1),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Person erfolgreich aktualisiert`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(d),bg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim Aktualisieren der Person: ${n}`,`OK`,{duration:5e3})}),this.actions$.pipe(AN(i),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Person erfolgreich gelöscht`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(x),bg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim L\xF6schen der Person: ${n}`,`OK`,{duration:5e3})}),this.actions$.pipe(AN(S),bg(this.destroy$)).subscribe(({deletedCount:n})=>{this.snackBar.open(`${n} ungenutzte Person(en) gel\xF6scht`,`OK`,{duration:3e3}),this.store.dispatch(o())}),this.actions$.pipe(AN(U),bg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim L\xF6schen der ungenutzten Personen: ${n}`,`OK`,{duration:5e3})}),id(()=>{let n=this.sort();n&&!this.sortInitialized&&setTimeout(()=>{this.dataSource.sort=n,this.sortInitialized=!0},100)}),id(()=>{let n=this.paginator();n&&!this.paginatorInitialized&&setTimeout(()=>{this.dataSource.paginator=n,this.paginatorInitialized=!0},100)})}ngAfterViewInit(){this.store.dispatch(o()),this.store.dispatch(e()),this.persons$.pipe(bg(this.destroy$)).subscribe(n=>{this.dataSource.data=n})}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete()}openCreateDialog(){this.dialog.open(V,{width:`500px`}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(P({person:t}))})}openEditDialog(n){this.dialog.open(V,{width:`500px`,data:n}).afterClosed().pipe(bg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(p({id:n.id,person:e}))})}deletePerson(n){n.activeRaces.length>0||confirm(`M\xF6chten Sie die Person "${n.lastName} ${n.firstName}" wirklich l\xF6schen?`)&&this.store.dispatch(l({id:n.id}))}deleteUnusedPersons(){this.unusedPersonCount$.pipe(tn$1(1)).subscribe(n=>{n!==0&&confirm(`M\xF6chten Sie wirklich alle ${n} Person(en) l\xF6schen, die keinem Rennen / Teilnehmer zugewiesen sind?`)&&this.store.dispatch(F())})}refreshData(){this.store.dispatch(o()),this.store.dispatch(e()),this.snackBar.open(`Daten werden aktualisiert...`,`OK`,{duration:2e3})}getGenderLabel(n){return n?e$1[n]||n:`—`}formatRaceDate(n){let t=n.split(`-`);if(t.length===3){let e=t[0],a=t[1];return`${t[2]}.${a}.${e}`}return n}static ɵfac=function(t){return new(t||i$1)};static ɵcmp=UE({type:i$1,selectors:[[`app-person-list`]],viewQuery:function(t,e){t&1&&fh(e.sort,W,5)(e.paginator,st,5),t&2&&VD(2)},decls:52,vars:19,consts:[[1,`header-actions`],[`mat-raised-button`,``,`color`,`primary`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Daten aktualisieren`,3,`click`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Löscht alle Personen, die keinem Rennen / Teilnehmer zugewiesen sind`,3,`click`,`disabled`],[1,`loading-container`],[1,`table-container`],[`mat-table`,``,`matSort`,``,1,`person-table`,3,`dataSource`,`trackBy`],[`matColumnDef`,`id`],[`mat-header-cell`,``,`mat-sort-header`,``,4,`matHeaderCellDef`],[`mat-cell`,``,4,`matCellDef`],[`matColumnDef`,`lastName`],[`matColumnDef`,`firstName`],[`matColumnDef`,`birthDate`],[`matColumnDef`,`gender`],[`matColumnDef`,`externalId`],[`matColumnDef`,`activeRaces`],[`mat-header-cell`,``,4,`matHeaderCellDef`],[`matColumnDef`,`actions`],[`mat-header-row`,``,4,`matHeaderRowDef`],[`mat-row`,``,4,`matRowDef`,`matRowDefColumns`],[`showFirstLastButtons`,``,3,`pageSizeOptions`],[`mat-header-cell`,``,`mat-sort-header`,``],[`mat-cell`,``],[`mat-header-cell`,``],[1,`no-races`],[`mat-icon-button`,``,`matTooltip`,`Bearbeiten`,3,`click`],[`mat-icon-button`,``,`color`,`warn`,3,`click`,`disabled`,`matTooltip`],[`mat-header-row`,``],[`mat-row`,``]],template:function(t,e){t&1&&(Mi(0,`mat-card`)(1,`mat-card-header`)(2,`mat-card-title`),cw(3,`Personen`),Jc()(),Mi(4,`mat-card-content`)(5,`div`,0)(6,`button`,1),sh(`click`,function(){return e.openCreateDialog()}),Mi(7,`mat-icon`),cw(8,`add`),Jc(),cw(9,` Neue Person `),Jc(),Mi(10,`button`,2),sh(`click`,function(){return e.refreshData()}),Mi(11,`mat-icon`),cw(12,`refresh`),Jc(),cw(13,` Aktualisieren `),Jc(),Mi(14,`button`,3),ww(15,`async`),sh(`click`,function(){return e.deleteUnusedPersons()}),Mi(16,`mat-icon`),cw(17,`delete_sweep`),Jc(),cw(18),ww(19,`async`),Jc()(),hD(20,on,2,0,`div`,4),ww(21,`async`),Mi(22,`div`,5)(23,`table`,6),ww(24,`async`),tl(25,7),Gp(26,cn,2,0,`th`,8)(27,rn,2,1,`td`,9),nl(),tl(28,10),Gp(29,sn,2,0,`th`,8)(30,dn,2,1,`td`,9),nl(),tl(31,11),Gp(32,ln,2,0,`th`,8)(33,pn,2,1,`td`,9),nl(),tl(34,12),Gp(35,hn,2,0,`th`,8)(36,mn,2,1,`td`,9),nl(),tl(37,13),Gp(38,un,2,0,`th`,8)(39,_n,2,1,`td`,9),nl(),tl(40,14),Gp(41,vn,2,0,`th`,8)(42,fn,2,1,`td`,9),nl(),tl(43,15),Gp(44,gn,2,0,`th`,16)(45,Sn,3,1,`td`,9),nl(),tl(46,17),Gp(47,wn,2,0,`th`,16)(48,xn,7,2,`td`,9),nl(),Gp(49,Nn,1,0,`tr`,18)(50,kn,1,0,`tr`,19),Jc()(),eh(51,`mat-paginator`,20),Jc()()),t&2&&(dI(14),Xp(`disabled`,!Tw(15,10,e.unusedPersonCount$)),dI(4),rl(` Ungenutzte Personen löschen (`,Tw(19,12,e.unusedPersonCount$),`) `),dI(2),gD(Tw(21,14,e.loading$)?20:-1),dI(3),mh(`hidden`,Tw(24,16,e.loading$)),Xp(`dataSource`,e.dataSource)(`trackBy`,e.trackById),dI(26),Xp(`matHeaderRowDef`,e.displayedColumns),dI(),Xp(`matRowDefColumns`,e.displayedColumns),dI(),Xp(`pageSizeOptions`,Iw(18,nn)))},dependencies:[qa,Rn,mn$1,gn$1,wn$1,_n$1,pn$1,Dn,yn$1,Cn$1,vn$1,bn$1,BE,VE,np,We$1,Xe$1,pN,mN,go,Xt,Dx,_x,vx,Sx,bx,we$2,Wt,gt,W,pt,It,st,De,ut,Ee,Vu],styles:[`.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px}.loading-container[_ngcontent-%COMP%]{display:flex;justify-content:center;padding:40px}.person-table[_ngcontent-%COMP%]{width:100%}.hidden[_ngcontent-%COMP%]{display:none}mat-card[_ngcontent-%COMP%]{margin:20px}th.mat-sort-header-sorted[_ngcontent-%COMP%]{color:#000}.no-races[_ngcontent-%COMP%]{color:#0006}mat-chip-set[_ngcontent-%COMP%]{max-width:320px}`]})};export{Re as PersonListComponent};