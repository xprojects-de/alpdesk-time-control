...
`],encapsulation:2})}return t})();var pe=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=GE({type:t});static ɵinj=uu({imports:[ce,se]})}return t})();export{pe as n,ce as t};