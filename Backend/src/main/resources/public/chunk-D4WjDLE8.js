import{$n as hw,An as bh,At as Re,B as Hv,C as Fh,Cn as _h,Cr as nl,Ct as Pu,D as G,F as HD,Fn as cw,Gr as tn,H as Ig,Hr as tE,Ht as Ue,In as dI,Ir as rh,It as T,Jn as gh,Jt as VD,K as Jc,Kn as gD,L as Hj,Ln as dh,Lr as rl,Nn as ch,O as Ge,Or as pw,Q as Kc,Qr as vw,Tr as oe,Tt as QE,V as ID,Vt as UE,W as Iw,Wr as tl,Wt as Uj,X as KD,Xn as hD,Xr as vD,Y as Jp,Zr as vg,Zt as WE,_ as Dg,c as A,ci as z,cn as Xp,ct as Mr,ei as wg,er as ih,et as Kp,ft as Nh,g as Cw,gr as lu,gt as OD,h as Co,ii as ww,in as Xa,it as Lu,kt as Qu,mr as lh,p as CD,r as $j,rn as XI,rr as jD,sr as kD,st as Mi,ti as wh,tn as Wp,tr as iy,tt as LD,vr as mg,w as Fj,wt as Q,x as FD,y as Ee,zt as Tw}from"./chunk-CMzlWkMW.js";import{$t as kD$1,B as OD$1,C as Ic,Ct as Zn$1,G as Ot,Gt as iN,In as vx,Jt as im,Kt as ic,Ln as we,Nn as ut,Pn as ve,Q as RD,Qt as ju,R as Nm,S as ID$1,Tt as _x,Ut as gr,Vt as gE,Y as Pt,Z as Qn$1,_n as pN,a as Am,at as Sx,bn as qa,bt as Zc,c as BE,cn as nr,ct as Tr,dt as VE,gn as pE,gt as Wo,ht as Vu,in as mN,it as Sm,j as MN,k as Le,kt as bx,l as Cc,mn as or,n as AD,on as nN,ot as TD,p as Dx,pn as om,r as AN,sn as np,tn as kh,u as Cm,v as Gi,wn as re}from"./chunk-BMmqvhgo.js";import{r as s,t as l}from"./chunk-BsPjWHoZ.js";import{$n as Ie,Ar as q,At as I,Cr as h,Dr as me,Er as l$1,Fr as w,Gn as Ae,Ir as we$1,Jn as De,K as m,Kn as B,Lr as xe,Mr as se,N as i,Nr as te$1,Or as ne,Ot as Bt,Pr as ve$1,Qn as H,Rr as z$1,Sr as ge,Tr as k,Wn as $,Wr as p,Xn as Fe,Yn as E,Zn as G$1,_r as _,a as Xe$1,ar as Ne,br as ee,cn as s$1,cr as P,dr as Se,er as J,fr as T$1,gr as X,hr as W,ht as S$1,i as Wt,ir as N,jr as re$1,jt as Lt,kr as oe$1,kt as G$2,lr as R,mr as V,nr as L,o as we$2,or as O,pr as U,qn as C,r as We,rr as Me,sr as Oe,tr as Je,ur as S,vr as ae,wr as j,wt as t,xr as f,yr as be}from"./main-EY4TFLZI.js";import{_ as uo,a as Yt,b as yn$1,d as gn,f as ki,g as po,h as pn,l as fn,m as mo,n as Dn$1,o as _n$1,p as mn,r as Ee$1,s as bn,t as Cn$1,u as fo,v as vn,y as wn}from"./chunk-CPyex6u9.js";import{n as Xt,t as Mt}from"./chunk-CvaIeXQR.js";import{t as s$2}from"./chunk-cV4kY63s.js";var Cn=[`switch`];var Nn=[`*`];function xn(n,i){n&1&&(Mi(0,`span`,11),Qu(),Mi(1,`svg`,13),Xp(2,`path`,14),Jc(),Mi(3,`svg`,15),Xp(4,`path`,16),Jc()())}var An=new A(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var Be=class{source;checked;constructor(i,e){this.source=i,this.checked=e}};var Ze=(()=>{class n{_elementRef=T(Mr);_focusMonitor=T(Gi);_changeDetectorRef=T(Hj);defaults=T(An);_onChange=e=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(e){return new Be(this,e)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=Le();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(e){this._checked=e,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new Ge;toggleChange=new Ge;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){T(ve).load(nr);let e=T(new Fh(`tabindex`),{optional:!0}),t=this.defaults;this.tabIndex=e==null?0:parseInt(e)||0,this.color=t.color||`accent`,this.id=this._uniqueId=T(we).getId(`mat-mdc-slide-toggle-`),this.hideIcon=t.hideIcon??!1,this.disabledInteractive=t.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(e=>{e===`keyboard`||e===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):e||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(e){e.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(e){this.checked=!!e}registerOnChange(e){this._onChange=e}registerOnTouched(e){this._onTouched=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorOnChange=e}setDisabledState(e){this.disabled=e,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new Be(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(t){return new(t||n)};static ɵcmp=UE({type:n,selectors:[[`mat-slide-toggle`]],viewQuery:function(t,a){if(t&1&&lh(Cn,5),t&2){let c;FD(c=jD())&&(a._switchElement=c.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(t,a){t&2&&(rh(`id`,a.id),Kp(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),KD(a.color?`mat-`+a.color:``),gh(`mat-mdc-slide-toggle-focused`,a._focused)(`mat-mdc-slide-toggle-checked`,a.checked)(`mat-slide-toggle-full-width`,a.fullWidth)(`_mat-animation-noopable`,a._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,$j],color:`color`,disabled:[2,`disabled`,`disabled`,$j],fullWidth:[2,`fullWidth`,`fullWidth`,$j],disableRipple:[2,`disableRipple`,`disableRipple`,$j],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?0:Uj(e)],checked:[2,`checked`,`checked`,$j],hideIcon:[2,`hideIcon`,`hideIcon`,$j],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,$j]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[vw([{provide:gr,useExisting:Co(()=>n),multi:!0},{provide:ut,useExisting:n,multi:!0}]),iy],ngContentSelectors:Nn,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(t,a){if(t&1&&(kD(),Mi(0,`div`,1)(1,`button`,2,0),ih(`click`,function(){return a._handleClick()}),Xp(3,`div`,3)(4,`span`,4),Mi(5,`span`,5)(6,`span`,6)(7,`span`,7),Xp(8,`span`,8),Jc(),Mi(9,`span`,9),Xp(10,`span`,10),Jc(),hD(11,xn,5,0,`span`,11),Jc()()(),Mi(12,`label`,12),ih(`click`,function(b){return b.stopPropagation()}),LD(13),Jc()()),t&2){let c=HD(2);Jp(`labelPosition`,a.labelPosition),dI(),gh(`mdc-switch--selected`,a.checked)(`mdc-switch--unselected`,!a.checked)(`mdc-switch--checked`,a.checked)(`mdc-switch--disabled`,a.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,a.disabledInteractive),Jp(`tabIndex`,a.disabled&&!a.disabledInteractive?-1:a.tabIndex)(`disabled`,a.disabled&&!a.disabledInteractive),Kp(`id`,a.buttonId)(`name`,a.name)(`aria-label`,a.ariaLabel)(`aria-labelledby`,a._getAriaLabelledBy())(`aria-describedby`,a.ariaDescribedby)(`aria-required`,a.required||null)(`aria-checked`,a.checked)(`aria-disabled`,a.disabled&&a.disabledInteractive?`true`:null),dI(9),Jp(`matRippleTrigger`,c)(`matRippleDisabled`,a.disableRipple||a.disabled)(`matRippleCentered`,!0),dI(),gD(a.hideIcon?-1:11),dI(),Jp(`for`,a.buttonId),Kp(`id`,a._labelId)}},dependencies:[ic,m],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return n})();var kn=(()=>{class n{static ɵfac=function(t){return new(t||n)};static ɵmod=WE({type:n});static ɵinj=lu({imports:[Tr,Ve,re]})}return n})();var jn=(n,i)=>i.id;function Hn(n,i){if(n&1&&(Mi(0,`mat-option`,4),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();Jp(`value`,e.id),dI(),bh(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function Un(n,i){n&1&&(Mi(0,`mat-error`),cw(1,`Bitte ein Rennen auswählen`),Jc())}function Wn(n,i){n&1&&(Mi(0,`mat-error`),cw(1,`Bitte eine Archivierungs-Variante auswählen`),Jc())}var Ke=class n{fb=T(OD$1);dialogRef=T(Ee$1);data=T(ki);form=this.fb.group({raceId:[null,Ot.required],mode:[null,Ot.required]});onCancel(){this.dialogRef.close()}onSave(){if(!this.form.valid)return;let i=this.form.value.mode,e={raceId:Number(this.form.value.raceId),resetDevice:i===`reset`,clearAfterArchive:i!==`noclear`};this.dialogRef.close(e)}formatRaceDate(i){let e=i.split(`-`);return e.length===3?`${e[2]}.${e[1]}.${e[0]}`:i}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-archive-measurements-dialog`]],decls:30,vars:4,consts:[[`mat-dialog-title`,``],[1,`archive-form`,3,`formGroup`],[`appearance`,`outline`],[`formControlName`,`raceId`,`required`,``],[3,`value`],[`formControlName`,`mode`,1,`mode-group`],[`value`,`reset`],[1,`hint`],[`value`,`keep`],[`value`,`noclear`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`]],template:function(e,t){e&1&&(Mi(0,`h2`,0),cw(1,`Messungen archivieren`),Jc(),Mi(2,`mat-dialog-content`)(3,`form`,1)(4,`mat-form-field`,2)(5,`mat-label`),cw(6,`Rennen`),Jc(),Mi(7,`mat-select`,3),vD(8,Hn,2,3,`mat-option`,4,jn),Jc(),XI(),hD(10,Un,2,0,`mat-error`),Jc(),Mi(11,`mat-radio-group`,5)(12,`mat-radio-button`,6),cw(13,` Archivieren (inkl. Gerät-Reset) `),Mi(14,`p`,7),cw(15,`Aktuelle Messungen werden diesem Rennen zugeordnet, danach werden Datenbank und Gerät geleert. Bereit für das nächste Rennen.`),Jc()(),Mi(16,`mat-radio-button`,8),cw(17,` Archivieren (nur Datenbank) `),Mi(18,`p`,7),cw(19,`Wie oben, aber nur die Datenbank wird geleert, das Gerät bleibt unverändert.`),Jc()(),Mi(20,`mat-radio-button`,9),cw(21,` Archivieren (ohne Löschen) `),Mi(22,`p`,7),cw(23,`Aktuelle Messungen werden diesem Rennen zugeordnet. Datenbank und Gerät werden dabei NICHT verändert.`),Jc()()(),XI(),hD(24,Wn,2,0,`mat-error`),Jc()(),Mi(25,`mat-dialog-actions`,10)(26,`button`,11),ih(`click`,function(){return t.onCancel()}),cw(27,`Abbrechen`),Jc(),Mi(28,`button`,12),ih(`click`,function(){return t.onSave()}),cw(29,` Archivieren `),Jc()()),e&2&&(dI(3),Jp(`formGroup`,t.form),dI(4),tE(),dI(),ID(t.data.races),dI(2),gD(t.form.get(`raceId`)?.hasError(`required`)&&t.form.get(`raceId`)?.touched?10:-1),dI(),tE(),dI(13),gD(t.form.get(`mode`)?.hasError(`required`)&&t.form.get(`mode`)?.touched?24:-1),dI(4),Jp(`disabled`,!t.form.valid))},dependencies:[qa,kD$1,TD,AD,RD,Zc,Zn$1,Nm,po,uo,mo,fo,Qn$1,Cc,Wo,kh,gE,pE,or,kn,Xe,Ve,BE,VE],styles:[`.archive-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px;min-width:420px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}.mode-group[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:12px}.hint[_ngcontent-%COMP%]{margin:2px 0 0;font-size:12px;color:#0009}`]})};var Qn=[`jsonImportInput`];var Ye=()=>[];var Jn=(n,i)=>i.id;function Zn(n,i){n&1&&(Mi(0,`mat-icon`,5),cw(1,`sync `),Jc())}function Xn(n,i){if(n&1&&(Mi(0,`mat-icon`,6),cw(1,`sync `),Jc()),n&2)Jp(`matTooltip`,hw(`Letzte Aktualisierung: `,OD().lastUpdate))}function Yn(n,i){if(n&1){let e=CD();Mi(0,`button`,41),ih(`click`,function(){Lu(e);return Pu(OD(2).toggleContinuousMode(!1))}),Mi(1,`mat-icon`),cw(2,`stop`),Jc(),cw(3,` Kontinuierlich AUS `),Jc()}}function ea(n,i){if(n&1){let e=CD();Mi(0,`button`,42),ih(`click`,function(){Lu(e);return Pu(OD(2).toggleContinuousMode(!0))}),Mi(1,`mat-icon`),cw(2,`play_arrow`),Jc(),cw(3,` Kontinuierlich AN `),Jc()}}function ta(n,i){if(n&1){let e=CD();Mi(0,`button`,43),ih(`click`,function(){Lu(e);return Pu(OD(2).discardOldestStart())}),Mi(1,`mat-icon`),cw(2,`person_off`),Jc(),cw(3,` Sturz signalisieren `),Jc()}}function ia(n,i){if(n&1&&(hD(0,Yn,4,0,`button`,38),ww(1,`async`),Kc(2,ea,4,0,`button`,39),hD(3,ta,4,0,`button`,40),ww(4,`async`)),n&2){let e=OD();gD(Tw(1,2,e.deviceStatus$)===`continuous`?0:2),dI(3),gD(Tw(4,4,e.deviceStatus$)===`normal`?3:-1)}}function na(n,i){if(n&1){let e=CD();Mi(0,`button`,44),ih(`click`,function(){Lu(e);return Pu(OD().toggleScheduledImport(!1))}),Mi(1,`mat-icon`),cw(2,`cloud_sync`),Jc(),cw(3,` Auto-Import AUS `),Jc()}}function aa(n,i){if(n&1){let e=CD();Mi(0,`button`,45),ih(`click`,function(){Lu(e);return Pu(OD().toggleScheduledImport(!0))}),Mi(1,`mat-icon`),cw(2,`cloud_download`),Jc(),cw(3,` Auto-Import AN `),Jc()}}function ra(n,i){if(n&1&&(Mi(0,`mat-option`,22),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();Jp(`value`,e.id),dI(),bh(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function oa(n,i){if(n&1&&(Mi(0,`strong`),cw(1),Jc(),cw(2),ww(3,`async`)),n&2){let e=OD(2),t=OD(),a=OD();dI(),wh(e.nextRaceNumber),dI(),rl(` (`,a.getParticipantNameByRaceNumber(t,e.nextRaceNumber,Tw(3,2,a.participants$)||Iw(4,Ye)),`) `)}}function sa(n,i){n&1&&(Mi(0,`em`),cw(1,`keine weiteren Startnummern`),Jc())}function da(n,i){if(n&1){let e=CD();Mi(0,`button`,46),ih(`click`,function(){Lu(e);return Pu(OD(3).skipAutoAssign())}),Mi(1,`mat-icon`),cw(2,`skip_next`),Jc(),cw(3,` Überspringen `),Jc(),Mi(4,`span`,47),cw(5,` Nächste erwartete Startnummer: `),hD(6,oa,4,5)(7,sa,2,0,`em`),Jc()}if(n&2){let e=OD();dI(6),gD(e.nextRaceNumber!==null?6:7)}}function ca(n,i){if(n&1&&hD(0,da,8,1),n&2){let e=i,t=OD();gD(e.active&&e.raceId===t?0:-1)}}function la(n,i){if(n&1&&(hD(0,ca,1,1),ww(1,`async`)),n&2){let e;gD((e=Tw(1,1,OD().autoAssignStatus$))?0:-1,e)}}function ma(n,i){n&1&&(Mi(0,`span`,23),cw(1,`Rennen auswählen, um Messungen automatisch zuzuordnen.`),Jc())}function ua(n,i){n&1&&(Mi(0,`div`,24),Xp(1,`mat-spinner`,48),Jc())}function pa(n,i){n&1&&(Mi(0,`th`,49),cw(1,`ID`),Jc())}function ha(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),Jc()),n&2){let e=i.$implicit;dI(),wh(e.id)}}function ba(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Dauer`),Jc())}function _a(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();dI(),rl(` `,t.formatDuration(e.durationMs),` `)}}function ga(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Teilnehmer`),Jc())}function fa(n,i){if(n&1&&(Mi(0,`td`,51),cw(1),Jc()),n&2){let e=i.$implicit;Jp(`matTooltip`,e.participantId?`Bereits einem Rennen zugeordnet`:``),dI(),rl(` `,e.participantName||`-`,` `)}}function va(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Gemessen am`),Jc())}function Sa(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),ww(2,`date`),Jc()),n&2){let e=i.$implicit;dI(),rl(` `,Cw(2,1,e.measuredAt,`dd.MM.yyyy HH:mm:ss`),` `)}}function ya(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Aktionen`),Jc())}function ka(n,i){if(n&1){let e=CD();Mi(0,`td`,50)(1,`button`,52),ih(`click`,function(){let a=Lu(e).$implicit;return Pu(OD().openEditDialog(a))}),Mi(2,`mat-icon`),cw(3,`edit`),Jc()(),Mi(4,`button`,53),ih(`click`,function(){let a=Lu(e).$implicit;return Pu(OD().deleteMeasurement(a))}),Mi(5,`mat-icon`),cw(6,`delete`),Jc()()()}}function Ma(n,i){n&1&&Xp(0,`tr`,54)}function wa(n,i){n&1&&Xp(0,`tr`,55)}var Mn=class n{store=T(Pt);dialog=T(Yt);snackBar=T(Mt);actions$=T(MN);destroy$=new Q;autoRefresh$=new Q;trackById=(i,e)=>e.id;measurements$;races$;participants$;measurementsWithParticipants$;selectedRaceId$;autoAssignStatus$;loading$;scheduledImportEnabled$;deviceStatus$;timingProviderActive$;displayedColumns=[`id`,`duration`,`measuredAt`,`participant`,`actions`];lastUpdate=``;autoRefreshEnabled=!1;lastArchiveClearAfterArchive=!0;jsonImportInput=Fj.required(`jsonImportInput`);constructor(){this.measurements$=this.store.select(l$1),this.races$=this.store.select(l),this.participants$=this.store.select(p),this.loading$=this.store.select(Ne),this.timingProviderActive$=this.store.select(s$1).pipe(oe(i=>i?i.type!==`NONE`:!0)),this.measurementsWithParticipants$=mg([this.measurements$,this.participants$]).pipe(oe(([i,e])=>i.map(t=>z(G({},t),{participantName:t.participantId?this.getParticipantName(t.participantId,e):void 0}))),Ig(s$2)),this.scheduledImportEnabled$=this.store.select(Je),this.deviceStatus$=this.store.select(Oe),this.selectedRaceId$=this.store.select(s),this.autoAssignStatus$=this.store.select(we$1),this.actions$.pipe(AN(xe,be,De),wg(this.destroy$)).subscribe(i=>{let e=i.type===xe.type?`Automatik-Modus aktiviert`:i.type===be.type?`Automatik-Modus deaktiviert`:`Startnummer übersprungen`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(AN(Ae,Fe,Ie),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(C),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich erstellt`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(L),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Erstellen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(P),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich aktualisiert`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(f),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Aktualisieren der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(N),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich gelöscht`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(k),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim L\xF6schen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(q),wg(this.destroy$)).subscribe(({message:i})=>{let t=i.toLowerCase().includes(`device reset`)?`Alle Messungen wurden gelöscht (inkl. Gerät)`:`Alle Messungen wurden gelöscht (nur Datenbank)`;this.snackBar.open(t,`OK`,{duration:3e3})}),this.actions$.pipe(AN(J),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Löschen der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(U),wg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Kontinuierlicher Modus aktiviert`:`Kontinuierlicher Modus deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(AN(j),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des kontinuierlichen Modus`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(z$1),wg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Automatischer Import aktiviert (alle 5 Sekunden)`:`Automatischer Import deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(AN(G$1),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des automatischen Imports`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(V),wg(this.destroy$)).subscribe(({message:i})=>{let e=i.toLowerCase().includes(`device reset`),t=this.lastArchiveClearAfterArchive?e?`Messungen archiviert und Gerät zurückgesetzt. Bereit für das nächste Rennen.`:`Messungen archiviert. Bereit für das nächste Rennen.`:`Messungen archiviert. Datenbank und Gerät wurden nicht verändert.`;this.snackBar.open(t,`OK`,{duration:3e3})}),this.actions$.pipe(AN(W),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Archivieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(me),wg(this.destroy$)).subscribe(({connected:i})=>{i&&this.store.dispatch(X())}),this.actions$.pipe(AN($),wg(this.destroy$)).subscribe(()=>{this.store.dispatch(Me()),this.snackBar.open(`Ältester Start erfolgreich verworfen`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(ee),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Verwerfen des ältesten Starts`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(U),wg(this.destroy$)).subscribe(()=>{this.store.dispatch(X())}),this.actions$.pipe(AN(se),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messungen erfolgreich exportiert`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(re$1),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Exportieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(oe$1),wg(this.destroy$)).subscribe(({count:i})=>{this.snackBar.open(`${i} Messung(en) erfolgreich importiert`,`OK`,{duration:3e3}),this.loadData()}),this.actions$.pipe(AN(ae),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Importieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.timingProviderActive$.pipe(wg(this.destroy$)).subscribe(i=>{i&&this.store.dispatch(X())})}ngAfterViewInit(){this.loadData(),this.store.dispatch(i()),this.store.dispatch(H()),this.autoRefresh$.pipe(Dg(i=>i?vg(2e3):Ue),wg(this.destroy$)).subscribe(()=>{this.loadMeasurementData()}),this.autoRefresh$.next(this.autoRefreshEnabled)}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete(),this.autoRefresh$.complete()}onAutoRefreshToggle(){this.autoRefresh$.next(this.autoRefreshEnabled);let i=this.autoRefreshEnabled?`Automatische Aktualisierung aktiviert`:`Automatische Aktualisierung deaktiviert`;this.snackBar.open(i,`OK`,{duration:2e3})}manualRefresh(){this.loadData(),this.snackBar.open(`Daten wurden aktualisiert`,`OK`,{duration:2e3})}loadData(){this.store.dispatch(t()),this.loadMeasurementData()}loadMeasurementData(){this.store.dispatch(S()),this.store.dispatch(Me()),this.updateLastUpdateTime()}updateLastUpdateTime(){let i=new Date;this.lastUpdate=i.toLocaleTimeString(`de-DE`)}getParticipantName(i,e){let t=e.find(a=>a.id===i);return t?.person?`${t.person.firstName} ${t.person.lastName}`:`-`}getParticipantNameByRaceNumber(i,e,t){let a=t.find(c=>c.race?.id===i&&c.raceNumber===e);return a?.person?`${a.person.firstName} ${a.person.lastName}`:`unbekannt`}formatRaceDate(i){let e=i.split(`-`);if(e.length===3){let[t,a,c]=e;return`${c}.${a}.${t}`}return i}onRaceChange(i){this.store.dispatch(S$1({id:i})),i!==null?this.store.dispatch(Se({request:{raceId:i}})):this.store.dispatch(ge())}skipAutoAssign(){this.store.dispatch(ve$1())}formatDuration(i){let e=Math.floor(i/1e3),t=Math.floor(e/3600),a=Math.floor(e%3600/60),c=e%60,b=i%1e3;return t>0?`${t}:${String(a).padStart(2,`0`)}:${String(c).padStart(2,`0`)}.${String(b).padStart(3,`0`)}`:a>0?`${a}:${String(c).padStart(2,`0`)}.${String(b).padStart(3,`0`)}`:`${c}.${String(b).padStart(3,`0`)}s`}openCreateDialog(){this.dialog.open(te,{width:`500px`}).afterClosed().pipe(wg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(h({measurement:e}))})}openEditDialog(i){this.dialog.open(te,{width:`500px`,data:i}).afterClosed().pipe(wg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(R({id:i.id,measurement:t}))})}deleteMeasurement(i){confirm(`M\xF6chten Sie die Messung #${i.id} wirklich l\xF6schen?`)&&this.store.dispatch(E({id:i.id}))}resetMeasurements(i){confirm(i?`Möchten Sie wirklich ALLE Messungen löschen? Dies betrifft auch die Messungen auf dem Gerät!`:`Möchten Sie wirklich ALLE Messungen löschen (nur aus der Datenbank)?`)&&this.store.dispatch(B({resetDevice:i}))}toggleContinuousMode(i){confirm(i?`Möchten Sie den kontinuierlichen Modus wirklich aktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`:`Möchten Sie den kontinuierlichen Modus wirklich deaktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`)&&this.store.dispatch(O({enable:i}))}toggleScheduledImport(i){this.store.dispatch(w({enable:i}))}openArchiveDialog(){this.races$.pipe(tn(1)).subscribe(i=>{this.dialog.open(Ke,{width:`500px`,data:{races:i}}).afterClosed().pipe(wg(this.destroy$)).subscribe(t=>{t&&(this.lastArchiveClearAfterArchive=t.clearAfterArchive,this.store.dispatch(T$1(t)))})})}discardOldestStart(){confirm(`Möchten Sie den ältesten Start aus der Warteschlange verwerfen? Dies sollte verwendet werden, wenn ein Läufer gestürzt ist.`)&&this.store.dispatch(_())}exportMeasurements(){this.store.dispatch(te$1())}triggerJsonImport(){this.jsonImportInput().nativeElement.value=``,this.jsonImportInput().nativeElement.click()}onJsonFileSelected(i){let t=i.target.files?.[0];if(!t)return;let a=new FileReader;a.onload=c=>{try{let b=c.target?.result,T=JSON.parse(b);if(!Array.isArray(T)){this.snackBar.open(`Ungültiges JSON-Format: Array erwartet`,`OK`,{duration:5e3,panelClass:`error-snackbar`});return}this.store.dispatch(ne({measurements:T}))}catch{this.snackBar.open(`Fehler beim Lesen der JSON-Datei`,`OK`,{duration:5e3,panelClass:`error-snackbar`})}},a.readAsText(t)}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-measurement-list`]],viewQuery:function(e,t){e&1&&dh(t.jsonImportInput,Qn,5),e&2&&VD()},decls:102,vars:45,consts:[[`jsonImportInput`,``],[`resetMenu`,`matMenu`],[1,`title-row`],[1,`sync-status`],[`color`,`primary`,`matTooltip`,`Automatische Aktualisierung`,3,`ngModelChange`,`change`,`ngModel`],[`matTooltip`,`Aktualisiere...`,1,`sync-icon`,`syncing`],[1,`sync-icon`,3,`matTooltip`],[1,`last-update-text`],[1,`header-actions`],[`mat-raised-button`,``,`color`,`primary`,3,`click`],[`mat-raised-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Aktuelle Messungen einem Rennen zuordnen und archivieren`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Alle Messungen als JSON-Datei herunterladen`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Messungen aus JSON-Datei importieren`,3,`click`],[`type`,`file`,`accept`,`.json,application/json`,2,`display`,`none`,3,`change`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Alle Messungen zurücksetzen`,3,`matMenuTriggerFor`],[`mat-menu-item`,``,3,`click`],[1,`auto-assign-row`],[`appearance`,`outline`,1,`race-select`,3,`matTooltip`],[3,`selectionChange`,`value`,`disabled`],[3,`value`],[1,`hint`],[1,`loading-overlay`],[1,`table-container`],[`mat-table`,``,1,`measurement-table`,3,`dataSource`,`trackBy`],[`matColumnDef`,`id`],[`mat-header-cell`,``,4,`matHeaderCellDef`],[`mat-cell`,``,4,`matCellDef`],[`matColumnDef`,`duration`],[`matColumnDef`,`participant`],[`mat-cell`,``,3,`matTooltip`,4,`matCellDef`],[`matColumnDef`,`measuredAt`],[`matColumnDef`,`actions`],[`mat-header-row`,``,4,`matHeaderRowDef`],[`mat-row`,``,4,`matRowDef`,`matRowDefColumns`],[1,`count-info`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`,3,`click`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Aktuell erwartete Startnummer überspringen (z. B. nicht gestartet)`,3,`click`],[1,`next-number-info`],[`diameter`,`30`],[`mat-header-cell`,``],[`mat-cell`,``],[`mat-cell`,``,3,`matTooltip`],[`mat-icon-button`,``,`matTooltip`,`Bearbeiten`,3,`click`],[`mat-icon-button`,``,`color`,`warn`,`matTooltip`,`Löschen`,3,`click`],[`mat-header-row`,``],[`mat-row`,``]],template:function(e,t){if(e&1){let a=CD();Mi(0,`mat-card`)(1,`mat-card-header`)(2,`mat-card-title`)(3,`div`,2)(4,`span`),cw(5,`Messungen`),Jc(),Mi(6,`div`,3)(7,`mat-slide-toggle`,4),Nh(`ngModelChange`,function(b){return Lu(a),pw(t.autoRefreshEnabled,b)||(t.autoRefreshEnabled=b),Pu(b)}),ih(`change`,function(){return t.onAutoRefreshToggle()}),Jc(),XI(),hD(8,Zn,2,0,`mat-icon`,5),ww(9,`async`),Kc(10,Xn,2,2,`mat-icon`,6),Mi(11,`span`,7),cw(12),Jc()()()()(),Mi(13,`mat-card-content`)(14,`div`,8)(15,`button`,9),ih(`click`,function(){return t.openCreateDialog()}),Mi(16,`mat-icon`),cw(17,`add`),Jc(),cw(18,` Neue Messung `),Jc(),Mi(19,`button`,10),ih(`click`,function(){return t.manualRefresh()}),Mi(20,`mat-icon`),cw(21,`refresh`),Jc(),cw(22,` Manuell aktualisieren `),Jc(),Mi(23,`button`,11),ih(`click`,function(){return t.openArchiveDialog()}),Mi(24,`mat-icon`),cw(25,`archive`),Jc(),cw(26,` Archivieren `),Jc(),Mi(27,`button`,12),ih(`click`,function(){return t.exportMeasurements()}),Mi(28,`mat-icon`),cw(29,`download`),Jc(),cw(30,` JSON Export `),Jc(),Mi(31,`button`,13),ih(`click`,function(){return t.triggerJsonImport()}),Mi(32,`mat-icon`),cw(33,`upload`),Jc(),cw(34,` JSON Import `),Jc(),Mi(35,`input`,14,0),ih(`change`,function(b){return t.onJsonFileSelected(b)}),Jc(),hD(37,ia,5,6),ww(38,`async`),hD(39,na,4,0,`button`,15),ww(40,`async`),Kc(41,aa,4,0,`button`,16),Mi(42,`button`,17)(43,`mat-icon`),cw(44,`delete_sweep`),Jc(),cw(45,` Zurücksetzen `),Mi(46,`mat-icon`),cw(47,`arrow_drop_down`),Jc()(),Mi(48,`mat-menu`,null,1)(50,`button`,18),ih(`click`,function(){return t.resetMeasurements(!1)}),Mi(51,`mat-icon`),cw(52,`delete_sweep`),Jc(),Mi(53,`span`),cw(54,`Alle Messungen löschen (nur Datenbank)`),Jc()(),Mi(55,`button`,18),ih(`click`,function(){return t.resetMeasurements(!0)}),Mi(56,`mat-icon`),cw(57,`delete_forever`),Jc(),Mi(58,`span`),cw(59,`Alle löschen (inkl. Gerät)`),Jc()()()(),Mi(60,`div`,19)(61,`mat-form-field`,20),ww(62,`async`),Mi(63,`mat-label`),cw(64,`Rennen (Automatik-Zuordnung)`),Jc(),Mi(65,`mat-select`,21),ww(66,`async`),ww(67,`async`),ih(`selectionChange`,function(b){return t.onRaceChange(b.value)}),Mi(68,`mat-option`,22),cw(69,`— kein Rennen —`),Jc(),vD(70,ra,2,3,`mat-option`,22,Jn),ww(72,`async`),Jc()(),hD(73,la,2,3),ww(74,`async`),Kc(75,ma,2,0,`span`,23),Jc(),hD(76,ua,2,0,`div`,24),ww(77,`async`),Mi(78,`div`,25)(79,`table`,26),ww(80,`async`),ww(81,`async`),tl(82,27),Wp(83,pa,2,0,`th`,28)(84,ha,2,1,`td`,29),nl(),tl(85,30),Wp(86,ba,2,0,`th`,28)(87,_a,2,1,`td`,29),nl(),tl(88,31),Wp(89,ga,2,0,`th`,28)(90,fa,2,2,`td`,32),nl(),tl(91,33),Wp(92,va,2,0,`th`,28)(93,Sa,3,4,`td`,29),nl(),tl(94,34),Wp(95,ya,2,0,`th`,28)(96,ka,7,0,`td`,29),nl(),Wp(97,Ma,1,0,`tr`,35)(98,wa,1,0,`tr`,36),Jc()(),Mi(99,`div`,37),cw(100),ww(101,`async`),Jc()()()}if(e&2){let a,c=HD(49);dI(7),_h(`ngModel`,t.autoRefreshEnabled),tE(),dI(),gD(Tw(9,19,t.loading$)?8:10),dI(4),wh(t.lastUpdate),dI(25),gD(Tw(38,21,t.timingProviderActive$)?37:-1),dI(2),gD(Tw(40,23,t.scheduledImportEnabled$)?39:41),dI(3),Jp(`matMenuTriggerFor`,c),dI(19),Jp(`matTooltip`,Tw(62,25,t.scheduledImportEnabled$)?`Automatischen Import zuerst deaktivieren, um das Rennen zu wechseln`:`Rennen auswählen startet die automatische Zuordnung, abwählen stoppt sie`),dI(4),Jp(`value`,Tw(66,27,t.selectedRaceId$))(`disabled`,!!Tw(67,29,t.scheduledImportEnabled$)),dI(3),Jp(`value`,null),dI(2),ID(Tw(72,31,t.races$)),dI(3),gD((a=Tw(74,33,t.selectedRaceId$))?73:75,a),dI(3),gD(Tw(77,35,t.loading$)?76:-1),dI(3),gh(`loading`,Tw(80,37,t.loading$)),Jp(`dataSource`,Tw(81,39,t.measurementsWithParticipants$)||Iw(43,Ye))(`trackBy`,t.trackById),dI(18),Jp(`matHeaderRowDef`,t.displayedColumns),dI(),Jp(`matRowDefColumns`,t.displayedColumns),dI(2),rl(` Anzahl der Messungen: `,(Tw(101,41,t.measurements$)||Iw(44,Ye)).length,` `)}},dependencies:[qa,bn,fn,pn,Cn$1,gn,mn,wn,_n$1,yn$1,Dn$1,vn,BE,VE,np,We,Xe$1,pN,mN,po,Xt,Dx,_x,vx,Sx,bx,we$2,Wt,_n,Ze,Lt,I,G$2,Bt,gE,Cc,Wo,pE,or,Qn$1,ID$1,AD,Sm,Vu,ju],styles:[`.title-row[_ngcontent-%COMP%]{display:flex;justify-content:space-between;align-items:center;width:100%;gap:32px}.sync-status[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;font-size:.875rem;color:#0009}.sync-icon[_ngcontent-%COMP%]{font-size:20px;width:20px;height:20px;color:#0009}.sync-icon.syncing[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_spin 1s linear infinite;color:#3f51b5}@keyframes _ngcontent-%COMP%_spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.last-update-text[_ngcontent-%COMP%]{font-size:.75rem;white-space:nowrap}.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px;position:relative;flex-wrap:wrap;align-items:center}.active-mode[_ngcontent-%COMP%]{background-color:#4caf50!important;color:#fff!important}.active-mode[_ngcontent-%COMP%]:hover{background-color:#45a049!important}.auto-assign-row[_ngcontent-%COMP%]{margin-bottom:20px;display:flex;gap:16px;flex-wrap:wrap;align-items:center}.race-select[_ngcontent-%COMP%]{min-width:280px}.next-number-info[_ngcontent-%COMP%]{font-size:.9rem;color:#000000b3}.hint[_ngcontent-%COMP%]{color:#0009}.loading-overlay[_ngcontent-%COMP%]{position:absolute;top:0;right:0;z-index:10;display:flex;align-items:center;justify-content:center;padding:10px}.measurement-table[_ngcontent-%COMP%]{width:100%;transition:opacity .2s ease}.measurement-table.loading[_ngcontent-%COMP%]{opacity:.6}mat-card[_ngcontent-%COMP%]{margin:20px}mat-card-content[_ngcontent-%COMP%]{position:relative}.count-info[_ngcontent-%COMP%]{margin-top:16px;padding:12px 16px;background-color:#f5f5f5;border-radius:4px;font-size:14px;font-weight:500;color:#000000de}@media(max-width:768px){mat-card[_ngcontent-%COMP%]{margin:8px}.title-row[_ngcontent-%COMP%]{flex-wrap:wrap;gap:8px}}`]})};export{Mn as MeasurementListComponent};