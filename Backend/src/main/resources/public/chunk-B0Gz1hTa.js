...
`],encapsulation:2})}return i})();var Ne=(()=>{class i{static ɵfac=function(e){return new(e||i)};static ɵmod=WE({type:i});static ɵinj=lu({providers:[$r,{provide:Te,useValue:{separatorKeyCodes:[13]}}],imports:[Gr,X]})}return i})();var ut=eN(`person`);var Oe=Jp$1(ut,i=>i.persons);var ke=Jp$1(ut,i=>i.loading);Jp$1(ut,i=>i.error);var Ie=Jp$1(Oe,p,(i,n)=>{let t=new Map;for(let e of n){if(!e.person||!e.race)continue;let a=t.get(e.person.id)??[];a.push(e.race),t.set(e.person.id,a)}return i.map(e=>z$1(G({},e),{activeRaces:t.get(e.id)??[]}))});var Ge=(i,n)=>n.value;function qe(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Vorname ist erforderlich`),Jc())}function $e(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Vorname darf nicht nur aus Leerzeichen bestehen`),Jc())}function je(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Nachname ist erforderlich`),Jc())}function Qe(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Nachname darf nicht nur aus Leerzeichen bestehen`),Jc())}function Ke(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Geburtsdatum ist erforderlich`),Jc())}function We(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Geburtsdatum muss zwischen 1900 und heute liegen`),Jc())}function Ue(i,n){if(i&1&&(Mi(0,`mat-option`,9),cw(1),Jc()),i&2){let t=n.$implicit;Jp(`value`,t.value),dI(),wh(t.label)}}function Je(i,n){i&1&&(Mi(0,`mat-error`),cw(1,`Geschlecht ist erforderlich`),Jc())}var z=class i{fb=T(iC);minBirthDate=new Date(1900,0,1);maxBirthDate=new Date;dialogRef=T($e$1);data=T(Un);form;genderOptions=[{value:`MALE`,label:e.MALE},{value:`FEMALE`,label:e.FEMALE}];constructor(){let n$1=this.data?.birthDate||``;if(n$1&&typeof n$1==`string`){let t=n$1.split(`-`);t.length===3&&(n$1=new Date(parseInt(t[0]),parseInt(t[1])-1,parseInt(t[2])))}this.form=this.fb.group({firstName:[this.data?.firstName||``,[jt.required,n()]],lastName:[this.data?.lastName||``,[jt.required,n()]],birthDate:[n$1,jt.required],gender:[this.data?.gender||``,jt.required],externalId:[this.data?.externalId||``]})}onCancel(){this.dialogRef.close()}onSave(){if(this.form.valid){let n=this.form.value,t={firstName:n.firstName,lastName:n.lastName,birthDate:this.formatDate(n.birthDate),gender:n.gender,externalId:n.externalId||void 0};this.dialogRef.close(t)}}formatDate(n){if(typeof n==`string`)return n;let t=new Date(n);return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}static ɵfac=function(t){return new(t||i)};static ɵcmp=UE({type:i,selectors:[[`app-person-dialog`]],decls:45,vars:14,consts:[[`picker`,``],[`mat-dialog-title`,``],[1,`person-form`,3,`formGroup`],[`appearance`,`outline`],[`matInput`,``,`formControlName`,`firstName`,`required`,``],[`matInput`,``,`formControlName`,`lastName`,`required`,``],[`matInput`,``,`formControlName`,`birthDate`,`placeholder`,`TT.MM.JJJJ`,`required`,``,3,`matDatepicker`,`min`,`max`],[`matSuffix`,``,3,`for`],[`formControlName`,`gender`,`required`,``],[3,`value`],[`matInput`,``,`formControlName`,`externalId`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`]],template:function(t,e){if(t&1&&(Mi(0,`h2`,1),cw(1),Jc(),Mi(2,`mat-dialog-content`)(3,`form`,2)(4,`mat-form-field`,3)(5,`mat-label`),cw(6,`Vorname`),Jc(),Xp(7,`input`,4),XI(),hD(8,qe,2,0,`mat-error`),hD(9,$e,2,0,`mat-error`),Jc(),Mi(10,`mat-form-field`,3)(11,`mat-label`),cw(12,`Nachname`),Jc(),Xp(13,`input`,5),XI(),hD(14,je,2,0,`mat-error`),hD(15,Qe,2,0,`mat-error`),Jc(),Mi(16,`mat-form-field`,3)(17,`mat-label`),cw(18,`Geburtsdatum`),Jc(),Xp(19,`input`,6),XI(),Xp(20,`mat-datepicker-toggle`,7)(21,`mat-datepicker`,null,0),Mi(23,`mat-hint`),cw(24,`Format: TT.MM.JJJJ (z.B. 24.3.2022)`),Jc(),hD(25,Ke,2,0,`mat-error`),hD(26,We,2,0,`mat-error`),Jc(),Mi(27,`mat-form-field`,3)(28,`mat-label`),cw(29,`Geschlecht`),Jc(),Mi(30,`mat-select`,8),vD(31,Ue,2,2,`mat-option`,9,Ge),Jc(),XI(),hD(33,Je,2,0,`mat-error`),Jc(),Mi(34,`mat-form-field`,3)(35,`mat-label`),cw(36,`Externe ID (optional)`),Jc(),Xp(37,`input`,10),XI(),Mi(38,`mat-hint`),cw(39,`Vereins-/Verbandsnummer, falls vorhanden`),Jc()()()(),Mi(40,`mat-dialog-actions`,11)(41,`button`,12),ih(`click`,function(){return e.onCancel()}),cw(42,`Abbrechen`),Jc(),Mi(43,`button`,13),ih(`click`,function(){return e.onSave()}),cw(44,` Speichern `),Jc()()),t&2){let a=HD(22);dI(),rl(` `,e.data?`Person bearbeiten`:`Neue Person`,` `),dI(2),Jp(`formGroup`,e.form),dI(4),tE(),dI(),gD(e.form.get(`firstName`)?.hasError(`required`)&&e.form.get(`firstName`)?.touched?8:-1),dI(),gD(e.form.get(`firstName`)?.hasError(`blank`)?9:-1),dI(4),tE(),dI(),gD(e.form.get(`lastName`)?.hasError(`required`)&&e.form.get(`lastName`)?.touched?14:-1),dI(),gD(e.form.get(`lastName`)?.hasError(`blank`)?15:-1),dI(4),Jp(`matDatepicker`,a)(`min`,e.minBirthDate)(`max`,e.maxBirthDate),tE(),dI(),Jp(`for`,a),dI(5),gD(e.form.get(`birthDate`)?.hasError(`required`)&&e.form.get(`birthDate`)?.touched?25:-1),dI(),gD(e.form.get(`birthDate`)?.hasError(`matDatepickerMin`)||e.form.get(`birthDate`)?.hasError(`matDatepickerMax`)?26:-1),dI(4),tE(),dI(),ID(e.genderOptions),dI(2),gD(e.form.get(`gender`)?.hasError(`required`)&&e.form.get(`gender`)?.touched?33:-1),dI(4),tE(),dI(6),Jp(`disabled`,!e.form.valid)}},dependencies:[il,oC,nC,Uc,JD,eC,od$1,oi,Lm,zo,Po,jo,Lo,si,Fc,ss,as,Yh,qh,YM,WM,kx,Ox,bn$1,fn$2,Xt,Va,Y,jE,BE,_r],styles:[`.person-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:16px;min-width:400px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}`]})};var Ze=()=>[10,25,50,100];var Xe=(i,n)=>n.id;function Ye(i,n){i&1&&(Mi(0,`div`,3),Xp(1,`mat-spinner`),Jc())}function tn(i,n){i&1&&(Mi(0,`th`,20),cw(1,`ID`),Jc())}function en(i,n){if(i&1&&(Mi(0,`td`,21),cw(1),Jc()),i&2){let t=n.$implicit;dI(),wh(t.id)}}function nn(i,n){i&1&&(Mi(0,`th`,20),cw(1,`Nachname`),Jc())}function an(i,n){if(i&1&&(Mi(0,`td`,21),cw(1),Jc()),i&2){let t=n.$implicit;dI(),wh(t.lastName)}}function on(i,n){i&1&&(Mi(0,`th`,20),cw(1,`Vorname`),Jc())}function cn(i,n){if(i&1&&(Mi(0,`td`,21),cw(1),Jc()),i&2){let t=n.$implicit;dI(),wh(t.firstName)}}function rn(i,n){i&1&&(Mi(0,`th`,20),cw(1,`Geburtsdatum`),Jc())}function sn(i,n){if(i&1&&(Mi(0,`td`,21),cw(1),Jc()),i&2){let t=n.$implicit,e=OD();dI(),wh(e.formatRaceDate(t.birthDate))}}function dn(i,n){i&1&&(Mi(0,`th`,20),cw(1,`Geschlecht`),Jc())}function ln(i,n){if(i&1&&(Mi(0,`td`,21),cw(1),Jc()),i&2){let t=n.$implicit,e=OD();dI(),wh(e.getGenderLabel(t.gender))}}function pn(i,n){i&1&&(Mi(0,`th`,20),cw(1,`Externe ID`),Jc())}function hn(i,n){if(i&1&&(Mi(0,`td`,21),cw(1),Jc()),i&2){let t=n.$implicit;dI(),wh(t.externalId||`-`)}}function mn(i,n){i&1&&(Mi(0,`th`,22),cw(1,`Aktiv bei Rennen`),Jc())}function un(i,n){if(i&1&&(Mi(0,`mat-chip`),cw(1),Jc()),i&2){let t=n.$implicit;dI(),wh(t.name)}}function _n(i,n){if(i&1&&(Mi(0,`mat-chip-set`),vD(1,un,2,1,`mat-chip`,null,Xe),Jc()),i&2){let t=OD().$implicit;dI(),ID(t.activeRaces)}}function vn(i,n){i&1&&(Mi(0,`span`,23),cw(1,`-`),Jc())}function fn(i,n){if(i&1&&(Mi(0,`td`,21),hD(1,_n,3,0,`mat-chip-set`)(2,vn,2,0,`span`,23),Jc()),i&2){let t=n.$implicit;dI(),gD(t.activeRaces.length?1:2)}}function gn(i,n){i&1&&(Mi(0,`th`,22),cw(1,`Aktionen`),Jc())}function yn(i,n){if(i&1){let t=CD();Mi(0,`td`,21)(1,`button`,24),ih(`click`,function(){let a=Lu(t).$implicit;return Pu(OD().openEditDialog(a))}),Mi(2,`mat-icon`),cw(3,`edit`),Jc()(),Mi(4,`button`,25),ih(`click`,function(){let a=Lu(t).$implicit;return Pu(OD().deletePerson(a))}),Mi(5,`mat-icon`),cw(6,`delete`),Jc()()()}if(i&2){let t=n.$implicit;dI(4),Jp(`disabled`,t.activeRaces.length>0)(`matTooltip`,t.activeRaces.length>0?`Kann nicht gelöscht werden, solange die Person einem Rennen zugeordnet ist`:`Löschen`)}}function bn(i,n){i&1&&Xp(0,`tr`,26)}function Cn(i,n){i&1&&Xp(0,`tr`,27)}var Me=class i$2{store=T(Yt);dialog=T(fn$1);snackBar=T(ni);actions$=T(cM);destroy$=new Q;persons$;loading$;displayedColumns=[`id`,`lastName`,`firstName`,`birthDate`,`gender`,`externalId`,`activeRaces`,`actions`];dataSource=new rn$1([]);trackById=(n,t)=>t.id;sortInitialized=!1;paginatorInitialized=!1;sort=Fj.required(W);paginator=Fj.required(st);constructor(){this.persons$=this.store.select(Ie),this.loading$=this.store.select(ke),this.actions$.pipe(dM(c),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Person erfolgreich erstellt`,`OK`,{duration:3e3})}),this.actions$.pipe(dM(a),wg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim Erstellen der Person: ${n}`,`OK`,{duration:5e3})}),this.actions$.pipe(dM(u),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Person erfolgreich aktualisiert`,`OK`,{duration:3e3})}),this.actions$.pipe(dM(d),wg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim Aktualisieren der Person: ${n}`,`OK`,{duration:5e3})}),this.actions$.pipe(dM(l),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Person erfolgreich gelöscht`,`OK`,{duration:3e3})}),this.actions$.pipe(dM(x),wg(this.destroy$)).subscribe(({error:n})=>{this.snackBar.open(`FEHLER beim L\xF6schen der Person: ${n}`,`OK`,{duration:5e3})}),od(()=>{let n=this.sort();n&&!this.sortInitialized&&setTimeout(()=>{this.dataSource.sort=n,this.sortInitialized=!0},100)}),od(()=>{let n=this.paginator();n&&!this.paginatorInitialized&&setTimeout(()=>{this.dataSource.paginator=n,this.paginatorInitialized=!0},100)})}ngAfterViewInit(){this.store.dispatch(o()),this.store.dispatch(i()),this.persons$.pipe(wg(this.destroy$)).subscribe(n=>{this.dataSource.data=n})}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete()}openCreateDialog(){this.dialog.open(z,{width:`500px`}).afterClosed().pipe(wg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(P({person:t}))})}openEditDialog(n){this.dialog.open(z,{width:`500px`,data:n}).afterClosed().pipe(wg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(p$1({id:n.id,person:e}))})}deletePerson(n){n.activeRaces.length>0||confirm(`M\xF6chten Sie die Person "${n.lastName} ${n.firstName}" wirklich l\xF6schen?`)&&this.store.dispatch(i$1({id:n.id}))}refreshData(){this.store.dispatch(o()),this.store.dispatch(i()),this.snackBar.open(`Daten werden aktualisiert...`,`OK`,{duration:2e3})}getGenderLabel(n){return n?e[n]||n:`—`}formatRaceDate(n){let t=n.split(`-`);if(t.length===3){let e=t[0],a=t[1];return`${t[2]}.${a}.${e}`}return n}static ɵfac=function(t){return new(t||i$2)};static ɵcmp=UE({type:i$2,selectors:[[`app-person-list`]],viewQuery:function(t,e){t&1&&dh(e.sort,W,5)(e.paginator,st,5),t&2&&VD(2)},decls:46,vars:13,consts:[[1,`header-actions`],[`mat-raised-button`,``,`color`,`primary`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Daten aktualisieren`,3,`click`],[1,`loading-container`],[1,`table-container`],[`mat-table`,``,`matSort`,``,1,`person-table`,3,`dataSource`,`trackBy`],[`matColumnDef`,`id`],[`mat-header-cell`,``,`mat-sort-header`,``,4,`matHeaderCellDef`],[`mat-cell`,``,4,`matCellDef`],[`matColumnDef`,`lastName`],[`matColumnDef`,`firstName`],[`matColumnDef`,`birthDate`],[`matColumnDef`,`gender`],[`matColumnDef`,`externalId`],[`matColumnDef`,`activeRaces`],[`mat-header-cell`,``,4,`matHeaderCellDef`],[`matColumnDef`,`actions`],[`mat-header-row`,``,4,`matHeaderRowDef`],[`mat-row`,``,4,`matRowDef`,`matRowDefColumns`],[`showFirstLastButtons`,``,3,`pageSizeOptions`],[`mat-header-cell`,``,`mat-sort-header`,``],[`mat-cell`,``],[`mat-header-cell`,``],[1,`no-races`],[`mat-icon-button`,``,`matTooltip`,`Bearbeiten`,3,`click`],[`mat-icon-button`,``,`color`,`warn`,3,`click`,`disabled`,`matTooltip`],[`mat-header-row`,``],[`mat-row`,``]],template:function(t,e){t&1&&(Mi(0,`mat-card`)(1,`mat-card-header`)(2,`mat-card-title`),cw(3,`Personen`),Jc()(),Mi(4,`mat-card-content`)(5,`div`,0)(6,`button`,1),ih(`click`,function(){return e.openCreateDialog()}),Mi(7,`mat-icon`),cw(8,`add`),Jc(),cw(9,` Neue Person `),Jc(),Mi(10,`button`,2),ih(`click`,function(){return e.refreshData()}),Mi(11,`mat-icon`),cw(12,`refresh`),Jc(),cw(13,` Aktualisieren `),Jc()(),hD(14,Ye,2,0,`div`,3),ww(15,`async`),Mi(16,`div`,4)(17,`table`,5),ww(18,`async`),tl(19,6),Wp(20,tn,2,0,`th`,7)(21,en,2,1,`td`,8),nl(),tl(22,9),Wp(23,nn,2,0,`th`,7)(24,an,2,1,`td`,8),nl(),tl(25,10),Wp(26,on,2,0,`th`,7)(27,cn,2,1,`td`,8),nl(),tl(28,11),Wp(29,rn,2,0,`th`,7)(30,sn,2,1,`td`,8),nl(),tl(31,12),Wp(32,dn,2,0,`th`,7)(33,ln,2,1,`td`,8),nl(),tl(34,13),Wp(35,pn,2,0,`th`,7)(36,hn,2,1,`td`,8),nl(),tl(37,14),Wp(38,mn,2,0,`th`,15)(39,fn,3,1,`td`,8),nl(),tl(40,16),Wp(41,gn,2,0,`th`,15)(42,yn,7,2,`td`,8),nl(),Wp(43,bn,1,0,`tr`,17)(44,Cn,1,0,`tr`,18),Jc()(),Xp(45,`mat-paginator`,19),Jc()()),t&2&&(dI(14),gD(Tw(15,8,e.loading$)?14:-1),dI(3),gh(`hidden`,Tw(18,10,e.loading$)),Jp(`dataSource`,e.dataSource)(`trackBy`,e.trackById),dI(26),Jp(`matHeaderRowDef`,e.displayedColumns),dI(),Jp(`matRowDefColumns`,e.displayedColumns),dI(),Jp(`pageSizeOptions`,Iw(12,Ze)))},dependencies:[il,Zi,ji,Hi,Wi,Vi,zi,qi,Ui,Qi,Gi,$i,kx,Ox,fp,wN,CN,KN,qN,zo,ra,VN,IN,kN,LN,ON,Ax,Dp,gt,W,pt,It,st,Ne,mt,xe,Ku],styles:[`.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px}.loading-container[_ngcontent-%COMP%]{display:flex;justify-content:center;padding:40px}.person-table[_ngcontent-%COMP%]{width:100%}.hidden[_ngcontent-%COMP%]{display:none}mat-card[_ngcontent-%COMP%]{margin:20px}th.mat-sort-header-sorted[_ngcontent-%COMP%]{color:#000}.no-races[_ngcontent-%COMP%]{color:#0006}mat-chip-set[_ngcontent-%COMP%]{max-width:320px}`]})};export{Me as PersonListComponent};