...
`],encapsulation:2})}return n})();var In=(()=>{class n{static ɵfac=function(t){return new(t||n)};static ɵmod=WE({type:n});static ɵinj=uu({imports:[Tr,Ue,re]})}return n})();var Jn=(n,i)=>i.id;function ea(n,i){if(n&1&&(Mi(0,`mat-option`,4),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();Xp(`value`,e.id),dI(),Th(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function ta(n,i){n&1&&(Mi(0,`mat-error`),cw(1,`Bitte ein Rennen auswählen`),Jc())}function ia(n,i){n&1&&(Mi(0,`mat-error`),cw(1,`Bitte eine Archivierungs-Variante auswählen`),Jc())}var We=class n{fb=T(OD$1);dialogRef=T(he);data=T(Ti);form=this.fb.group({raceId:[null,Ot.required],mode:[null,Ot.required]});onCancel(){this.dialogRef.close()}onSave(){if(!this.form.valid)return;let i=this.form.value.mode,e={raceId:Number(this.form.value.raceId),resetDevice:i===`reset`,clearAfterArchive:i!==`noclear`};this.dialogRef.close(e)}formatRaceDate(i){let e=i.split(`-`);return e.length===3?`${e[2]}.${e[1]}.${e[0]}`:i}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-archive-measurements-dialog`]],decls:30,vars:4,consts:[[`mat-dialog-title`,``],[1,`archive-form`,3,`formGroup`],[`appearance`,`outline`],[`formControlName`,`raceId`,`required`,``],[3,`value`],[`formControlName`,`mode`,1,`mode-group`],[`value`,`reset`],[1,`hint`],[`value`,`keep`],[`value`,`noclear`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`]],template:function(e,t){e&1&&(Mi(0,`h2`,0),cw(1,`Messungen archivieren`),Jc(),Mi(2,`mat-dialog-content`)(3,`form`,1)(4,`mat-form-field`,2)(5,`mat-label`),cw(6,`Rennen`),Jc(),Mi(7,`mat-select`,3),vD(8,ea,2,3,`mat-option`,4,Jn),Jc(),XI(),hD(10,ta,2,0,`mat-error`),Jc(),Mi(11,`mat-radio-group`,5)(12,`mat-radio-button`,6),cw(13,` Archivieren (inkl. Gerät-Reset) `),Mi(14,`p`,7),cw(15,`Aktuelle Messungen werden diesem Rennen zugeordnet, danach werden Datenbank und Gerät geleert. Bereit für das nächste Rennen.`),Jc()(),Mi(16,`mat-radio-button`,8),cw(17,` Archivieren (nur Datenbank) `),Mi(18,`p`,7),cw(19,`Wie oben, aber nur die Datenbank wird geleert, das Gerät bleibt unverändert.`),Jc()(),Mi(20,`mat-radio-button`,9),cw(21,` Archivieren (ohne Löschen) `),Mi(22,`p`,7),cw(23,`Aktuelle Messungen werden diesem Rennen zugeordnet. Datenbank und Gerät werden dabei NICHT verändert.`),Jc()()(),XI(),hD(24,ia,2,0,`mat-error`),Jc()(),Mi(25,`mat-dialog-actions`,10)(26,`button`,11),sh(`click`,function(){return t.onCancel()}),cw(27,`Abbrechen`),Jc(),Mi(28,`button`,12),sh(`click`,function(){return t.onSave()}),cw(29,` Archivieren `),Jc()()),e&2&&(dI(3),Xp(`formGroup`,t.form),dI(4),tE(),dI(),ID(t.data.races),dI(2),gD(t.form.get(`raceId`)?.hasError(`required`)&&t.form.get(`raceId`)?.touched?10:-1),dI(),tE(),dI(13),gD(t.form.get(`mode`)?.hasError(`required`)&&t.form.get(`mode`)?.touched?24:-1),dI(4),Xp(`disabled`,!t.form.valid))},dependencies:[qa$1,kD$1,TD,AD,RD,Zc,Zn$1,Nm,go,fo,po,mo,Qn$1,Cc,Wo,kh,gE,pE,or,In,lt,Ue,BE,VE],styles:[`.archive-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px;min-width:420px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}.mode-group[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:12px}.hint[_ngcontent-%COMP%]{margin:2px 0 0;font-size:12px;color:#0009}`]})};var Dn=[{key:`participantId`,label:`Teilnehmer-ID`,required:!1},{key:`durationMs`,label:`Dauer (ms)`,required:!0},{key:`measuredAt`,label:`Gemessen am`,required:!1}];var ra=(n,i)=>i.value;var ct=(n,i)=>i.key;function oa(n,i){if(n&1&&(Mi(0,`span`,6),cw(1),Jc()),n&2){let e=OD();dI(),bh(e.file().name)}}function sa(n,i){if(n&1&&(Mi(0,`mat-option`,15),cw(1),Jc()),n&2){let e=i.$implicit;Xp(`value`,e.value),dI(),bh(e.label)}}function da(n,i){if(n&1){let e=CD();Mi(0,`div`,7)(1,`mat-form-field`,13)(2,`mat-label`),cw(3,`Trennzeichen`),Jc(),Mi(4,`mat-select`,14),sh(`selectionChange`,function(a){Pu(e);return Fu(OD().onDelimiterChange(a.value))}),vD(5,sa,2,2,`mat-option`,15,ra),Jc()()()}if(n&2){let e=OD();dI(4),Xp(`value`,e.delimiter()),dI(),ID(e.delimiterOptions)}}function la(n,i){n&1&&(Mi(0,`div`,8),eh(1,`mat-spinner`,16),Mi(2,`span`),cw(3,`Datei wird analysiert...`),Jc()())}function ca(n,i){if(n&1&&(Mi(0,`p`,9),cw(1),Jc()),n&2){let e=OD();dI(),bh(e.previewError())}}function ma(n,i){if(n&1&&(Mi(0,`mat-option`,15),cw(1),Jc()),n&2){let e=i.$implicit;Xp(`value`,e),dI(),bh(e)}}function ua(n,i){if(n&1&&(Mi(0,`mat-form-field`,13)(1,`mat-label`),cw(2),Jc(),Mi(3,`mat-select`,18)(4,`mat-option`,19),cw(5,`— nicht importieren —`),Jc(),vD(6,ma,2,2,`mat-option`,15,yD),Jc(),XI(),Jc()),n&2){let e=i.$implicit,t=OD();dI(2),Th(``,e.label,``,e.required?` *`:``),dI(),Xp(`formControlName`,e.key),tE(),dI(3),ID(t.availableFields)}}function pa(n,i){if(n&1&&(Mi(0,`th`),cw(1),Jc()),n&2){let e=i.$implicit;dI(),bh(e.label)}}function ha(n,i){if(n&1&&(Mi(0,`td`),cw(1),Jc()),n&2){let e=i.$implicit,t=OD().$implicit,a=OD(3);dI(),bh(a.previewValue(t,e.key))}}function ga(n,i){if(n&1&&(Mi(0,`tr`),vD(1,ha,2,1,`td`,null,ct),Jc()),n&2){let e=OD(3);dI(),ID(e.targetFields)}}function _a(n,i){if(n&1&&(Mi(0,`h3`),cw(1,`Vorschau`),Jc(),Mi(2,`div`,20)(3,`table`,21)(4,`thead`)(5,`tr`),vD(6,pa,2,1,`th`,null,ct),Jc()(),Mi(8,`tbody`),vD(9,ga,3,0,`tr`,null,mD),Jc()()()),n&2){let e=OD(),t=OD();dI(6),ID(t.targetFields),dI(3),ID(e.sampleRows)}}function ba(n,i){if(n&1&&(Mi(0,`h3`),cw(1,`Spalten zuordnen`),Jc(),Mi(2,`form`,17),vD(3,ua,8,3,`mat-form-field`,13,ct),Jc(),hD(5,_a,11,0)),n&2){let e=OD();dI(2),Xp(`formGroup`,e.mappingForm),dI(),ID(e.targetFields),dI(2),gD(i.sampleRows.length>0?5:-1)}}var Qe=class n{fb=T(OD$1);measurementService=T(x);dialogRef=T(he);targetFields=Dn;delimiterOptions=[{value:``,label:`Automatisch erkennen`},{value:`;`,label:`Semikolon (;)`},{value:`,`,label:`Komma (,)`},{value:`	`,label:`Tab`},{value:`|`,label:`Pipe (|)`}];file=Yo(null);delimiter=Yo(``);previewLoading=Yo(!1);previewError=Yo(null);preview=Yo(null);mappingForm=this.fb.group(Object.fromEntries(this.targetFields.map(i=>[i.key,[``]])));onFileSelected(i){let t=i.target.files?.[0]??null;this.file.set(t),this.preview.set(null),this.previewError.set(null),t?this.analyze():(this.analyzeRequestId++,this.previewLoading.set(!1))}onDelimiterChange(i){this.delimiter.set(i),this.analyze()}analyzeRequestId=0;analyze(){let i=this.file();if(!i)return;let e=++this.analyzeRequestId;this.previewLoading.set(!0),this.previewError.set(null),this.measurementService.previewImport(i,this.delimiter()||void 0).subscribe({next:t=>{if(e!==this.analyzeRequestId)return;this.previewLoading.set(!1),this.preview.set(t);let a={};for(let l of this.targetFields)a[l.key]=t.suggestedMapping[l.key]??``;this.mappingForm.patchValue(a)},error:t=>{e===this.analyzeRequestId&&(this.previewLoading.set(!1),this.preview.set(null),this.previewError.set(t?.error?.message??`Datei konnte nicht gelesen/analysiert werden.`))}})}previewValue(i,e){let t=this.mappingForm.get(e)?.value;return t?i[t]??``:``}onCancel(){this.dialogRef.close()}onImport(){let i=this.file();if(!i)return;let e=this.mappingForm.value,t={};for(let[l,b]of Object.entries(e))b&&(t[l]=b);let a={file:i,delimiter:this.delimiter()||void 0,mapping:t};this.dialogRef.close(a)}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-measurement-import-mapping-dialog`]],decls:22,vars:6,consts:[[`fileInput`,``],[`mat-dialog-title`,``],[1,`hint`],[1,`file-row`],[`type`,`file`,`accept`,`.csv,.txt,text/csv`,`hidden`,``,3,`change`],[`mat-raised-button`,``,3,`click`],[1,`filename`],[1,`format-row`],[1,`loading-row`],[1,`error`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`],[`appearance`,`outline`],[3,`selectionChange`,`value`],[3,`value`],[`diameter`,`24`],[1,`mapping-grid`,3,`formGroup`],[3,`formControlName`],[`value`,``],[1,`preview-table-wrapper`],[1,`preview-table`]],template:function(e,t){if(e&1){let a=CD();Mi(0,`h2`,1),cw(1,`Messungen importieren`),Jc(),Mi(2,`mat-dialog-content`)(3,`p`,2),cw(4,` CSV-Datei (beliebiges Trennzeichen). Ordne die Spalten der Datei unseren Feldern zu - das Mapping wird nicht gespeichert und muss bei jedem Import neu gewählt werden. Nicht zugeordnete Felder werden einfach nicht importiert. `),Jc(),Mi(5,`div`,3)(6,`input`,4,0),sh(`change`,function(b){return t.onFileSelected(b)}),Jc(),Mi(8,`button`,5),sh(`click`,function(){Pu(a);return Fu(HD(7).click())}),Mi(9,`mat-icon`),cw(10,`upload_file`),Jc(),cw(11,` Datei wählen `),Jc(),hD(12,oa,2,1,`span`,6),Jc(),hD(13,da,7,1,`div`,7),hD(14,la,4,0,`div`,8),hD(15,ca,2,1,`p`,9),hD(16,ba,6,2),Jc(),Mi(17,`mat-dialog-actions`,10)(18,`button`,11),sh(`click`,function(){return t.onCancel()}),cw(19,`Abbrechen`),Jc(),Mi(20,`button`,12),sh(`click`,function(){return t.onImport()}),cw(21,` Importieren `),Jc()()}if(e&2){let a;dI(12),gD(t.file()?12:-1),dI(),gD(t.file()?13:-1),dI(),gD(t.previewLoading()?14:-1),dI(),gD(t.previewError()?15:-1),dI(),gD((a=t.preview())?16:-1,a),dI(4),Xp(`disabled`,!t.preview()||t.previewLoading())}},dependencies:[qa$1,kD$1,TD,AD,RD,Zn$1,Nm,go,fo,po,mo,Qn$1,Cc,Wo,BE,VE,gE,pE,or,We$1,Xe,pN,mN],styles:[`mat-dialog-content[_ngcontent-%COMP%]{min-width:500px;max-width:80vw}.hint[_ngcontent-%COMP%]{font-size:12px;color:#0009}.file-row[_ngcontent-%COMP%], .format-row[_ngcontent-%COMP%], .loading-row[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;margin-bottom:8px}.filename[_ngcontent-%COMP%]{font-size:13px}.error[_ngcontent-%COMP%]{color:#b00020}.mapping-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:4px 16px}.preview-table-wrapper[_ngcontent-%COMP%]{overflow-x:auto;max-width:100%}.preview-table[_ngcontent-%COMP%]{border-collapse:collapse;font-size:12px;width:100%}.preview-table[_ngcontent-%COMP%]   th[_ngcontent-%COMP%], .preview-table[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{border:1px solid rgba(0,0,0,.12);padding:4px 8px;text-align:left;white-space:nowrap}`]})};var mt=()=>[];var fa=(n,i)=>i.id;function va(n,i){n&1&&(Mi(0,`mat-icon`,4),cw(1,`sync `),Jc())}function ya(n,i){if(n&1&&(Mi(0,`mat-icon`,5),cw(1,`sync `),Jc()),n&2)Xp(`matTooltip`,hw(`Letzte Aktualisierung: `,OD().lastUpdate))}function Ma(n,i){n&1&&eh(0,`mat-spinner`,13)}function Sa(n,i){n&1&&(Mi(0,`mat-icon`),cw(1,`upload_file`),Jc())}function Ca(n,i){if(n&1){let e=CD();Mi(0,`button`,40),sh(`click`,function(){Pu(e);return Fu(OD(2).toggleContinuousMode(!1))}),Mi(1,`mat-icon`),cw(2,`stop`),Jc(),cw(3,` Kontinuierlich AUS `),Jc()}}function wa(n,i){if(n&1){let e=CD();Mi(0,`button`,41),sh(`click`,function(){Pu(e);return Fu(OD(2).toggleContinuousMode(!0))}),Mi(1,`mat-icon`),cw(2,`play_arrow`),Jc(),cw(3,` Kontinuierlich AN `),Jc()}}function ka(n,i){if(n&1){let e=CD();Mi(0,`button`,42),sh(`click`,function(){Pu(e);return Fu(OD(2).discardOldestStart())}),Mi(1,`mat-icon`),cw(2,`person_off`),Jc(),cw(3,` Sturz signalisieren `),Jc()}}function xa(n,i){if(n&1&&(hD(0,Ca,4,0,`button`,37),ww(1,`async`),Kc(2,wa,4,0,`button`,38),hD(3,ka,4,0,`button`,39),ww(4,`async`)),n&2){let e=OD();gD(Tw(1,2,e.deviceStatus$)===`continuous`?0:2),dI(3),gD(Tw(4,4,e.deviceStatus$)===`normal`?3:-1)}}function Na(n,i){if(n&1){let e=CD();Mi(0,`button`,43),sh(`click`,function(){Pu(e);return Fu(OD().toggleScheduledImport(!1))}),Mi(1,`mat-icon`),cw(2,`cloud_sync`),Jc(),cw(3,` Auto-Import AUS `),Jc()}}function Ea(n,i){if(n&1){let e=CD();Mi(0,`button`,44),sh(`click`,function(){Pu(e);return Fu(OD().toggleScheduledImport(!0))}),Mi(1,`mat-icon`),cw(2,`cloud_download`),Jc(),cw(3,` Auto-Import AN `),Jc()}}function Ia(n,i){if(n&1&&(Mi(0,`mat-option`,21),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();Xp(`value`,e.id),dI(),Th(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function Aa(n,i){if(n&1&&(Mi(0,`strong`),cw(1),Jc(),cw(2),ww(3,`async`)),n&2){let e=OD(2),t=OD(),a=OD();dI(),bh(e.nextRaceNumber),dI(),rl(` (`,a.getParticipantNameByRaceNumber(t,e.nextRaceNumber,Tw(3,2,a.participants$)||Iw(4,mt)),`) `)}}function Da(n,i){n&1&&(Mi(0,`em`),cw(1,`keine weiteren Startnummern`),Jc())}function Ra(n,i){if(n&1){let e=CD();Mi(0,`button`,45),sh(`click`,function(){Pu(e);return Fu(OD(3).skipAutoAssign())}),Mi(1,`mat-icon`),cw(2,`skip_next`),Jc(),cw(3,` Überspringen `),Jc(),Mi(4,`span`,46),cw(5,` Nächste erwartete Startnummer: `),hD(6,Aa,4,5)(7,Da,2,0,`em`),Jc()}if(n&2){let e=OD();dI(6),gD(e.nextRaceNumber!==null?6:7)}}function Ta(n,i){if(n&1&&hD(0,Ra,8,1),n&2){let e=i,t=OD();gD(e.active&&e.raceId===t?0:-1)}}function $a(n,i){if(n&1&&(hD(0,Ta,1,1),ww(1,`async`)),n&2){let e;gD((e=Tw(1,1,OD().autoAssignStatus$))?0:-1,e)}}function Fa(n,i){n&1&&(Mi(0,`span`,22),cw(1,`Rennen auswählen, um Messungen automatisch zuzuordnen.`),Jc())}function La(n,i){n&1&&(Mi(0,`div`,23),eh(1,`mat-spinner`,47),Jc())}function Oa(n,i){n&1&&(Mi(0,`th`,48),cw(1,`ID`),Jc())}function Pa(n,i){if(n&1&&(Mi(0,`td`,49),cw(1),Jc()),n&2){let e=i.$implicit;dI(),bh(e.id)}}function za(n,i){n&1&&(Mi(0,`th`,48),cw(1,`Dauer`),Jc())}function Ba(n,i){if(n&1&&(Mi(0,`td`,49),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();dI(),rl(` `,t.formatDuration(e.durationMs),` `)}}function Ga(n,i){n&1&&(Mi(0,`th`,48),cw(1,`Teilnehmer`),Jc())}function Va(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),Jc()),n&2){let e=i.$implicit;Xp(`matTooltip`,e.participantId?`Bereits einem Rennen zugeordnet`:``),dI(),rl(` `,e.participantName||`-`,` `)}}function qa(n,i){n&1&&(Mi(0,`th`,48),cw(1,`Gemessen am`),Jc())}function Ka(n,i){if(n&1&&(Mi(0,`td`,49),cw(1),ww(2,`date`),Jc()),n&2){let e=i.$implicit;dI(),rl(` `,Cw(2,1,e.measuredAt,`dd.MM.yyyy HH:mm:ss`),` `)}}function Ha(n,i){n&1&&(Mi(0,`th`,48),cw(1,`Aktionen`),Jc())}function ja(n,i){if(n&1){let e=CD();Mi(0,`td`,49)(1,`button`,51),sh(`click`,function(){let a=Pu(e).$implicit;return Fu(OD().openEditDialog(a))}),Mi(2,`mat-icon`),cw(3,`edit`),Jc()(),Mi(4,`button`,52),sh(`click`,function(){let a=Pu(e).$implicit;return Fu(OD().deleteMeasurement(a))}),Mi(5,`mat-icon`),cw(6,`delete`),Jc()()()}}function Ua(n,i){n&1&&eh(0,`tr`,53)}function Wa(n,i){n&1&&eh(0,`tr`,54)}var Rn=class n{store=T(Pt);dialog=T(nt$1);snackBar=T(Mt);actions$=T(MN);destroy$=new Q;autoRefresh$=new Q;trackById=(i,e)=>e.id;measurements$;races$;participants$;measurementsWithParticipants$;selectedRaceId$;autoAssignStatus$;loading$;scheduledImportEnabled$;deviceStatus$;timingProviderActive$;importLoading$;displayedColumns=[`id`,`duration`,`measuredAt`,`participant`,`actions`];lastUpdate=``;autoRefreshEnabled=!1;constructor(){this.measurements$=this.store.select(A$1),this.races$=this.store.select(l),this.participants$=this.store.select(a),this.loading$=this.store.select(qe),this.timingProviderActive$=this.store.select(S).pipe(Hn$1(i=>i!==null),Eg()),this.measurementsWithParticipants$=yg([this.measurements$,this.participants$]).pipe(oe(([i,e])=>i.map(t=>z(G({},t),{participantName:t.participantId?this.getParticipantName(t.participantId,e):void 0}))),Eg(s$1)),this.scheduledImportEnabled$=this.store.select(He$1),this.deviceStatus$=this.store.select(Je),this.selectedRaceId$=this.store.select(s),this.autoAssignStatus$=this.store.select(Ke),this.importLoading$=this.store.select(Qe$1),this.actions$.pipe(AN(Ie,fe,Ue$2),bg(this.destroy$)).subscribe(i=>{let e=i.type===Ie.type?`Automatik-Modus aktiviert`:i.type===fe.type?`Automatik-Modus deaktiviert`:`Startnummer übersprungen`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(AN(Ce,Re$1,$e),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(L),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich erstellt`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(P),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Erstellen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(N),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich aktualisiert`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(E),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Aktualisieren der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(q),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich gelöscht`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(w),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim L\xF6schen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(V),bg(this.destroy$)).subscribe(({message:i})=>{let t=at(i)?`Alle Messungen wurden gelöscht (inkl. Gerät)`:`Alle Messungen wurden gelöscht (nur Datenbank)`;this.snackBar.open(t,`OK`,{duration:3e3})}),this.actions$.pipe(AN(H),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Löschen der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(z$1),bg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Kontinuierlicher Modus aktiviert`:`Kontinuierlicher Modus deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(AN(G$1),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des kontinuierlichen Modus`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(Q$1),bg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Automatischer Import aktiviert (alle 5 Sekunden)`:`Automatischer Import deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(AN(W),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des automatischen Imports`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(ee),bg(this.destroy$)).subscribe(({clearAfterArchive:i,message:e})=>{let t=at(e),a=i?t?`Messungen archiviert und Gerät zurückgesetzt. Bereit für das nächste Rennen.`:`Messungen archiviert. Bereit für das nächste Rennen.`:`Messungen archiviert. Datenbank und Gerät wurden nicht verändert.`;this.snackBar.open(a,`OK`,{duration:3e3})}),this.actions$.pipe(AN(te),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Archivieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(be),bg(this.destroy$)).subscribe(({connected:i})=>{i&&this.store.dispatch(se())}),this.actions$.pipe(AN(oe$1),bg(this.destroy$)).subscribe(()=>{this.store.dispatch(xe()),this.snackBar.open(`Ältester Start erfolgreich verworfen`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(ue),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Verwerfen des ältesten Starts`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(z$1),bg(this.destroy$)).subscribe(()=>{this.store.dispatch(se())}),this.actions$.pipe(AN(ce),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messungen erfolgreich exportiert`,`OK`,{duration:3e3})}),this.actions$.pipe(AN(pe),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Exportieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(AN(le),bg(this.destroy$)).subscribe(({result:i})=>{let e=i.skippedCount>0?`Import abgeschlossen: ${i.importedCount} importiert, ${i.skippedCount} \xFCbersprungen`:`Import abgeschlossen: ${i.importedCount} importiert`;this.snackBar.open(e,`OK`,{duration:i.skippedCount>0?8e3:3e3});let t=i.errors??[];if(t.length>0){let a=t.map(l=>`Zeile ${l.lineNumber}: ${l.reason}`).join(`
`);alert(`Folgende Zeilen wurden \xFCbersprungen:

${a}`)}this.loadData()}),this.actions$.pipe(AN(Me),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Importieren der Messungen: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.timingProviderActive$.pipe(bg(this.destroy$)).subscribe(i=>{i&&this.store.dispatch(se())})}ngAfterViewInit(){this.loadData(),this.store.dispatch(e()),this.store.dispatch(X()),this.autoRefresh$.pipe(wg(i=>i?Ig(2e3):Ue$1),bg(this.destroy$)).subscribe(()=>{this.loadMeasurementData()}),this.autoRefresh$.next(this.autoRefreshEnabled)}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete(),this.autoRefresh$.complete()}onAutoRefreshToggle(){this.autoRefresh$.next(this.autoRefreshEnabled);let i=this.autoRefreshEnabled?`Automatische Aktualisierung aktiviert`:`Automatische Aktualisierung deaktiviert`;this.snackBar.open(i,`OK`,{duration:2e3})}manualRefresh(){this.loadData(),this.snackBar.open(`Daten wurden aktualisiert`,`OK`,{duration:2e3})}loadData(){this.store.dispatch(t()),this.loadMeasurementData()}loadMeasurementData(){this.store.dispatch(F()),this.store.dispatch(xe()),this.updateLastUpdateTime()}updateLastUpdateTime(){let i=new Date;this.lastUpdate=i.toLocaleTimeString(`de-DE`)}getParticipantName(i,e){let t=e.find(a=>a.id===i);return t?.person?`${t.person.firstName} ${t.person.lastName}`:`-`}getParticipantNameByRaceNumber(i,e,t){let a=t.find(l=>l.race?.id===i&&l.raceNumber===e);return a?.person?`${a.person.firstName} ${a.person.lastName}`:`unbekannt`}formatRaceDate(i){let e=i.split(`-`);if(e.length===3){let[t,a,l]=e;return`${l}.${a}.${t}`}return i}onRaceChange(i){this.store.dispatch(S$1({id:i})),i!==null?this.store.dispatch(Fe({request:{raceId:i}})):this.store.dispatch(De())}skipAutoAssign(){this.store.dispatch(Oe())}formatDuration(i){let e=Math.floor(i/1e3),t=Math.floor(e/3600),a=Math.floor(e%3600/60),l=e%60,b=i%1e3;return t>0?`${t}:${String(a).padStart(2,`0`)}:${String(l).padStart(2,`0`)}.${String(b).padStart(3,`0`)}`:a>0?`${a}:${String(l).padStart(2,`0`)}.${String(b).padStart(3,`0`)}`:`${l}.${String(b).padStart(3,`0`)}s`}openCreateDialog(){this.dialog.open(ve,{width:`500px`}).afterClosed().pipe(bg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(y({measurement:e}))})}openEditDialog(i){this.dialog.open(ve,{width:`500px`,data:i}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(k({id:i.id,measurement:t}))})}deleteMeasurement(i){confirm(`M\xF6chten Sie die Messung #${i.id} wirklich l\xF6schen?`)&&this.store.dispatch(B({id:i.id}))}resetMeasurements(i){confirm(i?`Möchten Sie wirklich ALLE Messungen löschen? Dies betrifft auch die Messungen auf dem Gerät!`:`Möchten Sie wirklich ALLE Messungen löschen (nur aus der Datenbank)?`)&&this.store.dispatch(j({resetDevice:i}))}toggleContinuousMode(i){confirm(i?`Möchten Sie den kontinuierlichen Modus wirklich aktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`:`Möchten Sie den kontinuierlichen Modus wirklich deaktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`)&&this.store.dispatch(J({enable:i}))}toggleScheduledImport(i){this.store.dispatch(K({enable:i}))}openArchiveDialog(){this.races$.pipe(tn(1)).subscribe(i=>{this.dialog.open(We,{width:`500px`,data:{races:i}}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(_(t))})})}discardOldestStart(){confirm(`Möchten Sie den ältesten Start aus der Warteschlange verwerfen? Dies sollte verwendet werden, wenn ein Läufer gestürzt ist.`)&&this.store.dispatch(ae())}exportMeasurementsCsv(){this.store.dispatch(ie())}openImportDialog(){this.dialog.open(Qe,{width:`900px`}).afterClosed().pipe(bg(this.destroy$)).subscribe(e=>{e&&(this.store.dispatch(me({file:e.file,delimiter:e.delimiter,mapping:e.mapping})),this.snackBar.open(`Import gestartet...`,`OK`,{duration:2e3}))})}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-measurement-list`]],decls:102,vars:51,consts:[[`resetMenu`,`matMenu`],[1,`title-row`],[1,`sync-status`],[`color`,`primary`,`matTooltip`,`Automatische Aktualisierung`,3,`ngModelChange`,`change`,`ngModel`],[`matTooltip`,`Aktualisiere...`,1,`sync-icon`,`syncing`],[1,`sync-icon`,3,`matTooltip`],[1,`last-update-text`],[1,`header-actions`],[`mat-raised-button`,``,`color`,`primary`,3,`click`],[`mat-raised-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Aktuelle Messungen einem Rennen zuordnen und archivieren`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Alle Messungen als CSV-Datei herunterladen`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Messungen aus CSV-Datei importieren (mit Spalten-Zuordnung)`,3,`click`,`disabled`],[`diameter`,`20`,2,`display`,`inline-block`,`margin-right`,`8px`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Alle Messungen zurücksetzen`,3,`matMenuTriggerFor`],[`mat-menu-item`,``,3,`click`],[1,`auto-assign-row`],[`appearance`,`outline`,1,`race-select`,3,`matTooltip`],[3,`selectionChange`,`value`,`disabled`],[3,`value`],[1,`hint`],[1,`loading-overlay`],[1,`table-container`],[`mat-table`,``,1,`measurement-table`,3,`dataSource`,`trackBy`],[`matColumnDef`,`id`],[`mat-header-cell`,``,4,`matHeaderCellDef`],[`mat-cell`,``,4,`matCellDef`],[`matColumnDef`,`duration`],[`matColumnDef`,`participant`],[`mat-cell`,``,3,`matTooltip`,4,`matCellDef`],[`matColumnDef`,`measuredAt`],[`matColumnDef`,`actions`],[`mat-header-row`,``,4,`matHeaderRowDef`],[`mat-row`,``,4,`matRowDef`,`matRowDefColumns`],[1,`count-info`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`,3,`click`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Aktuell erwartete Startnummer überspringen (z. B. nicht gestartet)`,3,`click`],[1,`next-number-info`],[`diameter`,`30`],[`mat-header-cell`,``],[`mat-cell`,``],[`mat-cell`,``,3,`matTooltip`],[`mat-icon-button`,``,`matTooltip`,`Bearbeiten`,3,`click`],[`mat-icon-button`,``,`color`,`warn`,`matTooltip`,`Löschen`,3,`click`],[`mat-header-row`,``],[`mat-row`,``]],template:function(e,t){if(e&1){let a=CD();Mi(0,`mat-card`)(1,`mat-card-header`)(2,`mat-card-title`)(3,`div`,1)(4,`span`),cw(5,`Messungen`),Jc(),Mi(6,`div`,2)(7,`mat-slide-toggle`,3),Mh(`ngModelChange`,function(b){return Pu(a),pw(t.autoRefreshEnabled,b)||(t.autoRefreshEnabled=b),Fu(b)}),sh(`change`,function(){return t.onAutoRefreshToggle()}),Jc(),XI(),hD(8,va,2,0,`mat-icon`,4),ww(9,`async`),Kc(10,ya,2,2,`mat-icon`,5),Mi(11,`span`,6),cw(12),Jc()()()()(),Mi(13,`mat-card-content`)(14,`div`,7)(15,`button`,8),sh(`click`,function(){return t.openCreateDialog()}),Mi(16,`mat-icon`),cw(17,`add`),Jc(),cw(18,` Neue Messung `),Jc(),Mi(19,`button`,9),sh(`click`,function(){return t.manualRefresh()}),Mi(20,`mat-icon`),cw(21,`refresh`),Jc(),cw(22,` Manuell aktualisieren `),Jc(),Mi(23,`button`,10),sh(`click`,function(){return t.openArchiveDialog()}),Mi(24,`mat-icon`),cw(25,`archive`),Jc(),cw(26,` Archivieren `),Jc(),Mi(27,`button`,11),sh(`click`,function(){return t.exportMeasurementsCsv()}),Mi(28,`mat-icon`),cw(29,`download`),Jc(),cw(30,` CSV Export `),Jc(),Mi(31,`button`,12),ww(32,`async`),sh(`click`,function(){return t.openImportDialog()}),hD(33,Ma,1,0,`mat-spinner`,13),ww(34,`async`),Kc(35,Sa,2,0,`mat-icon`),cw(36,` CSV Import `),Jc(),hD(37,xa,5,6),ww(38,`async`),hD(39,Na,4,0,`button`,14),ww(40,`async`),Kc(41,Ea,4,0,`button`,15),Mi(42,`button`,16)(43,`mat-icon`),cw(44,`delete_sweep`),Jc(),cw(45,` Zurücksetzen `),Mi(46,`mat-icon`),cw(47,`arrow_drop_down`),Jc()(),Mi(48,`mat-menu`,null,0)(50,`button`,17),sh(`click`,function(){return t.resetMeasurements(!1)}),Mi(51,`mat-icon`),cw(52,`delete_sweep`),Jc(),Mi(53,`span`),cw(54,`Alle Messungen löschen (nur Datenbank)`),Jc()(),Mi(55,`button`,17),sh(`click`,function(){return t.resetMeasurements(!0)}),Mi(56,`mat-icon`),cw(57,`delete_forever`),Jc(),Mi(58,`span`),cw(59,`Alle löschen (inkl. Gerät)`),Jc()()()(),Mi(60,`div`,18)(61,`mat-form-field`,19),ww(62,`async`),Mi(63,`mat-label`),cw(64,`Rennen (Automatik-Zuordnung)`),Jc(),Mi(65,`mat-select`,20),ww(66,`async`),ww(67,`async`),sh(`selectionChange`,function(b){return t.onRaceChange(b.value)}),Mi(68,`mat-option`,21),cw(69,`— kein Rennen —`),Jc(),vD(70,Ia,2,3,`mat-option`,21,fa),ww(72,`async`),Jc()(),hD(73,$a,2,3),ww(74,`async`),Kc(75,Fa,2,0,`span`,22),Jc(),hD(76,La,2,0,`div`,23),ww(77,`async`),Mi(78,`div`,24)(79,`table`,25),ww(80,`async`),ww(81,`async`),tl(82,26),Gp(83,Oa,2,0,`th`,27)(84,Pa,2,1,`td`,28),nl(),tl(85,29),Gp(86,za,2,0,`th`,27)(87,Ba,2,1,`td`,28),nl(),tl(88,30),Gp(89,Ga,2,0,`th`,27)(90,Va,2,2,`td`,31),nl(),tl(91,32),Gp(92,qa,2,0,`th`,27)(93,Ka,3,4,`td`,28),nl(),tl(94,33),Gp(95,Ha,2,0,`th`,27)(96,ja,7,0,`td`,28),nl(),Gp(97,Ua,1,0,`tr`,34)(98,Wa,1,0,`tr`,35),Jc()(),Mi(99,`div`,36),cw(100),ww(101,`async`),Jc()()()}if(e&2){let a,l=HD(49);dI(7),Nh(`ngModel`,t.autoRefreshEnabled),tE(),dI(),gD(Tw(9,21,t.loading$)?8:10),dI(4),bh(t.lastUpdate),dI(19),Xp(`disabled`,Tw(32,23,t.importLoading$)),dI(2),gD(Tw(34,25,t.importLoading$)?33:35),dI(4),gD(Tw(38,27,t.timingProviderActive$)?37:-1),dI(2),gD(Tw(40,29,t.scheduledImportEnabled$)?39:41),dI(3),Xp(`matMenuTriggerFor`,l),dI(19),Xp(`matTooltip`,Tw(62,31,t.scheduledImportEnabled$)?`Automatischen Import zuerst deaktivieren, um das Rennen zu wechseln`:`Rennen auswählen startet die automatische Zuordnung, abwählen stoppt sie`),dI(4),Xp(`value`,Tw(66,33,t.selectedRaceId$))(`disabled`,!!Tw(67,35,t.scheduledImportEnabled$)),dI(3),Xp(`value`,null),dI(2),ID(Tw(72,37,t.races$)),dI(3),gD((a=Tw(74,39,t.selectedRaceId$))?73:75,a),dI(3),gD(Tw(77,41,t.loading$)?76:-1),dI(3),mh(`loading`,Tw(80,43,t.loading$)),Xp(`dataSource`,Tw(81,45,t.measurementsWithParticipants$)||Iw(49,mt))(`trackBy`,t.trackById),dI(18),Xp(`matHeaderRowDef`,t.displayedColumns),dI(),Xp(`matRowDefColumns`,t.displayedColumns),dI(2),rl(` Anzahl der Messungen: `,(Tw(101,47,t.measurements$)||Iw(50,mt)).length,` `)}},dependencies:[qa$1,Rn$1,mn,gn,wn,_n,pn,Dn$1,yn,Cn,vn,bn,BE,VE,np,We$1,Xe,pN,mN,go,Xt,Dx,_x,vx,Sx,bx,we$1,Wt,xn,nt,Lt,I,G$2,Bt,gE,Cc,Wo,pE,or,Qn$1,ID$1,AD,Sm,Vu,ju],styles:[`.title-row[_ngcontent-%COMP%]{display:flex;justify-content:space-between;align-items:center;width:100%;gap:32px}.sync-status[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;font-size:.875rem;color:#0009}.sync-icon[_ngcontent-%COMP%]{font-size:20px;width:20px;height:20px;color:#0009}.sync-icon.syncing[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_spin 1s linear infinite;color:#3f51b5}@keyframes _ngcontent-%COMP%_spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.last-update-text[_ngcontent-%COMP%]{font-size:.75rem;white-space:nowrap}.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px;position:relative;flex-wrap:wrap;align-items:center}.active-mode[_ngcontent-%COMP%]{background-color:#4caf50!important;color:#fff!important}.active-mode[_ngcontent-%COMP%]:hover{background-color:#45a049!important}.auto-assign-row[_ngcontent-%COMP%]{margin-bottom:20px;display:flex;gap:16px;flex-wrap:wrap;align-items:center}.race-select[_ngcontent-%COMP%]{min-width:280px}.next-number-info[_ngcontent-%COMP%]{font-size:.9rem;color:#000000b3}.hint[_ngcontent-%COMP%]{color:#0009}.loading-overlay[_ngcontent-%COMP%]{position:absolute;top:0;right:0;z-index:10;display:flex;align-items:center;justify-content:center;padding:10px}.measurement-table[_ngcontent-%COMP%]{width:100%;transition:opacity .2s ease}.measurement-table.loading[_ngcontent-%COMP%]{opacity:.6}mat-card[_ngcontent-%COMP%]{margin:20px}mat-card-content[_ngcontent-%COMP%]{position:relative}.count-info[_ngcontent-%COMP%]{margin-top:16px;padding:12px 16px;background-color:#f5f5f5;border-radius:4px;font-size:14px;font-weight:500;color:#000000de}@media(max-width:768px){mat-card[_ngcontent-%COMP%]{margin:8px}.title-row[_ngcontent-%COMP%]{flex-wrap:wrap;gap:8px}}`]})};export{Rn as MeasurementListComponent};