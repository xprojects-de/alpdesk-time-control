import{$n as hw,An as bh,At as Re,B as Hv,C as Fh,Cn as _h,Cr as nl,Ct as Pu,D as G,F as HD,Fn as cw,Gr as tn,H as Ig,Hr as tE,Ht as Ue,In as dI,Ir as rh,It as T,Jn as gh,Jt as VD,K as Jc,Kn as gD,L as Hj,Ln as dh,Lr as rl,Nn as ch,O as Ge,Or as pw,Q as Kc,Qr as vw,Tr as oe,Tt as QE,V as ID,Vt as UE,W as Iw,Wr as tl,Wt as Uj,X as KD,Xn as hD,Xr as vD,Y as Jp,Zr as vg,Zt as WE,_ as Dg,c as A,ci as z,cn as Xp,ct as Mr,ei as wg,er as ih,et as Kp,ft as Nh,g as Cw,gr as lu,gt as OD,h as Co,ii as ww,in as Xa,it as Lu,kt as Qu,mr as lh,p as CD,r as $j,rn as XI,rr as jD,sr as kD,st as Mi,ti as wh,tn as Wp,tr as iy,tt as LD,vr as mg,w as Fj,wt as Q,x as FD,y as Ee,zt as Tw}from"./chunk-CMzlWkMW.js";import{A as Kt,Bn as wE,C as Hm,D as Iu,E as IE,En as tg,Fn as uw,G as Oe,Hn as wm,Ht as fw,I as Mp,J as Ot,N as Lx,O as JN,Q as QN,Qt as kg,R as Nc,Rn as vr,St as Zd,T as ID$1,Tn as ss,U as OD$1,Ut as ge,W as OE,Wn as wx,Y as PE,Yt as kD$1,Z as Px,Zn as zm,Zt as ke,_ as Es,at as Ss,gn as qn,gt as W,h as Dx,hn as qm,j as LE,k as Ji,lt as Tt,n as $l,nt as RD,o as Ba,on as mr,ot as TD,r as AD,rt as Sm,s as Bm,st as TE,t as $c,ut as Tw$1,v as Fu,vt as Wl,y as Fw}from"./chunk-ZMC-HYpb.js";import{r as s,t as l}from"./chunk-D7iSWTlm.js";import{$n as me,An as N,Bn as V,Cn as G$1,D as m,Dn as Je,En as J,Fn as R,Gn as be,Hn as X,In as S,Jn as ge$1,Kn as ee,Ln as Se,Mn as O,Nn as Oe$1,On as L,Pn as P,Qn as l$1,Rn as T$1,Sn as Fe,Tn as Ie,Un as _,Vn as W$1,Wn as ae,X as S$1,Xn as j,Yn as h,Zn as k,_ as i,_n as Ae,_r as p,ar as te$1,at as t,bn as De,cr as we,dt as I,er as ne,ft as Lt,gn as $,ir as se,jn as Ne,kn as Me,lr as xe,lt as Bt,nr as q,or as ve,qn as f,rr as re,sr as w,tr as oe$1,ur as z$1,ut as G$2,vn as B,wn as H,xn as E,yn as C,zn as U}from"./main-HDJA2H6H.js";import{C as qa,S as ot,_ as Va,a as Io,b as ja,c as Ln$1,d as Po,f as Qa,g as Ui,h as Ua,i as Ha,l as No,m as Sn$1,n as Bo,o as Ir,r as Br,s as La,t as Ba$1,u as Pa,v as Wa,w as za,y as ar}from"./chunk-B_ny0XxP.js";var Mn=[`switch`];var wn=[`*`];function Cn(n,i){n&1&&(Mi(0,`span`,11),Qu(),Mi(1,`svg`,13),Xp(2,`path`,14),Jc(),Mi(3,`svg`,15),Xp(4,`path`,16),Jc()())}var Nn=new A(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var Be=class{source;checked;constructor(i,e){this.source=i,this.checked=e}};var We=(()=>{class n{_elementRef=T(Mr);_focusMonitor=T(Kt);_changeDetectorRef=T(Hj);defaults=T(Nn);_onChange=e=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(e){return new Be(this,e)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=ke();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(e){this._checked=e,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new Ge;toggleChange=new Ge;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){T(ge).load(Ji);let e=T(new Fh(`tabindex`),{optional:!0}),t=this.defaults;this.tabIndex=e==null?0:parseInt(e)||0,this.color=t.color||`accent`,this.id=this._uniqueId=T(Oe).getId(`mat-mdc-slide-toggle-`),this.hideIcon=t.hideIcon??!1,this.disabledInteractive=t.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(e=>{e===`keyboard`||e===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):e||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(e){e.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(e){this.checked=!!e}registerOnChange(e){this._onChange=e}registerOnTouched(e){this._onTouched=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorOnChange=e}setDisabledState(e){this.disabled=e,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new Be(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(t){return new(t||n)};static ɵcmp=UE({type:n,selectors:[[`mat-slide-toggle`]],viewQuery:function(t,a){if(t&1&&lh(Mn,5),t&2){let c;FD(c=jD())&&(a._switchElement=c.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(t,a){t&2&&(rh(`id`,a.id),Kp(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),KD(a.color?`mat-`+a.color:``),gh(`mat-mdc-slide-toggle-focused`,a._focused)(`mat-mdc-slide-toggle-checked`,a.checked)(`mat-slide-toggle-full-width`,a.fullWidth)(`_mat-animation-noopable`,a._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,$j],color:`color`,disabled:[2,`disabled`,`disabled`,$j],fullWidth:[2,`fullWidth`,`fullWidth`,$j],disableRipple:[2,`disableRipple`,`disableRipple`,$j],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?0:Uj(e)],checked:[2,`checked`,`checked`,$j],hideIcon:[2,`hideIcon`,`hideIcon`,$j],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,$j]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[vw([{provide:mr,useExisting:Co(()=>n),multi:!0},{provide:Ot,useExisting:n,multi:!0}]),iy],ngContentSelectors:wn,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(t,a){if(t&1&&(kD(),Mi(0,`div`,1)(1,`button`,2,0),ih(`click`,function(){return a._handleClick()}),Xp(3,`div`,3)(4,`span`,4),Mi(5,`span`,5)(6,`span`,6)(7,`span`,7),Xp(8,`span`,8),Jc(),Mi(9,`span`,9),Xp(10,`span`,10),Jc(),hD(11,Cn,5,0,`span`,11),Jc()()(),Mi(12,`label`,12),ih(`click`,function(b){return b.stopPropagation()}),LD(13),Jc()()),t&2){let c=HD(2);Jp(`labelPosition`,a.labelPosition),dI(),gh(`mdc-switch--selected`,a.checked)(`mdc-switch--unselected`,!a.checked)(`mdc-switch--checked`,a.checked)(`mdc-switch--disabled`,a.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,a.disabledInteractive),Jp(`tabIndex`,a.disabled&&!a.disabledInteractive?-1:a.tabIndex)(`disabled`,a.disabled&&!a.disabledInteractive),Kp(`id`,a.buttonId)(`name`,a.name)(`aria-label`,a.ariaLabel)(`aria-labelledby`,a._getAriaLabelledBy())(`aria-describedby`,a.ariaDescribedby)(`aria-required`,a.required||null)(`aria-checked`,a.checked)(`aria-disabled`,a.disabled&&a.disabledInteractive?`true`:null),dI(9),Jp(`matRippleTrigger`,c)(`matRippleDisabled`,a.disableRipple||a.disabled)(`matRippleCentered`,!0),dI(),gD(a.hideIcon?-1:11),dI(),Jp(`for`,a.buttonId),Kp(`id`,a._labelId)}},dependencies:[$l,m],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return n})();var Sn=(()=>{class n{static ɵfac=function(t){return new(t||n)};static ɵmod=WE({type:n});static ɵinj=lu({imports:[vr,Ve,W]})}return n})();var Vn=(n,i)=>i.id;function Kn(n,i){if(n&1&&(Mi(0,`mat-option`,4),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();Jp(`value`,e.id),dI(),bh(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function jn(n,i){n&1&&(Mi(0,`mat-error`),cw(1,`Bitte ein Rennen auswählen`),Jc())}function Hn(n,i){n&1&&(Mi(0,`mat-error`),cw(1,`Bitte eine Archivierungs-Variante auswählen`),Jc())}var Ke=class n{fb=T(ID$1);dialogRef=T(ot);data=T(Sn$1);form=this.fb.group({raceId:[null,qn.required],mode:[null,qn.required]});onCancel(){this.dialogRef.close()}onSave(){if(!this.form.valid)return;let i=this.form.value.mode,e={raceId:Number(this.form.value.raceId),resetDevice:i===`reset`,clearAfterArchive:i!==`noclear`};this.dialogRef.close(e)}formatRaceDate(i){let e=i.split(`-`);return e.length===3?`${e[2]}.${e[1]}.${e[0]}`:i}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-archive-measurements-dialog`]],decls:30,vars:4,consts:[[`mat-dialog-title`,``],[1,`archive-form`,3,`formGroup`],[`appearance`,`outline`],[`formControlName`,`raceId`,`required`,``],[3,`value`],[`formControlName`,`mode`,1,`mode-group`],[`value`,`reset`],[1,`hint`],[`value`,`keep`],[`value`,`noclear`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`]],template:function(e,t){e&1&&(Mi(0,`h2`,0),cw(1,`Messungen archivieren`),Jc(),Mi(2,`mat-dialog-content`)(3,`form`,1)(4,`mat-form-field`,2)(5,`mat-label`),cw(6,`Rennen`),Jc(),Mi(7,`mat-select`,3),vD(8,Kn,2,3,`mat-option`,4,Vn),Jc(),XI(),hD(10,jn,2,0,`mat-error`),Jc(),Mi(11,`mat-radio-group`,5)(12,`mat-radio-button`,6),cw(13,` Archivieren (inkl. Gerät-Reset) `),Mi(14,`p`,7),cw(15,`Aktuelle Messungen werden diesem Rennen zugeordnet, danach werden Datenbank und Gerät geleert. Bereit für das nächste Rennen.`),Jc()(),Mi(16,`mat-radio-button`,8),cw(17,` Archivieren (nur Datenbank) `),Mi(18,`p`,7),cw(19,`Wie oben, aber nur die Datenbank wird geleert, das Gerät bleibt unverändert.`),Jc()(),Mi(20,`mat-radio-button`,9),cw(21,` Archivieren (ohne Löschen) `),Mi(22,`p`,7),cw(23,`Aktuelle Messungen werden diesem Rennen zugeordnet. Datenbank und Gerät werden dabei NICHT verändert.`),Jc()()(),XI(),hD(24,Hn,2,0,`mat-error`),Jc()(),Mi(25,`mat-dialog-actions`,10)(26,`button`,11),ih(`click`,function(){return t.onCancel()}),cw(27,`Abbrechen`),Jc(),Mi(28,`button`,12),ih(`click`,function(){return t.onSave()}),cw(29,` Archivieren `),Jc()()),e&2&&(dI(3),Jp(`formGroup`,t.form),dI(4),tE(),dI(),ID(t.data.races),dI(2),gD(t.form.get(`raceId`)?.hasError(`required`)&&t.form.get(`raceId`)?.touched?10:-1),dI(),tE(),dI(13),gD(t.form.get(`mode`)?.hasError(`required`)&&t.form.get(`mode`)?.touched?24:-1),dI(4),Jp(`disabled`,!t.form.valid))},dependencies:[Ba,kD$1,TD,AD,RD,$c,ss,Hm,Po,No,Bo,Io,Es,Zd,Ss,tg,Br,Ir,Wl,Sn,Ze,Ve,fw,uw],styles:[`.archive-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px;min-width:420px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}.mode-group[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:12px}.hint[_ngcontent-%COMP%]{margin:2px 0 0;font-size:12px;color:#0009}`]})};var Un=[`jsonImportInput`];var Xe=()=>[];var Jn=(n,i)=>i.id;function Qn(n,i){n&1&&(Mi(0,`mat-icon`,5),cw(1,`sync `),Jc())}function Wn(n,i){if(n&1&&(Mi(0,`mat-icon`,6),cw(1,`sync `),Jc()),n&2)Jp(`matTooltip`,hw(`Letzte Aktualisierung: `,OD().lastUpdate))}function Zn(n,i){if(n&1){let e=CD();Mi(0,`button`,41),ih(`click`,function(){Lu(e);return Pu(OD().toggleContinuousMode(!1))}),Mi(1,`mat-icon`),cw(2,`stop`),Jc(),cw(3,` Kontinuierlich AUS `),Jc()}}function Xn(n,i){if(n&1){let e=CD();Mi(0,`button`,42),ih(`click`,function(){Lu(e);return Pu(OD().toggleContinuousMode(!0))}),Mi(1,`mat-icon`),cw(2,`play_arrow`),Jc(),cw(3,` Kontinuierlich AN `),Jc()}}function Yn(n,i){if(n&1){let e=CD();Mi(0,`button`,43),ih(`click`,function(){Lu(e);return Pu(OD().discardOldestStart())}),Mi(1,`mat-icon`),cw(2,`person_off`),Jc(),cw(3,` Sturz signalisieren `),Jc()}}function ea(n,i){if(n&1){let e=CD();Mi(0,`button`,44),ih(`click`,function(){Lu(e);return Pu(OD().toggleScheduledImport(!1))}),Mi(1,`mat-icon`),cw(2,`cloud_sync`),Jc(),cw(3,` Auto-Import AUS `),Jc()}}function ta(n,i){if(n&1){let e=CD();Mi(0,`button`,45),ih(`click`,function(){Lu(e);return Pu(OD().toggleScheduledImport(!0))}),Mi(1,`mat-icon`),cw(2,`cloud_download`),Jc(),cw(3,` Auto-Import AN `),Jc()}}function ia(n,i){if(n&1&&(Mi(0,`mat-option`,25),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();Jp(`value`,e.id),dI(),bh(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function na(n,i){if(n&1&&(Mi(0,`strong`),cw(1),Jc(),cw(2),ww(3,`async`)),n&2){let e=OD(2),t=OD(),a=OD();dI(),wh(e.nextRaceNumber),dI(),rl(` (`,a.getParticipantNameByRaceNumber(t,e.nextRaceNumber,Tw(3,2,a.participants$)||Iw(4,Xe)),`) `)}}function aa(n,i){n&1&&(Mi(0,`em`),cw(1,`keine weiteren Startnummern`),Jc())}function ra(n,i){if(n&1){let e=CD();Mi(0,`button`,46),ih(`click`,function(){Lu(e);return Pu(OD(3).skipAutoAssign())}),Mi(1,`mat-icon`),cw(2,`skip_next`),Jc(),cw(3,` Überspringen `),Jc(),Mi(4,`span`,47),cw(5,` Nächste erwartete Startnummer: `),hD(6,na,4,5)(7,aa,2,0,`em`),Jc()}if(n&2){let e=OD();dI(6),gD(e.nextRaceNumber!==null?6:7)}}function oa(n,i){if(n&1&&hD(0,ra,8,1),n&2){let e=i,t=OD();gD(e.active&&e.raceId===t?0:-1)}}function sa(n,i){if(n&1&&(hD(0,oa,1,1),ww(1,`async`)),n&2){let e;gD((e=Tw(1,1,OD().autoAssignStatus$))?0:-1,e)}}function da(n,i){n&1&&(Mi(0,`span`,26),cw(1,`Rennen auswählen, um Messungen automatisch zuzuordnen.`),Jc())}function ca(n,i){n&1&&(Mi(0,`div`,27),Xp(1,`mat-spinner`,48),Jc())}function la(n,i){n&1&&(Mi(0,`th`,49),cw(1,`ID`),Jc())}function ma(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),Jc()),n&2){let e=i.$implicit;dI(),wh(e.id)}}function ua(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Dauer`),Jc())}function pa(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),Jc()),n&2){let e=i.$implicit,t=OD();dI(),rl(` `,t.formatDuration(e.durationMs),` `)}}function ha(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Teilnehmer`),Jc())}function ba(n,i){if(n&1&&(Mi(0,`td`,51),cw(1),Jc()),n&2){let e=i.$implicit;Jp(`matTooltip`,e.participantId?`Bereits einem Rennen zugeordnet`:``),dI(),rl(` `,e.participantName||`-`,` `)}}function ga(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Gemessen am`),Jc())}function _a(n,i){if(n&1&&(Mi(0,`td`,50),cw(1),ww(2,`date`),Jc()),n&2){let e=i.$implicit;dI(),rl(` `,Cw(2,1,e.measuredAt,`dd.MM.yyyy HH:mm:ss`),` `)}}function fa(n,i){n&1&&(Mi(0,`th`,49),cw(1,`Aktionen`),Jc())}function va(n,i){if(n&1){let e=CD();Mi(0,`td`,50)(1,`button`,52),ih(`click`,function(){let a=Lu(e).$implicit;return Pu(OD().openEditDialog(a))}),Mi(2,`mat-icon`),cw(3,`edit`),Jc()(),Mi(4,`button`,53),ih(`click`,function(){let a=Lu(e).$implicit;return Pu(OD().deleteMeasurement(a))}),Mi(5,`mat-icon`),cw(6,`delete`),Jc()()()}}function Sa(n,i){n&1&&Xp(0,`tr`,54)}function ya(n,i){n&1&&Xp(0,`tr`,55)}var yn=class n{store=T(Tt);dialog=T(Ui);snackBar=T(Ln$1);actions$=T(Px);destroy$=new Q;autoRefresh$=new Q;measurements$;races$;participants$;measurementsWithParticipants$;selectedRaceId$;autoAssignStatus$;loading$;scheduledImportEnabled$;deviceStatus$;displayedColumns=[`id`,`duration`,`measuredAt`,`participant`,`actions`];lastUpdate=``;autoRefreshEnabled=!1;lastResetDevice=!1;lastArchiveResetDevice=!1;lastArchiveClearAfterArchive=!0;jsonImportInput=Fj.required(`jsonImportInput`);constructor(){this.measurements$=this.store.select(l$1),this.races$=this.store.select(l),this.participants$=this.store.select(p),this.loading$=this.store.select(Ne),this.measurementsWithParticipants$=mg([this.measurements$,this.participants$]).pipe(oe(([i,e])=>i.map(t=>z(G({},t),{participantName:t.participantId?this.getParticipantName(t.participantId,e):void 0}))),Ig((i,e)=>JSON.stringify(i)===JSON.stringify(e))),this.scheduledImportEnabled$=this.store.select(Je),this.deviceStatus$=this.store.select(Oe$1),this.selectedRaceId$=this.store.select(s),this.autoAssignStatus$=this.store.select(we),this.actions$.pipe(Lx(xe,be,De),wg(this.destroy$)).subscribe(i=>{let e=i.type===xe.type?`Automatik-Modus aktiviert`:i.type===be.type?`Automatik-Modus deaktiviert`:`Startnummer übersprungen`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(Ae,Fe,Ie),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(C),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich erstellt`,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(L),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Erstellen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(P),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich aktualisiert`,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(f),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Aktualisieren der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(N),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich gelöscht`,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(k),wg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim L\xF6schen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(q),wg(this.destroy$)).subscribe(()=>{let i=this.lastResetDevice?`Alle Messungen wurden gelöscht (inkl. Gerät)`:`Alle Messungen wurden gelöscht (nur Datenbank)`;this.snackBar.open(i,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(J),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Löschen der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(U),wg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Kontinuierlicher Modus aktiviert`:`Kontinuierlicher Modus deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(j),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des kontinuierlichen Modus`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(z$1),wg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Automatischer Import aktiviert (alle 5 Sekunden)`:`Automatischer Import deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(G$1),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des automatischen Imports`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(V),wg(this.destroy$)).subscribe(()=>{let i=this.lastArchiveClearAfterArchive?this.lastArchiveResetDevice?`Messungen archiviert und Gerät zurückgesetzt. Bereit für das nächste Rennen.`:`Messungen archiviert. Bereit für das nächste Rennen.`:`Messungen archiviert. Datenbank und Gerät wurden nicht verändert.`;this.snackBar.open(i,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(W$1),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Archivieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(me),wg(this.destroy$)).subscribe(({connected:i})=>{i&&this.store.dispatch(X())}),this.actions$.pipe(Lx($),wg(this.destroy$)).subscribe(()=>{this.store.dispatch(Me()),this.snackBar.open(`Ältester Start erfolgreich verworfen`,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(ee),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Verwerfen des ältesten Starts`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(U),wg(this.destroy$)).subscribe(()=>{this.store.dispatch(X())}),this.actions$.pipe(Lx(se),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messungen erfolgreich exportiert`,`OK`,{duration:3e3})}),this.actions$.pipe(Lx(re),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Exportieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(Lx(oe$1),wg(this.destroy$)).subscribe(({count:i})=>{this.snackBar.open(`${i} Messung(en) erfolgreich importiert`,`OK`,{duration:3e3}),this.loadData()}),this.actions$.pipe(Lx(ae),wg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Importieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})})}ngAfterViewInit(){this.loadData(),this.store.dispatch(i()),this.store.dispatch(H()),this.store.dispatch(X()),this.autoRefresh$.pipe(Dg(i=>i?vg(2e3):Ue),wg(this.destroy$)).subscribe(()=>{this.loadData()}),this.autoRefresh$.next(this.autoRefreshEnabled)}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete(),this.autoRefresh$.complete()}onAutoRefreshToggle(){this.autoRefresh$.next(this.autoRefreshEnabled);let i=this.autoRefreshEnabled?`Automatische Aktualisierung aktiviert`:`Automatische Aktualisierung deaktiviert`;this.snackBar.open(i,`OK`,{duration:2e3})}manualRefresh(){this.loadData(),this.snackBar.open(`Daten wurden aktualisiert`,`OK`,{duration:2e3})}loadData(){this.store.dispatch(S()),this.store.dispatch(t()),this.store.dispatch(Me()),this.updateLastUpdateTime()}updateLastUpdateTime(){let i=new Date;this.lastUpdate=i.toLocaleTimeString(`de-DE`)}getParticipantName(i,e){let t=e.find(a=>a.id===i);return t?.person?`${t.person.firstName} ${t.person.lastName}`:`-`}getParticipantNameByRaceNumber(i,e,t){let a=t.find(c=>c.race?.id===i&&c.raceNumber===e);return a?.person?`${a.person.firstName} ${a.person.lastName}`:`unbekannt`}formatRaceDate(i){let e=i.split(`-`);if(e.length===3){let[t,a,c]=e;return`${c}.${a}.${t}`}return i}onRaceChange(i){this.store.dispatch(S$1({id:i})),i!==null?this.store.dispatch(Se({request:{raceId:i}})):this.store.dispatch(ge$1())}skipAutoAssign(){this.store.dispatch(ve())}formatDuration(i){let e=Math.floor(i/1e3),t=Math.floor(e/3600),a=Math.floor(e%3600/60),c=e%60,b=i%1e3;return t>0?`${t}:${String(a).padStart(2,`0`)}:${String(c).padStart(2,`0`)}.${String(b).padStart(3,`0`)}`:a>0?`${a}:${String(c).padStart(2,`0`)}.${String(b).padStart(3,`0`)}`:`${c}.${String(b).padStart(3,`0`)}s`}openCreateDialog(){this.dialog.open(te,{width:`500px`}).afterClosed().pipe(wg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(h({measurement:e}))})}openEditDialog(i){this.dialog.open(te,{width:`500px`,data:i}).afterClosed().pipe(wg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(R({id:i.id,measurement:t}))})}deleteMeasurement(i){confirm(`M\xF6chten Sie die Messung #${i.id} wirklich l\xF6schen?`)&&this.store.dispatch(E({id:i.id}))}resetMeasurements(i){confirm(i?`Möchten Sie wirklich ALLE Messungen löschen? Dies betrifft auch die Messungen auf dem Gerät!`:`Möchten Sie wirklich ALLE Messungen löschen (nur aus der Datenbank)?`)&&(this.lastResetDevice=i,this.store.dispatch(B({resetDevice:i})))}toggleContinuousMode(i){confirm(i?`Möchten Sie den kontinuierlichen Modus wirklich aktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`:`Möchten Sie den kontinuierlichen Modus wirklich deaktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`)&&this.store.dispatch(O({enable:i}))}toggleScheduledImport(i){this.store.dispatch(w({enable:i}))}openArchiveDialog(){this.races$.pipe(tn(1)).subscribe(i=>{this.dialog.open(Ke,{width:`500px`,data:{races:i}}).afterClosed().pipe(wg(this.destroy$)).subscribe(t=>{t&&(this.lastArchiveResetDevice=t.resetDevice,this.lastArchiveClearAfterArchive=t.clearAfterArchive,this.store.dispatch(T$1(t)))})})}discardOldestStart(){confirm(`Möchten Sie den ältesten Start aus der Warteschlange verwerfen? Dies sollte verwendet werden, wenn ein Läufer gestürzt ist.`)&&this.store.dispatch(_())}exportMeasurements(){this.store.dispatch(te$1())}triggerJsonImport(){this.jsonImportInput().nativeElement.value=``,this.jsonImportInput().nativeElement.click()}onJsonFileSelected(i){let t=i.target.files?.[0];if(!t)return;let a=new FileReader;a.onload=c=>{try{let b=c.target?.result,T=JSON.parse(b);if(!Array.isArray(T)){this.snackBar.open(`Ungültiges JSON-Format: Array erwartet`,`OK`,{duration:5e3,panelClass:`error-snackbar`});return}this.store.dispatch(ne({measurements:T}))}catch{this.snackBar.open(`Fehler beim Lesen der JSON-Datei`,`OK`,{duration:5e3,panelClass:`error-snackbar`})}},a.readAsText(t)}static ɵfac=function(e){return new(e||n)};static ɵcmp=UE({type:n,selectors:[[`app-measurement-list`]],viewQuery:function(e,t){e&1&&dh(t.jsonImportInput,Un,5),e&2&&VD()},decls:105,vars:47,consts:[[`jsonImportInput`,``],[`resetMenu`,`matMenu`],[1,`title-row`],[1,`sync-status`],[`color`,`primary`,`matTooltip`,`Automatische Aktualisierung`,3,`ngModelChange`,`change`,`ngModel`],[`matTooltip`,`Aktualisiere...`,1,`sync-icon`,`syncing`],[1,`sync-icon`,3,`matTooltip`],[1,`last-update-text`],[1,`header-actions`],[`mat-raised-button`,``,`color`,`primary`,3,`click`],[`mat-raised-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Aktuelle Messungen einem Rennen zuordnen und archivieren`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Alle Messungen als JSON-Datei herunterladen`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Messungen aus JSON-Datei importieren`,3,`click`],[`type`,`file`,`accept`,`.json,application/json`,2,`display`,`none`,3,`change`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Alle Messungen zurücksetzen`,3,`matMenuTriggerFor`],[`mat-menu-item`,``,3,`click`],[1,`auto-assign-row`],[`appearance`,`outline`,1,`race-select`,3,`matTooltip`],[3,`selectionChange`,`value`,`disabled`],[3,`value`],[1,`hint`],[1,`loading-overlay`],[1,`table-container`],[`mat-table`,``,1,`measurement-table`,3,`dataSource`],[`matColumnDef`,`id`],[`mat-header-cell`,``,4,`matHeaderCellDef`],[`mat-cell`,``,4,`matCellDef`],[`matColumnDef`,`duration`],[`matColumnDef`,`participant`],[`mat-cell`,``,3,`matTooltip`,4,`matCellDef`],[`matColumnDef`,`measuredAt`],[`matColumnDef`,`actions`],[`mat-header-row`,``,4,`matHeaderRowDef`],[`mat-row`,``,4,`matRowDef`,`matRowDefColumns`],[1,`count-info`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`,3,`click`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Aktuell erwartete Startnummer überspringen (z. B. nicht gestartet)`,3,`click`],[1,`next-number-info`],[`diameter`,`30`],[`mat-header-cell`,``],[`mat-cell`,``],[`mat-cell`,``,3,`matTooltip`],[`mat-icon-button`,``,`matTooltip`,`Bearbeiten`,3,`click`],[`mat-icon-button`,``,`color`,`warn`,`matTooltip`,`Löschen`,3,`click`],[`mat-header-row`,``],[`mat-row`,``]],template:function(e,t){if(e&1){let a=CD();Mi(0,`mat-card`)(1,`mat-card-header`)(2,`mat-card-title`)(3,`div`,2)(4,`span`),cw(5,`Messungen`),Jc(),Mi(6,`div`,3)(7,`mat-slide-toggle`,4),Nh(`ngModelChange`,function(b){return Lu(a),pw(t.autoRefreshEnabled,b)||(t.autoRefreshEnabled=b),Pu(b)}),ih(`change`,function(){return t.onAutoRefreshToggle()}),Jc(),XI(),hD(8,Qn,2,0,`mat-icon`,5),ww(9,`async`),Kc(10,Wn,2,2,`mat-icon`,6),Mi(11,`span`,7),cw(12),Jc()()()()(),Mi(13,`mat-card-content`)(14,`div`,8)(15,`button`,9),ih(`click`,function(){return t.openCreateDialog()}),Mi(16,`mat-icon`),cw(17,`add`),Jc(),cw(18,` Neue Messung `),Jc(),Mi(19,`button`,10),ih(`click`,function(){return t.manualRefresh()}),Mi(20,`mat-icon`),cw(21,`refresh`),Jc(),cw(22,` Manuell aktualisieren `),Jc(),Mi(23,`button`,11),ih(`click`,function(){return t.openArchiveDialog()}),Mi(24,`mat-icon`),cw(25,`archive`),Jc(),cw(26,` Archivieren `),Jc(),Mi(27,`button`,12),ih(`click`,function(){return t.exportMeasurements()}),Mi(28,`mat-icon`),cw(29,`download`),Jc(),cw(30,` JSON Export `),Jc(),Mi(31,`button`,13),ih(`click`,function(){return t.triggerJsonImport()}),Mi(32,`mat-icon`),cw(33,`upload`),Jc(),cw(34,` JSON Import `),Jc(),Mi(35,`input`,14,0),ih(`change`,function(b){return t.onJsonFileSelected(b)}),Jc(),hD(37,Zn,4,0,`button`,15),ww(38,`async`),Kc(39,Xn,4,0,`button`,16),hD(40,Yn,4,0,`button`,17),ww(41,`async`),hD(42,ea,4,0,`button`,18),ww(43,`async`),Kc(44,ta,4,0,`button`,19),Mi(45,`button`,20)(46,`mat-icon`),cw(47,`delete_sweep`),Jc(),cw(48,` Zurücksetzen `),Mi(49,`mat-icon`),cw(50,`arrow_drop_down`),Jc()(),Mi(51,`mat-menu`,null,1)(53,`button`,21),ih(`click`,function(){return t.resetMeasurements(!1)}),Mi(54,`mat-icon`),cw(55,`delete_sweep`),Jc(),Mi(56,`span`),cw(57,`Alle Messungen löschen (nur Datenbank)`),Jc()(),Mi(58,`button`,21),ih(`click`,function(){return t.resetMeasurements(!0)}),Mi(59,`mat-icon`),cw(60,`delete_forever`),Jc(),Mi(61,`span`),cw(62,`Alle löschen (inkl. Gerät)`),Jc()()()(),Mi(63,`div`,22)(64,`mat-form-field`,23),ww(65,`async`),Mi(66,`mat-label`),cw(67,`Rennen (Automatik-Zuordnung)`),Jc(),Mi(68,`mat-select`,24),ww(69,`async`),ww(70,`async`),ih(`selectionChange`,function(b){return t.onRaceChange(b.value)}),Mi(71,`mat-option`,25),cw(72,`— kein Rennen —`),Jc(),vD(73,ia,2,3,`mat-option`,25,Jn),ww(75,`async`),Jc()(),hD(76,sa,2,3),ww(77,`async`),Kc(78,da,2,0,`span`,26),Jc(),hD(79,ca,2,0,`div`,27),ww(80,`async`),Mi(81,`div`,28)(82,`table`,29),ww(83,`async`),ww(84,`async`),tl(85,30),Wp(86,la,2,0,`th`,31)(87,ma,2,1,`td`,32),nl(),tl(88,33),Wp(89,ua,2,0,`th`,31)(90,pa,2,1,`td`,32),nl(),tl(91,34),Wp(92,ha,2,0,`th`,31)(93,ba,2,2,`td`,35),nl(),tl(94,36),Wp(95,ga,2,0,`th`,31)(96,_a,3,4,`td`,32),nl(),tl(97,37),Wp(98,fa,2,0,`th`,31)(99,va,7,0,`td`,32),nl(),Wp(100,Sa,1,0,`tr`,38)(101,ya,1,0,`tr`,39),Jc()(),Mi(102,`div`,40),cw(103),ww(104,`async`),Jc()()()}if(e&2){let a,c=HD(52);dI(7),_h(`ngModel`,t.autoRefreshEnabled),tE(),dI(),gD(Tw(9,19,t.loading$)?8:10),dI(4),wh(t.lastUpdate),dI(25),gD(Tw(38,21,t.deviceStatus$)===`continuous`?37:39),dI(3),gD(Tw(41,23,t.deviceStatus$)===`normal`?40:-1),dI(2),gD(Tw(43,25,t.scheduledImportEnabled$)?42:44),dI(3),Jp(`matMenuTriggerFor`,c),dI(19),Jp(`matTooltip`,Tw(65,27,t.scheduledImportEnabled$)?`Automatischen Import zuerst deaktivieren, um das Rennen zu wechseln`:`Rennen auswählen startet die automatische Zuordnung, abwählen stoppt sie`),dI(4),Jp(`value`,Tw(69,29,t.selectedRaceId$))(`disabled`,!!Tw(70,31,t.scheduledImportEnabled$)),dI(3),Jp(`value`,null),dI(2),ID(Tw(75,33,t.races$)),dI(3),gD((a=Tw(77,35,t.selectedRaceId$))?76:78,a),dI(3),gD(Tw(80,37,t.loading$)?79:-1),dI(3),gh(`loading`,Tw(83,39,t.loading$)),Jp(`dataSource`,Tw(84,41,t.measurementsWithParticipants$)||Iw(45,Xe)),dI(18),Jp(`matHeaderRowDef`,t.displayedColumns),dI(),Jp(`matRowDefColumns`,t.displayedColumns),dI(2),rl(` Anzahl der Messungen: `,(Tw(104,43,t.measurements$)||Iw(46,Xe)).length,` `)}},dependencies:[Ba,qa,Ba$1,La,Va,ja,Pa,Wa,za,Ha,Qa,Ua,fw,uw,qm,Tw$1,Fw,wx,Dx,Po,ar,LE,TE,OE,PE,IE,wE,Mp,hn,We,Lt,I,G$2,Bt,Br,Zd,Ss,Ir,Wl,Es,OD$1,AD,Bm,Fu,Iu],styles:[`.title-row[_ngcontent-%COMP%]{display:flex;justify-content:space-between;align-items:center;width:100%;gap:32px}.sync-status[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;font-size:.875rem;color:#0009}.sync-icon[_ngcontent-%COMP%]{font-size:20px;width:20px;height:20px;color:#0009}.sync-icon.syncing[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_spin 1s linear infinite;color:#3f51b5}@keyframes _ngcontent-%COMP%_spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.last-update-text[_ngcontent-%COMP%]{font-size:.75rem;white-space:nowrap}.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px;position:relative;flex-wrap:wrap;align-items:center}.active-mode[_ngcontent-%COMP%]{background-color:#4caf50!important;color:#fff!important}.active-mode[_ngcontent-%COMP%]:hover{background-color:#45a049!important}.auto-assign-row[_ngcontent-%COMP%]{margin-bottom:20px;display:flex;gap:16px;flex-wrap:wrap;align-items:center}.race-select[_ngcontent-%COMP%]{min-width:280px}.next-number-info[_ngcontent-%COMP%]{font-size:.9rem;color:#000000b3}.hint[_ngcontent-%COMP%]{color:#0009}.loading-overlay[_ngcontent-%COMP%]{position:absolute;top:0;right:0;z-index:10;display:flex;align-items:center;justify-content:center;padding:10px}.measurement-table[_ngcontent-%COMP%]{width:100%;transition:opacity .2s ease}.measurement-table.loading[_ngcontent-%COMP%]{opacity:.6}mat-card[_ngcontent-%COMP%]{margin:20px}mat-card-content[_ngcontent-%COMP%]{position:relative}.count-info[_ngcontent-%COMP%]{margin-top:16px;padding:12px 16px;background-color:#f5f5f5;border-radius:4px;font-size:14px;font-weight:500;color:#000000de}@media(max-width:768px){mat-card[_ngcontent-%COMP%]{margin:8px}.title-row[_ngcontent-%COMP%]{flex-wrap:wrap;gap:8px}}`]})};export{yn as MeasurementListComponent};