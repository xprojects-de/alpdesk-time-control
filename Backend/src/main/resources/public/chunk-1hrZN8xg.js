...
`],encapsulation:2})}return n})();var An=(()=>{class n{static ɵfac=function(t){return new(t||n)};static ɵmod=GE({type:n});static ɵinj=uu({imports:[Do,Qe,an]})}return n})();var ea=(n,i)=>i.id;function ta(n,i){if(n&1&&(Mi(0,`mat-option`,4),lw(1),Jc()),n&2){let e=i.$implicit,t=RD();Xp(`value`,e.id),fI(),Th(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function ia(n,i){n&1&&(Mi(0,`mat-error`),lw(1,`Bitte ein Rennen auswählen`),Jc())}function na(n,i){n&1&&(Mi(0,`mat-error`),lw(1,`Bitte eine Archivierungs-Variante auswählen`),Jc())}var Ze=class n{fb=T(bu);dialogRef=T(b$1);data=T(ce$1);form=this.fb.group({raceId:[null,bt.required],mode:[null,bt.required]});onCancel(){this.dialogRef.close()}onSave(){if(!this.form.valid)return;let i=this.form.value.mode,e={raceId:Number(this.form.value.raceId),resetDevice:i===`reset`,clearAfterArchive:i!==`noclear`};this.dialogRef.close(e)}formatRaceDate(i){let e=i.split(`-`);return e.length===3?`${e[2]}.${e[1]}.${e[0]}`:i}static ɵfac=function(e){return new(e||n)};static ɵcmp=qE({type:n,selectors:[[`app-archive-measurements-dialog`]],decls:30,vars:4,consts:[[`mat-dialog-title`,``],[1,`archive-form`,3,`formGroup`],[`appearance`,`outline`],[`formControlName`,`raceId`,`required`,``],[3,`value`],[`formControlName`,`mode`,1,`mode-group`],[`value`,`reset`],[1,`hint`],[`value`,`keep`],[`value`,`noclear`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`]],template:function(e,t){e&1&&(Mi(0,`h2`,0),lw(1,`Messungen archivieren`),Jc(),Mi(2,`mat-dialog-content`)(3,`form`,1)(4,`mat-form-field`,2)(5,`mat-label`),lw(6,`Rennen`),Jc(),Mi(7,`mat-select`,3),ID(8,ta,2,3,`mat-option`,4,ea),Jc(),eE(),gD(10,ia,2,0,`mat-error`),Jc(),Mi(11,`mat-radio-group`,5)(12,`mat-radio-button`,6),lw(13,` Archivieren (inkl. Gerät-Reset) `),Mi(14,`p`,7),lw(15,` Aktuelle Messungen werden diesem Rennen zugeordnet, danach werden Datenbank und Gerät geleert. Bereit für das nächste Rennen. `),Jc()(),Mi(16,`mat-radio-button`,8),lw(17,` Archivieren (nur Datenbank) `),Mi(18,`p`,7),lw(19,`Wie oben, aber nur die Datenbank wird geleert, das Gerät bleibt unverändert.`),Jc()(),Mi(20,`mat-radio-button`,9),lw(21,` Archivieren (ohne Löschen) `),Mi(22,`p`,7),lw(23,` Aktuelle Messungen werden diesem Rennen zugeordnet. Datenbank und Gerät werden dabei NICHT verändert. `),Jc()()(),eE(),gD(24,na,2,0,`mat-error`),Jc()(),Mi(25,`mat-dialog-actions`,10)(26,`button`,11),sh(`click`,function(){return t.onCancel()}),lw(27,`Abbrechen`),Jc(),Mi(28,`button`,12),sh(`click`,function(){return t.onSave()}),lw(29,`Archivieren`),Jc()()),e&2&&(fI(3),Xp(`formGroup`,t.form),fI(4),nE(),fI(),ED(t.data.races),fI(2),mD(t.form.get(`raceId`)?.hasError(`required`)&&t.form.get(`raceId`)?.touched?10:-1),fI(),nE(),fI(13),mD(t.form.get(`mode`)?.hasError(`required`)&&t.form.get(`mode`)?.touched?24:-1),fI(4),Xp(`disabled`,!t.form.valid))},dependencies:[di,Su,yu,gu,_u,So,yi,rl$1,ot$1,tt,nt,it,Vo,$r,ti,fa$1,om,rm,nn,An,mt,Qe,sh$1,ah],styles:[`.archive-form[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:8px;min-width:420px;margin-top:16px}mat-form-field[_ngcontent-%COMP%]{width:100%}.mode-group[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:12px}.hint[_ngcontent-%COMP%]{margin:2px 0 0;font-size:12px;color:#0009}`]})};var Rn=[{key:`participantId`,label:`Teilnehmer-ID`,required:!1},{key:`durationMs`,label:`Dauer (ms)`,required:!0},{key:`measuredAt`,label:`Gemessen am`,required:!1}];var oa=(n,i)=>i.value;var ut=(n,i)=>i.key;function sa(n,i){if(n&1&&(Mi(0,`span`,6),lw(1),Jc()),n&2){let e=RD();fI(),bh(e.file().name)}}function da(n,i){if(n&1&&(Mi(0,`mat-option`,15),lw(1),Jc()),n&2){let e=i.$implicit;Xp(`value`,e.value),fI(),bh(e.label)}}function la(n,i){if(n&1){let e=_D();Mi(0,`div`,7)(1,`mat-form-field`,13)(2,`mat-label`),lw(3,`Trennzeichen`),Jc(),Mi(4,`mat-select`,14),sh(`selectionChange`,function(a){Pu(e);return Fu(RD().onDelimiterChange(a.value))}),ID(5,da,2,2,`mat-option`,15,oa),Jc()()()}if(n&2){let e=RD();fI(4),Xp(`value`,e.delimiter()),fI(),ED(e.delimiterOptions)}}function ca(n,i){n&1&&(Mi(0,`div`,8),eh(1,`mat-spinner`,16),Mi(2,`span`),lw(3,`Datei wird analysiert...`),Jc()())}function ma(n,i){if(n&1&&(Mi(0,`p`,9),lw(1),Jc()),n&2){let e=RD();fI(),bh(e.previewError())}}function ua(n,i){if(n&1&&(Mi(0,`mat-option`,15),lw(1),Jc()),n&2){let e=i.$implicit;Xp(`value`,e),fI(),bh(e)}}function pa(n,i){if(n&1&&(Mi(0,`mat-form-field`,13)(1,`mat-label`),lw(2),Jc(),Mi(3,`mat-select`,18)(4,`mat-option`,19),lw(5,`— nicht importieren —`),Jc(),ID(6,ua,2,2,`mat-option`,15,vD),Jc(),eE(),Jc()),n&2){let e=i.$implicit,t=RD();fI(2),Th(``,e.label,``,e.required?` *`:``),fI(),Xp(`formControlName`,e.key),nE(),fI(3),ED(t.availableFields)}}function ha(n,i){if(n&1&&(Mi(0,`th`),lw(1),Jc()),n&2){let e=i.$implicit;fI(),bh(e.label)}}function ga(n,i){if(n&1&&(Mi(0,`td`),lw(1),Jc()),n&2){let e=i.$implicit,t=RD().$implicit,a=RD(3);fI(),bh(a.previewValue(t,e.key))}}function ba(n,i){if(n&1&&(Mi(0,`tr`),ID(1,ga,2,1,`td`,null,ut),Jc()),n&2){let e=RD(3);fI(),ED(e.targetFields)}}function _a(n,i){if(n&1&&(Mi(0,`h3`),lw(1,`Vorschau`),Jc(),Mi(2,`div`,20)(3,`table`,21)(4,`thead`)(5,`tr`),ID(6,ha,2,1,`th`,null,ut),Jc()(),Mi(8,`tbody`),ID(9,ba,3,0,`tr`,null,yD),Jc()()()),n&2){let e=RD(),t=RD();fI(6),ED(t.targetFields),fI(3),ED(e.sampleRows)}}function fa(n,i){if(n&1&&(Mi(0,`h3`),lw(1,`Spalten zuordnen`),Jc(),Mi(2,`form`,17),ID(3,pa,8,3,`mat-form-field`,13,ut),Jc(),gD(5,_a,11,0)),n&2){let e=RD();fI(2),Xp(`formGroup`,e.mappingForm),fI(),ED(e.targetFields),fI(2),mD(i.sampleRows.length>0?5:-1)}}var Xe=class n{fb=T(bu);measurementService=T(x);dialogRef=T(b$1);targetFields=Rn;delimiterOptions=[{value:``,label:`Automatisch erkennen`},{value:`;`,label:`Semikolon (;)`},{value:`,`,label:`Komma (,)`},{value:`	`,label:`Tab`},{value:`|`,label:`Pipe (|)`}];file=Yo(null);delimiter=Yo(``);previewLoading=Yo(!1);previewError=Yo(null);preview=Yo(null);mappingForm=this.fb.group(Object.fromEntries(this.targetFields.map(i=>[i.key,[``,i.required?bt.required:[]]])));onFileSelected(i){let t=i.target.files?.[0]??null;this.file.set(t),this.preview.set(null),this.previewError.set(null),t?this.analyze():(this.analyzeRequestId++,this.previewLoading.set(!1))}onDelimiterChange(i){this.delimiter.set(i),this.analyze()}analyzeRequestId=0;analyze(){let i=this.file();if(!i)return;let e=++this.analyzeRequestId;this.previewLoading.set(!0),this.previewError.set(null),this.measurementService.previewImport(i,this.delimiter()||void 0).subscribe({next:t=>{if(e!==this.analyzeRequestId)return;this.previewLoading.set(!1),this.preview.set(t);let a={};for(let l of this.targetFields)a[l.key]=t.suggestedMapping[l.key]??``;this.mappingForm.patchValue(a)},error:t=>{e===this.analyzeRequestId&&(this.previewLoading.set(!1),this.preview.set(null),this.previewError.set(t?.error?.message??`Datei konnte nicht gelesen/analysiert werden.`))}})}previewValue(i,e){let t=this.mappingForm.get(e)?.value;return t?i[t]??``:``}onCancel(){this.dialogRef.close()}onImport(){let i=this.file();if(!i)return;let e=this.mappingForm.value,t={};for(let[l,_]of Object.entries(e))_&&(t[l]=_);let a={file:i,delimiter:this.delimiter()||void 0,mapping:t};this.dialogRef.close(a)}static ɵfac=function(e){return new(e||n)};static ɵcmp=qE({type:n,selectors:[[`app-measurement-import-mapping-dialog`]],decls:22,vars:6,consts:[[`fileInput`,``],[`mat-dialog-title`,``],[1,`hint`],[1,`file-row`],[`type`,`file`,`accept`,`.csv,.txt,text/csv`,`hidden`,``,3,`change`],[`mat-raised-button`,``,3,`click`],[1,`filename`],[1,`format-row`],[1,`loading-row`],[1,`error`],[`align`,`end`],[`mat-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`primary`,3,`click`,`disabled`],[`appearance`,`outline`],[3,`selectionChange`,`value`],[3,`value`],[`diameter`,`24`],[1,`mapping-grid`,3,`formGroup`],[3,`formControlName`],[`value`,``],[1,`preview-table-wrapper`],[1,`preview-table`]],template:function(e,t){if(e&1){let a=_D();Mi(0,`h2`,1),lw(1,`Messungen importieren`),Jc(),Mi(2,`mat-dialog-content`)(3,`p`,2),lw(4,` CSV-Datei (beliebiges Trennzeichen). Ordne die Spalten der Datei unseren Feldern zu - das Mapping wird nicht gespeichert und muss bei jedem Import neu gewählt werden. Nicht zugeordnete Felder werden einfach nicht importiert. `),Jc(),Mi(5,`div`,3)(6,`input`,4,0),sh(`change`,function(_){return t.onFileSelected(_)}),Jc(),Mi(8,`button`,5),sh(`click`,function(){Pu(a);return Fu(BD(7).click())}),Mi(9,`mat-icon`),lw(10,`upload_file`),Jc(),lw(11,` Datei wählen `),Jc(),gD(12,sa,2,1,`span`,6),Jc(),gD(13,la,7,1,`div`,7),gD(14,ca,4,0,`div`,8),gD(15,ma,2,1,`p`,9),gD(16,fa,6,2),Jc(),Mi(17,`mat-dialog-actions`,10)(18,`button`,11),sh(`click`,function(){return t.onCancel()}),lw(19,`Abbrechen`),Jc(),Mi(20,`button`,12),sh(`click`,function(){return t.onImport()}),lw(21,` Importieren `),Jc()()}if(e&2){let a;fI(12),mD(t.file()?12:-1),fI(),mD(t.file()?13:-1),fI(),mD(t.previewLoading()?14:-1),fI(),mD(t.previewError()?15:-1),fI(),mD((a=t.preview())?16:-1,a),fI(4),Xp(`disabled`,!t.preview()||t.previewLoading()||t.mappingForm.invalid)}},dependencies:[di,Su,yu,gu,_u,yi,rl$1,ot$1,tt,nt,it,Vo,$r,ti,sh$1,ah,om,rm,nn,yt,wt,op,rp],styles:[`mat-dialog-content[_ngcontent-%COMP%]{min-width:500px;max-width:80vw}.hint[_ngcontent-%COMP%]{font-size:12px;color:#0009}.file-row[_ngcontent-%COMP%], .format-row[_ngcontent-%COMP%], .loading-row[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;margin-bottom:8px}.filename[_ngcontent-%COMP%]{font-size:13px}.error[_ngcontent-%COMP%]{color:#b00020}.mapping-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:4px 16px}.preview-table-wrapper[_ngcontent-%COMP%]{overflow-x:auto;max-width:100%}.preview-table[_ngcontent-%COMP%]{border-collapse:collapse;font-size:12px;width:100%}.preview-table[_ngcontent-%COMP%]   th[_ngcontent-%COMP%], .preview-table[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{border:1px solid rgba(0,0,0,.12);padding:4px 8px;text-align:left;white-space:nowrap}`]})};var pt=()=>[];var va=(n,i)=>i.id;function ya(n,i){n&1&&(Mi(0,`mat-icon`,4),lw(1,`sync `),Jc())}function Ma(n,i){if(n&1&&(Mi(0,`mat-icon`,5),lw(1,`sync `),Jc()),n&2)Xp(`matTooltip`,gw(`Letzte Aktualisierung: `,RD().lastUpdate))}function Sa(n,i){n&1&&eh(0,`mat-spinner`,13)}function wa(n,i){n&1&&(Mi(0,`mat-icon`),lw(1,`upload_file`),Jc())}function Ca(n,i){if(n&1){let e=_D();Mi(0,`button`,40),sh(`click`,function(){Pu(e);return Fu(RD(2).toggleContinuousMode(!1))}),Mi(1,`mat-icon`),lw(2,`stop`),Jc(),lw(3,` Kontinuierlich AUS `),Jc()}}function ka(n,i){if(n&1){let e=_D();Mi(0,`button`,41),sh(`click`,function(){Pu(e);return Fu(RD(2).toggleContinuousMode(!0))}),Mi(1,`mat-icon`),lw(2,`play_arrow`),Jc(),lw(3,` Kontinuierlich AN `),Jc()}}function xa(n,i){if(n&1){let e=_D();Mi(0,`button`,42),sh(`click`,function(){Pu(e);return Fu(RD(2).discardOldestStart())}),Mi(1,`mat-icon`),lw(2,`person_off`),Jc(),lw(3,` Sturz signalisieren `),Jc()}}function Na(n,i){if(n&1&&(gD(0,Ca,4,0,`button`,37),bw(1,`async`),Kc(2,ka,4,0,`button`,38),gD(3,xa,4,0,`button`,39),bw(4,`async`)),n&2){let e=RD();mD(Cw(1,2,e.deviceStatus$)===`continuous`?0:2),fI(3),mD(Cw(4,4,e.deviceStatus$)===`normal`?3:-1)}}function Ea(n,i){if(n&1){let e=_D();Mi(0,`button`,43),sh(`click`,function(){Pu(e);return Fu(RD().toggleScheduledImport(!1))}),Mi(1,`mat-icon`),lw(2,`cloud_sync`),Jc(),lw(3,` Auto-Import AUS `),Jc()}}function Ia(n,i){if(n&1){let e=_D();Mi(0,`button`,44),sh(`click`,function(){Pu(e);return Fu(RD().toggleScheduledImport(!0))}),Mi(1,`mat-icon`),lw(2,`cloud_download`),Jc(),lw(3,` Auto-Import AN `),Jc()}}function Aa(n,i){if(n&1&&(Mi(0,`mat-option`,21),lw(1),Jc()),n&2){let e=i.$implicit,t=RD();Xp(`value`,e.id),fI(),Th(``,e.name,` (`,t.formatRaceDate(e.date),`)`)}}function Da(n,i){if(n&1&&(Mi(0,`strong`),lw(1),Jc(),lw(2),bw(3,`async`)),n&2){let e=RD(2),t=RD(),a=RD();fI(),bh(e.nextRaceNumber),fI(),rl(` (`,a.getParticipantNameByRaceNumber(t,e.nextRaceNumber,Cw(3,2,a.participants$)||Ew(4,pt)),`) `)}}function Ra(n,i){n&1&&(Mi(0,`em`),lw(1,`keine weiteren Startnummern`),Jc())}function Ta(n,i){if(n&1){let e=_D();Mi(0,`button`,45),bw(1,`async`),sh(`click`,function(){Pu(e);return Fu(RD(3).skipAutoAssign())}),Mi(2,`mat-icon`),lw(3,`skip_next`),Jc(),lw(4,` Überspringen `),Jc(),Mi(5,`span`,46),lw(6,` Nächste erwartete Startnummer: `),gD(7,Da,4,5)(8,Ra,2,0,`em`),Jc()}if(n&2){let e=RD();Xp(`disabled`,Cw(1,2,RD(2).autoAssignBusy$)),fI(7),mD(e.nextRaceNumber!==null?7:8)}}function $a(n,i){if(n&1&&gD(0,Ta,9,4),n&2){let e=i,t=RD();mD(e.active&&e.raceId===t?0:-1)}}function Fa(n,i){if(n&1&&(gD(0,$a,1,1),bw(1,`async`)),n&2){let e;mD((e=Cw(1,1,RD().autoAssignStatus$))?0:-1,e)}}function La(n,i){n&1&&(Mi(0,`span`,22),lw(1,`Rennen auswählen, um Messungen automatisch zuzuordnen.`),Jc())}function Oa(n,i){n&1&&(Mi(0,`div`,23),eh(1,`mat-spinner`,47),Jc())}function Pa(n,i){n&1&&(Mi(0,`th`,48),lw(1,`ID`),Jc())}function za(n,i){if(n&1&&(Mi(0,`td`,49),lw(1),Jc()),n&2){let e=i.$implicit;fI(),bh(e.id)}}function Ba(n,i){n&1&&(Mi(0,`th`,48),lw(1,`Dauer`),Jc())}function Ga(n,i){if(n&1&&(Mi(0,`td`,49),lw(1),Jc()),n&2){let e=i.$implicit,t=RD();fI(),rl(` `,t.formatDuration(e.durationMs),` `)}}function Va(n,i){n&1&&(Mi(0,`th`,48),lw(1,`Teilnehmer`),Jc())}function qa(n,i){if(n&1&&(Mi(0,`td`,50),lw(1),Jc()),n&2){let e=i.$implicit;Xp(`matTooltip`,e.participantId?`Bereits einem Rennen zugeordnet`:``),fI(),rl(` `,e.participantName||`-`,` `)}}function Ka(n,i){n&1&&(Mi(0,`th`,48),lw(1,`Gemessen am`),Jc())}function Ha(n,i){if(n&1&&(Mi(0,`td`,49),lw(1),bw(2,`date`),Jc()),n&2){let e=i.$implicit;fI(),rl(` `,_w(2,1,e.measuredAt,`dd.MM.yyyy HH:mm:ss`),` `)}}function ja(n,i){n&1&&(Mi(0,`th`,48),lw(1,`Aktionen`),Jc())}function Ua(n,i){if(n&1){let e=_D();Mi(0,`td`,49)(1,`button`,51),sh(`click`,function(){let a=Pu(e).$implicit;return Fu(RD().openEditDialog(a))}),Mi(2,`mat-icon`),lw(3,`edit`),Jc()(),Mi(4,`button`,52),sh(`click`,function(){let a=Pu(e).$implicit;return Fu(RD().deleteMeasurement(a))}),Mi(5,`mat-icon`),lw(6,`delete`),Jc()()()}}function Wa(n,i){n&1&&eh(0,`tr`,53)}function Qa(n,i){n&1&&eh(0,`tr`,54)}var Tn=class n{store=T(je$1);dialog=T(de);snackBar=T(Wc);actions$=T(Lp);destroy$=new Q;autoRefresh$=new Q;trackById=(i,e)=>e.id;measurements$;races$;participants$;measurementsWithParticipants$;selectedRaceId$;autoAssignStatus$;autoAssignBusy$;loading$;scheduledImportEnabled$;deviceStatus$;timingProviderActive$;importLoading$;displayedColumns=[`id`,`duration`,`measuredAt`,`participant`,`actions`];lastUpdate=``;autoRefreshEnabled=!1;constructor(){this.measurements$=this.store.select(b),this.races$=this.store.select(s),this.participants$=this.store.select(a),this.loading$=this.store.select(Be$1),this.timingProviderActive$=this.store.select(S).pipe(Hn$1(i=>i!==null),Eg()),this.measurementsWithParticipants$=yg([this.measurements$,this.participants$]).pipe(oe(([i,e])=>i.map(t=>z(G({},t),{participantName:t.participantId?this.getParticipantName(t.participantId,e):void 0}))),Eg(s$1)),this.scheduledImportEnabled$=this.store.select(He),this.deviceStatus$=this.store.select(Je),this.autoAssignStatus$=this.store.select(Ge$1),this.autoAssignBusy$=this.store.select(Qe$1),this.selectedRaceId$=this.autoAssignStatus$.pipe(oe(i=>i.active?i.raceId:null),Eg()),this.importLoading$=this.store.select(Xe$1),this.actions$.pipe(jp(Ie,fe,Ue$2),bg(this.destroy$)).subscribe(i=>{let e=i.type===Ie.type?`Automatik-Modus aktiviert`:i.type===fe.type?`Automatik-Modus deaktiviert`:`Startnummer übersprungen`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(jp(Ce,Re$1,$e),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(L),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich erstellt`,`OK`,{duration:3e3})}),this.actions$.pipe(jp(P),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Erstellen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(N),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich aktualisiert`,`OK`,{duration:3e3})}),this.actions$.pipe(jp(E),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Aktualisieren der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(B),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messung erfolgreich gelöscht`,`OK`,{duration:3e3})}),this.actions$.pipe(jp(w),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim L\xF6schen der Messung: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(V),bg(this.destroy$)).subscribe(({message:i})=>{let t=ot(i)?`Alle Messungen wurden gelöscht (inkl. Gerät)`:`Alle Messungen wurden gelöscht (nur Datenbank)`;this.snackBar.open(t,`OK`,{duration:3e3})}),this.actions$.pipe(jp(H),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Löschen der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(W),bg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Kontinuierlicher Modus aktiviert`:`Kontinuierlicher Modus deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(jp(z$1),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des kontinuierlichen Modus`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(K),bg(this.destroy$)).subscribe(({enabled:i})=>{let e=i?`Automatischer Import aktiviert (alle 5 Sekunden)`:`Automatischer Import deaktiviert`;this.snackBar.open(e,`OK`,{duration:3e3})}),this.actions$.pipe(jp(Q$1),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Ändern des automatischen Imports`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(ee),bg(this.destroy$)).subscribe(({clearAfterArchive:i,message:e})=>{let t=ot(e),a=i?t?`Messungen archiviert und Gerät zurückgesetzt. Bereit für das nächste Rennen.`:`Messungen archiviert. Bereit für das nächste Rennen.`:`Messungen archiviert. Datenbank und Gerät wurden nicht verändert.`;this.snackBar.open(a,`OK`,{duration:3e3})}),this.actions$.pipe(jp(te),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Archivieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(Ae),bg(this.destroy$)).subscribe(({connected:i})=>{i&&this.store.dispatch(se())}),this.actions$.pipe(jp(oe$1),bg(this.destroy$)).subscribe(()=>{this.store.dispatch(xe()),this.snackBar.open(`Ältester Start erfolgreich verworfen`,`OK`,{duration:3e3})}),this.actions$.pipe(jp(ue),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Verwerfen des ältesten Starts`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(W),bg(this.destroy$)).subscribe(()=>{this.store.dispatch(se())}),this.actions$.pipe(jp(ce),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`Messungen erfolgreich exportiert`,`OK`,{duration:3e3})}),this.actions$.pipe(jp(pe),bg(this.destroy$)).subscribe(()=>{this.snackBar.open(`FEHLER beim Exportieren der Messungen`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.actions$.pipe(jp(le$1),bg(this.destroy$)).subscribe(({result:i})=>{let e=i.skippedCount>0?`Import abgeschlossen: ${i.importedCount} importiert, ${i.skippedCount} \xFCbersprungen`:`Import abgeschlossen: ${i.importedCount} importiert`;this.snackBar.open(e,`OK`,{duration:i.skippedCount>0?8e3:3e3});let t=i.errors??[];if(t.length>0){let a=t.map(l=>`Zeile ${l.lineNumber}: ${l.reason}`).join(`
`);this.dialog.open(st,{width:`500px`,data:{title:`Übersprungene Zeilen`,message:a,confirmLabel:`OK`,hideCancel:!0}})}this.loadData()}),this.actions$.pipe(jp(Me),bg(this.destroy$)).subscribe(({error:i})=>{this.snackBar.open(`FEHLER beim Importieren der Messungen: ${i}`,`OK`,{duration:1e4,panelClass:`error-snackbar`})}),this.timingProviderActive$.pipe(bg(this.destroy$)).subscribe(i=>{i&&this.store.dispatch(se())})}ngAfterViewInit(){this.loadData(),this.store.dispatch(e()),this.store.dispatch(X()),this.autoRefresh$.pipe(wg(i=>i?Ig(2e3):Ue$1),bg(this.destroy$)).subscribe(()=>{this.loadMeasurementData()}),this.autoRefresh$.next(this.autoRefreshEnabled)}ngOnDestroy(){this.destroy$.next(),this.destroy$.complete(),this.autoRefresh$.complete()}onAutoRefreshToggle(){this.autoRefresh$.next(this.autoRefreshEnabled);let i=this.autoRefreshEnabled?`Automatische Aktualisierung aktiviert`:`Automatische Aktualisierung deaktiviert`;this.snackBar.open(i,`OK`,{duration:2e3})}manualRefresh(){this.loadData(),this.snackBar.open(`Daten wurden aktualisiert`,`OK`,{duration:2e3})}loadData(){this.store.dispatch(r()),this.loadMeasurementData()}loadMeasurementData(){this.store.dispatch(F()),this.store.dispatch(xe()),this.updateLastUpdateTime()}updateLastUpdateTime(){let i=new Date;this.lastUpdate=i.toLocaleTimeString(`de-DE`)}getParticipantName(i,e){let t=e.find(a=>a.id===i);return t?.person?`${t.person.firstName} ${t.person.lastName}`:`-`}getParticipantNameByRaceNumber(i,e,t){let a=t.find(l=>l.race?.id===i&&l.raceNumber===e);return a?.person?`${a.person.firstName} ${a.person.lastName}`:`unbekannt`}formatRaceDate(i){let e=i.split(`-`);if(e.length===3){let[t,a,l]=e;return`${l}.${a}.${t}`}return i}onRaceChange(i){this.store.dispatch(g({id:i})),i!==null?this.store.dispatch(Fe({request:{raceId:i}})):this.store.dispatch(De())}skipAutoAssign(){this.store.dispatch(Oe())}formatDuration(i){let e=Math.floor(i/1e3),t=Math.floor(e/3600),a=Math.floor(e%3600/60),l=e%60,_=i%1e3;return t>0?`${t}:${String(a).padStart(2,`0`)}:${String(l).padStart(2,`0`)}.${String(_).padStart(3,`0`)}`:a>0?`${a}:${String(l).padStart(2,`0`)}.${String(_).padStart(3,`0`)}`:`${l}.${String(_).padStart(3,`0`)}s`}openCreateDialog(){this.dialog.open(ye,{width:`500px`}).afterClosed().pipe(bg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(y({measurement:e}))})}openEditDialog(i){this.dialog.open(ye,{width:`500px`,data:i}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(k({id:i.id,measurement:t}))})}deleteMeasurement(i){this.dialog.open(st,{width:`450px`,data:{message:`M\xF6chten Sie die Messung #${i.id} wirklich l\xF6schen?`,confirmLabel:`Löschen`,confirmColor:`warn`}}).afterClosed().pipe(bg(this.destroy$)).subscribe(e=>{e&&this.store.dispatch(q({id:i.id}))})}resetMeasurements(i){let e=i?`Möchten Sie wirklich ALLE Messungen löschen? Dies betrifft auch die Messungen auf dem Gerät!`:`Möchten Sie wirklich ALLE Messungen löschen (nur aus der Datenbank)?`;this.dialog.open(st,{width:`450px`,data:{message:e,confirmLabel:`Löschen`,confirmColor:`warn`}}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(j({resetDevice:i}))})}toggleContinuousMode(i){let e=i?`Möchten Sie den kontinuierlichen Modus wirklich aktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`:`Möchten Sie den kontinuierlichen Modus wirklich deaktivieren? Dabei werden alle Zeiten auf dem Gerät zurückgesetzt!`;this.dialog.open(st,{width:`450px`,data:{message:e,confirmLabel:`Bestätigen`}}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(J({enable:i}))})}toggleScheduledImport(i){this.store.dispatch(G$1({enable:i}))}openArchiveDialog(){this.races$.pipe(tn(1)).subscribe(i=>{this.dialog.open(Ze,{width:`500px`,data:{races:i}}).afterClosed().pipe(bg(this.destroy$)).subscribe(t=>{t&&this.store.dispatch(_(t))})})}discardOldestStart(){this.dialog.open(st,{width:`450px`,data:{message:`Möchten Sie den ältesten Start aus der Warteschlange verwerfen? Dies sollte verwendet werden, wenn ein Läufer gestürzt ist.`,confirmLabel:`Verwerfen`,confirmColor:`warn`}}).afterClosed().pipe(bg(this.destroy$)).subscribe(i=>{i&&this.store.dispatch(ae())})}exportMeasurementsCsv(){this.store.dispatch(ie())}openImportDialog(){this.dialog.open(Xe,{width:`900px`}).afterClosed().pipe(bg(this.destroy$)).subscribe(e=>{e&&(this.store.dispatch(me({file:e.file,delimiter:e.delimiter,mapping:e.mapping})),this.snackBar.open(`Import gestartet...`,`OK`,{duration:2e3}))})}static ɵfac=function(e){return new(e||n)};static ɵcmp=qE({type:n,selectors:[[`app-measurement-list`]],decls:103,vars:53,consts:[[`resetMenu`,`matMenu`],[1,`title-row`],[1,`sync-status`],[`color`,`primary`,`matTooltip`,`Automatische Aktualisierung`,3,`ngModelChange`,`change`,`ngModel`],[`matTooltip`,`Aktualisiere...`,1,`sync-icon`,`syncing`],[1,`sync-icon`,3,`matTooltip`],[1,`last-update-text`],[1,`header-actions`],[`mat-raised-button`,``,`color`,`primary`,3,`click`],[`mat-raised-button`,``,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Aktuelle Messungen einem Rennen zuordnen und archivieren`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Alle Messungen als CSV-Datei herunterladen`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Messungen aus CSV-Datei importieren (mit Spalten-Zuordnung)`,3,`click`,`disabled`],[`diameter`,`20`,2,`display`,`inline-block`,`margin-right`,`8px`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Alle Messungen zurücksetzen`,3,`matMenuTriggerFor`],[`mat-menu-item`,``,3,`click`],[1,`auto-assign-row`],[`appearance`,`outline`,1,`race-select`,3,`matTooltip`],[3,`selectionChange`,`value`,`disabled`],[3,`value`],[1,`hint`],[1,`loading-overlay`],[1,`table-container`],[`mat-table`,``,1,`measurement-table`,3,`dataSource`,`trackBy`],[`matColumnDef`,`id`],[`mat-header-cell`,``,4,`matHeaderCellDef`],[`mat-cell`,``,4,`matCellDef`],[`matColumnDef`,`duration`],[`matColumnDef`,`participant`],[`mat-cell`,``,3,`matTooltip`,4,`matCellDef`],[`matColumnDef`,`measuredAt`],[`matColumnDef`,`actions`],[`mat-header-row`,``,4,`matHeaderRowDef`],[`mat-row`,``,4,`matRowDef`,`matRowDefColumns`],[1,`count-info`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Kontinuierlichen Modus deaktivieren`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Kontinuierlichen Modus aktivieren`,3,`click`],[`mat-raised-button`,``,`color`,`warn`,`matTooltip`,`Ältesten Start verwerfen (bei Sturz des Läufers)`,3,`click`],[`mat-raised-button`,``,`color`,`accent`,`matTooltip`,`Automatischen Import deaktivieren (läuft alle 5 Sekunden)`,1,`active-mode`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Automatischen Import aktivieren (läuft alle 5 Sekunden)`,3,`click`],[`mat-raised-button`,``,`matTooltip`,`Aktuell erwartete Startnummer überspringen (z. B. nicht gestartet)`,3,`click`,`disabled`],[1,`next-number-info`],[`diameter`,`30`],[`mat-header-cell`,``],[`mat-cell`,``],[`mat-cell`,``,3,`matTooltip`],[`mat-icon-button`,``,`matTooltip`,`Bearbeiten`,3,`click`],[`mat-icon-button`,``,`color`,`warn`,`matTooltip`,`Löschen`,3,`click`],[`mat-header-row`,``],[`mat-row`,``]],template:function(e,t){if(e&1){let a=_D();Mi(0,`mat-card`)(1,`mat-card-header`)(2,`mat-card-title`)(3,`div`,1)(4,`span`),lw(5,`Messungen`),Jc(),Mi(6,`div`,2)(7,`mat-slide-toggle`,3),Mh(`ngModelChange`,function(_){return Pu(a),hw(t.autoRefreshEnabled,_)||(t.autoRefreshEnabled=_),Fu(_)}),sh(`change`,function(){return t.onAutoRefreshToggle()}),Jc(),eE(),gD(8,ya,2,0,`mat-icon`,4),bw(9,`async`),Kc(10,Ma,2,2,`mat-icon`,5),Mi(11,`span`,6),lw(12),Jc()()()()(),Mi(13,`mat-card-content`)(14,`div`,7)(15,`button`,8),sh(`click`,function(){return t.openCreateDialog()}),Mi(16,`mat-icon`),lw(17,`add`),Jc(),lw(18,` Neue Messung `),Jc(),Mi(19,`button`,9),sh(`click`,function(){return t.manualRefresh()}),Mi(20,`mat-icon`),lw(21,`refresh`),Jc(),lw(22,` Manuell aktualisieren `),Jc(),Mi(23,`button`,10),sh(`click`,function(){return t.openArchiveDialog()}),Mi(24,`mat-icon`),lw(25,`archive`),Jc(),lw(26,` Archivieren `),Jc(),Mi(27,`button`,11),sh(`click`,function(){return t.exportMeasurementsCsv()}),Mi(28,`mat-icon`),lw(29,`download`),Jc(),lw(30,` CSV Export `),Jc(),Mi(31,`button`,12),bw(32,`async`),sh(`click`,function(){return t.openImportDialog()}),gD(33,Sa,1,0,`mat-spinner`,13),bw(34,`async`),Kc(35,wa,2,0,`mat-icon`),lw(36,` CSV Import `),Jc(),gD(37,Na,5,6),bw(38,`async`),gD(39,Ea,4,0,`button`,14),bw(40,`async`),Kc(41,Ia,4,0,`button`,15),Mi(42,`button`,16)(43,`mat-icon`),lw(44,`delete_sweep`),Jc(),lw(45,` Zurücksetzen `),Mi(46,`mat-icon`),lw(47,`arrow_drop_down`),Jc()(),Mi(48,`mat-menu`,null,0)(50,`button`,17),sh(`click`,function(){return t.resetMeasurements(!1)}),Mi(51,`mat-icon`),lw(52,`delete_sweep`),Jc(),Mi(53,`span`),lw(54,`Alle Messungen löschen (nur Datenbank)`),Jc()(),Mi(55,`button`,17),sh(`click`,function(){return t.resetMeasurements(!0)}),Mi(56,`mat-icon`),lw(57,`delete_forever`),Jc(),Mi(58,`span`),lw(59,`Alle löschen (inkl. Gerät)`),Jc()()()(),Mi(60,`div`,18)(61,`mat-form-field`,19),bw(62,`async`),Mi(63,`mat-label`),lw(64,`Rennen (Automatik-Zuordnung)`),Jc(),Mi(65,`mat-select`,20),bw(66,`async`),bw(67,`async`),bw(68,`async`),sh(`selectionChange`,function(_){return t.onRaceChange(_.value)}),Mi(69,`mat-option`,21),lw(70,`— kein Rennen —`),Jc(),ID(71,Aa,2,3,`mat-option`,21,va),bw(73,`async`),Jc()(),gD(74,Fa,2,3),bw(75,`async`),Kc(76,La,2,0,`span`,22),Jc(),gD(77,Oa,2,0,`div`,23),bw(78,`async`),Mi(79,`div`,24)(80,`table`,25),bw(81,`async`),bw(82,`async`),tl(83,26),Gp(84,Pa,2,0,`th`,27)(85,za,2,1,`td`,28),nl(),tl(86,29),Gp(87,Ba,2,0,`th`,27)(88,Ga,2,1,`td`,28),nl(),tl(89,30),Gp(90,Va,2,0,`th`,27)(91,qa,2,2,`td`,31),nl(),tl(92,32),Gp(93,Ka,2,0,`th`,27)(94,Ha,3,4,`td`,28),nl(),tl(95,33),Gp(96,ja,2,0,`th`,27)(97,Ua,7,0,`td`,28),nl(),Gp(98,Wa,1,0,`tr`,34)(99,Qa,1,0,`tr`,35),Jc()(),Mi(100,`div`,36),lw(101),bw(102,`async`),Jc()()()}if(e&2){let a,l=BD(49);fI(7),Nh(`ngModel`,t.autoRefreshEnabled),nE(),fI(),mD(Cw(9,21,t.loading$)?8:10),fI(4),bh(t.lastUpdate),fI(19),Xp(`disabled`,Cw(32,23,t.importLoading$)),fI(2),mD(Cw(34,25,t.importLoading$)?33:35),fI(4),mD(Cw(38,27,t.timingProviderActive$)?37:-1),fI(2),mD(Cw(40,29,t.scheduledImportEnabled$)?39:41),fI(3),Xp(`matMenuTriggerFor`,l),fI(19),Xp(`matTooltip`,Cw(62,31,t.scheduledImportEnabled$)?`Automatischen Import zuerst deaktivieren, um das Rennen zu wechseln`:`Rennen auswählen startet die automatische Zuordnung, abwählen stoppt sie`),fI(4),Xp(`value`,Cw(66,33,t.selectedRaceId$))(`disabled`,!!Cw(67,35,t.scheduledImportEnabled$)||!!Cw(68,37,t.autoAssignBusy$)),fI(4),Xp(`value`,null),fI(2),ED(Cw(73,39,t.races$)),fI(3),mD((a=Cw(75,41,t.selectedRaceId$))?74:76,a),fI(3),mD(Cw(78,43,t.loading$)?77:-1),fI(3),mh(`loading`,Cw(81,45,t.loading$)),Xp(`dataSource`,Cw(82,47,t.measurementsWithParticipants$)||Ew(51,pt))(`trackBy`,t.trackById),fI(18),Xp(`matHeaderRowDef`,t.displayedColumns),fI(),Xp(`matRowDefColumns`,t.displayedColumns),fI(2),rl(`Anzahl der Messungen: `,(Cw(102,49,t.measurements$)||Ew(52,pt)).length)}},dependencies:[di,ci,Jt,ti$1,ri,ii,ei,si,oi,ni,ai,li,sh$1,ah,Es,yt,wt,op,rp,ot$1,Ep,$m,Hm,Um,qm,Wm,Yt,mt$1,Nn,rt,Lt,I,G$2,Bt,om,$r,ti,rm,nn,Vo,Cu,gu,Qa$1,Wo,Zo],styles:[`.title-row[_ngcontent-%COMP%]{display:flex;justify-content:space-between;align-items:center;width:100%;gap:32px}.sync-status[_ngcontent-%COMP%]{display:flex;align-items:center;gap:12px;font-size:.875rem;color:#0009}.sync-icon[_ngcontent-%COMP%]{font-size:20px;width:20px;height:20px;color:#0009}.sync-icon.syncing[_ngcontent-%COMP%]{animation:_ngcontent-%COMP%_spin 1s linear infinite;color:#3f51b5}@keyframes _ngcontent-%COMP%_spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.last-update-text[_ngcontent-%COMP%]{font-size:.75rem;white-space:nowrap}.header-actions[_ngcontent-%COMP%]{margin-top:20px;margin-bottom:20px;display:flex;gap:10px;position:relative;flex-wrap:wrap;align-items:center}.active-mode[_ngcontent-%COMP%]{background-color:#4caf50!important;color:#fff!important}.active-mode[_ngcontent-%COMP%]:hover{background-color:#45a049!important}.auto-assign-row[_ngcontent-%COMP%]{margin-bottom:20px;display:flex;gap:16px;flex-wrap:wrap;align-items:center}.race-select[_ngcontent-%COMP%]{min-width:280px}.next-number-info[_ngcontent-%COMP%]{font-size:.9rem;color:#000000b3}.hint[_ngcontent-%COMP%]{color:#0009}.loading-overlay[_ngcontent-%COMP%]{position:absolute;top:0;right:0;z-index:10;display:flex;align-items:center;justify-content:center;padding:10px}.measurement-table[_ngcontent-%COMP%]{width:100%;transition:opacity .2s ease}.measurement-table.loading[_ngcontent-%COMP%]{opacity:.6}mat-card[_ngcontent-%COMP%]{margin:20px}mat-card-content[_ngcontent-%COMP%]{position:relative}.count-info[_ngcontent-%COMP%]{margin-top:16px;padding:12px 16px;background-color:#f5f5f5;border-radius:4px;font-size:14px;font-weight:500;color:#000000de}@media(max-width:768px){mat-card[_ngcontent-%COMP%]{margin:8px}.title-row[_ngcontent-%COMP%]{flex-wrap:wrap;gap:8px}}`]})};export{Tn as MeasurementListComponent};