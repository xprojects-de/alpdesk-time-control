import{Ar as qE,Er as oh,Gn as fI,J as JD,Jn as gD,M as Ge,Nr as qj,Q as Jp,Ur as sh,Ut as VD,Vn as eh,X as Jc,Xr as uu,Yt as Wj,_n as Zu,_r as mD,ct as Mr,h as Co,ir as jD,j as GE,jt as T,l as BD,n as $j,nr as iy,nt as LD,o as A,or as jh,q as Iw,qr as uh,rn as Xp,st as Mi,vr as mh,vt as PD}from"./chunk-CIV96p5l.js";import{O as Yn,P as an,X as je,_ as Kt,et as le,ft as vo,x as Tf}from"./chunk-CyGegQQm.js";import{G as St,a as Ce}from"./chunk-D-PgdQ4d.js";import{u as m}from"./main-TS73WMFN.js";var Y=[`switch`];var J=[`*`];function K(i,p){i&1&&(Mi(0,`span`,11),Zu(),Mi(1,`svg`,13),eh(2,`path`,14),Jc(),Mi(3,`svg`,15),eh(4,`path`,16),Jc()())}var ee=new A(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var g=class{source;checked;constructor(p,t){this.source=p,this.checked=t}};var te=(()=>{class i{_elementRef=T(Mr);_focusMonitor=T(Kt);_changeDetectorRef=T($j);defaults=T(ee);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new g(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=je();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new Ge;toggleChange=new Ge;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){T(le).load(vo);let t=T(new jh(`tabindex`),{optional:!0}),a=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=a.color||`accent`,this.id=this._uniqueId=T(Yn).getId(`mat-mdc-slide-toggle-`),this.hideIcon=a.hideIcon??!1,this.disabledInteractive=a.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new g(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(a){return new(a||i)};static ɵcmp=qE({type:i,selectors:[[`mat-slide-toggle`]],viewQuery:function(a,e){if(a&1&&uh(Y,5),a&2){let l;jD(l=VD())&&(e._switchElement=l.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(a,e){a&2&&(oh(`id`,e.id),Jp(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),JD(e.color?`mat-`+e.color:``),mh(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,qj],color:`color`,disabled:[2,`disabled`,`disabled`,qj],fullWidth:[2,`fullWidth`,`fullWidth`,qj],disableRipple:[2,`disableRipple`,`disableRipple`,qj],tabIndex:[2,`tabIndex`,`tabIndex`,t=>t==null?0:Wj(t)],checked:[2,`checked`,`checked`,qj],hideIcon:[2,`hideIcon`,`hideIcon`,qj],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,qj]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[Iw([{provide:St,useExisting:Co(()=>i),multi:!0},{provide:Ce,useExisting:i,multi:!0}]),iy],ngContentSelectors:J,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(a,e){if(a&1&&(LD(),Mi(0,`div`,1)(1,`button`,2,0),sh(`click`,function(){return e._handleClick()}),eh(3,`div`,3)(4,`span`,4),Mi(5,`span`,5)(6,`span`,6)(7,`span`,7),eh(8,`span`,8),Jc(),Mi(9,`span`,9),eh(10,`span`,10),Jc(),gD(11,K,5,0,`span`,11),Jc()()(),Mi(12,`label`,12),sh(`click`,function($){return $.stopPropagation()}),PD(13),Jc()()),a&2){let l=BD(2);Xp(`labelPosition`,e.labelPosition),fI(),mh(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),Xp(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),Jp(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),fI(9),Xp(`matRippleTrigger`,l)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),fI(),mD(e.hideIcon?-1:11),fI(),Xp(`for`,e.buttonId),Jp(`id`,e._labelId)}},dependencies:[Tf,m],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return i})();var we=(()=>{class i{static ɵfac=function(a){return new(a||i)};static ɵmod=GE({type:i});static ɵinj=uu({imports:[te,an]})}return i})();export{we as n,te as t};