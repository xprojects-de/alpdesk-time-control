...
@Component({
    ...
    template: `
        ...
        <mat-dialog-content>
            <p class="hint">
                CSV-Datei (beliebiges Trennzeichen) mit Ergebnissen. Jede Zeile wird über die Startnummer einem bereits
                vorhandenen Teilnehmer dieses Rennens zugeordnet - es werden dabei
                <strong>keine neuen Teilnehmer angelegt</strong> und keine Stammdaten (Name, Verein, ...) verändert, nur
                Zeit/Wert, Strafe, Status und Kommentar. Etwaige Name/Verein-Spalten in der Datei sind reine Information
                und werden nicht ausgewertet. Eine Startnummer ohne passenden Teilnehmer wird als Fehler gemeldet. Das
                Mapping wird nicht gespeichert und muss bei jedem Import neu gewählt werden.
            </p>
