...
export const selectAllTeams = createSelector(selectTeamState, state => state.teams);
...
export const selectTeamById = (id: number) => createSelector(selectAllTeams, teams => teams.find(t => t.id === id));
