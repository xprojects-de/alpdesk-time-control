...
export const loadParticipant = createAction("[Participant] Load Participant", props<{id: number}>());
export const loadParticipantSuccess = createAction(
    "[Participant] Load Participant Success",
    props<{participant: Participant}>(),
);
export const loadParticipantFailure = createAction("[Participant] Load Participant Failure", props<{error: string}>());
...
export const clearParticipantResult = createAction("[Participant] Clear Participant Result", props<{id: number}>());
...
// Delete participant
export const deleteParticipant = createAction("[Participant] Delete Participant", props<{id: number}>());
export const deleteParticipantSuccess = createAction("[Participant] Delete Participant Success", props<{id: number}>());
...
// Select participant
export const selectParticipant = createAction("[Participant] Select Participant", props<{id: number | null}>());

// Assign race numbers
export const assignRaceNumbers = createAction("[Participant] Assign Race Numbers", props<{raceId: number}>());
...
export const exportStartListPdf = createAction("[Participant] Export Start List PDF", props<{raceId: number}>());
...
export const exportAllPdf = createAction("[Participant] Export All PDF", props<{raceId: number}>());
export const exportAllPdfSuccess = createAction(
    "[Participant] Export All PDF Success",
    props<{blob: Blob; filename: string}>(),
);
export const exportAllPdfFailure = createAction("[Participant] Export All PDF Failure", props<{error: string}>());
...
export const exportAllAgeGroupsPdf = createAction("[Participant] Export All Age Groups PDF", props<{raceId: number}>());
