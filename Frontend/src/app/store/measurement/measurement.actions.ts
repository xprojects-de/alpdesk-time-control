...
export const loadMeasurement = createAction("[Measurement] Load Measurement", props<{id: number}>());
export const loadMeasurementSuccess = createAction(
    "[Measurement] Load Measurement Success",
    props<{measurement: Measurement}>(),
);
export const loadMeasurementFailure = createAction("[Measurement] Load Measurement Failure", props<{error: string}>());
...
// Delete measurement
export const deleteMeasurement = createAction("[Measurement] Delete Measurement", props<{id: number}>());
export const deleteMeasurementSuccess = createAction("[Measurement] Delete Measurement Success", props<{id: number}>());
...
// Select measurement
export const selectMeasurement = createAction("[Measurement] Select Measurement", props<{id: number | null}>());

// Reset all measurements
export const resetMeasurements = createAction("[Measurement] Reset Measurements", props<{resetDevice: boolean}>());
...
// Set continuous mode
export const setContinuousMode = createAction("[Measurement] Set Continuous Mode", props<{enable: boolean}>());
...
export const setScheduledImport = createAction("[Measurement] Set Scheduled Import", props<{enable: boolean}>());
...
export const loadScheduledImportStatus = createAction("[Measurement] Load Scheduled Import Status");
...
// Get device status
export const loadDeviceStatus = createAction("[Measurement] Load Device Status");
...
export const discardOldestStart = createAction("[Measurement] Discard Oldest Start");
...
export const exportMeasurementsCsv = createAction("[Measurement] Export Measurements CSV");
...
export const startDeviceConnectionPolling = createAction("[Measurement] Start Device Connection Polling");
export const stopDeviceConnectionPolling = createAction("[Measurement] Stop Device Connection Polling");
export const checkDeviceConnection = createAction("[Measurement] Check Device Connection");
...
export const loadAutoAssignStatus = createAction("[Measurement] Load Auto-Assign Status");
...
export const disableAutoAssign = createAction("[Measurement] Disable Auto-Assign");
...
export const skipAutoAssign = createAction("[Measurement] Skip Auto-Assign");
export const skipAutoAssignSuccess = createAction(
    "[Measurement] Skip Auto-Assign Success",
    props<{status: AutoAssignStatus}>(),
);
export const skipAutoAssignFailure = createAction("[Measurement] Skip Auto-Assign Failure", props<{error: string}>());
