...
export const createPerson = createAction("[Person] Create Person", props<{person: PersonRequest}>());
export const createPersonSuccess = createAction("[Person] Create Person Success", props<{person: Person}>());
export const createPersonFailure = createAction("[Person] Create Person Failure", props<{error: string}>());

export const updatePerson = createAction("[Person] Update Person", props<{id: number; person: PersonRequest}>());
