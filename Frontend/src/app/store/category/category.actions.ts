...
export const createCategory = createAction("[Category] Create Category", props<{category: CategoryRequest}>());
...
export const deleteCategory = createAction("[Category] Delete Category", props<{id: number; force?: boolean}>());
