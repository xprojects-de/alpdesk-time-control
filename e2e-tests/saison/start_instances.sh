#!/bin/bash
# Starts 1 isolated backend instance for the Saison E2E test. NEVER points at the real production
# database - the whole suite moves the season boundary around, which re-assigns existing races.
#
...
(
  ...
  APP_USERNAME=e2e_admin APP_PASSWORD=e2eTestPass123 \
    JWT_GENERATOR_SIGNATURE_SECRET="e2e-saison-secret-needs-at-least-32-bytes-xyz" \
    OPEN_BROWSER=false \
