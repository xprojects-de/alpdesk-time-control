#!/bin/bash
# Starts 1 isolated backend instance + the fake timing device for the Nachtslalom E2E test.
...
(
  ...
  APP_USERNAME=e2e_admin APP_PASSWORD=e2eTestPass123 \
    JWT_GENERATOR_SIGNATURE_SECRET="e2e-nachtslalom-secret-needs-at-least-32-bytes-xyz" \
    OPEN_BROWSER=false \
